...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/blockchain/ITAController;
    ...
    check-cast v0, Landroid/blockchain/ITAController;

    return-object v0

    :cond_1
    new-instance v0, Landroid/blockchain/ITAController$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/blockchain/ITAController$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_2
    sget-object p1, Landroid/blockchain/TACommandRequest;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/blockchain/TACommandRequest;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/blockchain/ITAController$Stub;->processTACommand(Landroid/blockchain/TACommandRequest;)Landroid/blockchain/TACommandResponse;
    ...
    :cond_3
    invoke-virtual {p0}, Landroid/blockchain/ITAController$Stub;->unloadTA()V
    ...
    invoke-virtual/range {v2 .. v7}, Landroid/blockchain/ITAController$Stub;->loadTA(Landroid/os/ParcelFileDescriptor;JJ)Z
