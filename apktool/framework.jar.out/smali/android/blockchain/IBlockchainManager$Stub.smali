...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/blockchain/IBlockchainManager;
    ...
    check-cast v0, Landroid/blockchain/IBlockchainManager;

    return-object v0

    :cond_1
    new-instance v0, Landroid/blockchain/IBlockchainManager$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/blockchain/IBlockchainManager$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo p0, "sspExit"

    return-object p0

    :pswitch_1
    const-string/jumbo p0, "sspInit"

    return-object p0

    :pswitch_2
    const-string p0, "getCredential"

    return-object p0

    :pswitch_3
    const-string/jumbo p0, "putCredential"
    ...
    :pswitch_5
    const-string/jumbo p0, "registerBlockchainFW"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1}, Landroid/blockchain/IBlockchainManager$Stub;->getCredential(I)[B
    ...
    invoke-virtual {p0, p1, p4}, Landroid/blockchain/IBlockchainManager$Stub;->putCredential(I[B)Z
    ...
    :pswitch_5
    sget-object p1, Landroid/blockchain/BlockchainTZServiceConfig;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/blockchain/BlockchainTZServiceConfig;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/blockchain/IBlockchainManager$Stub;->registerBlockchainFW(Landroid/blockchain/BlockchainTZServiceConfig;)Landroid/blockchain/BlockchainTZServiceCommnInfo;
