...
.method private greylist-max-o getAuthority(Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Landroid/app/slice/SliceManager;->mContext:Landroid/content/Context;
...
.method private greylist-max-o resolveStatic(Landroid/content/Intent;Landroid/content/ContentResolver;)Landroid/net/Uri;
    ...
    const-string p2, "android.metadata.SLICE_URI"
...
.method public whitelist bindSlice(Landroid/content/Intent;Ljava/util/Set;)Landroid/app/slice/Slice;
    ...
    const-string/jumbo p1, "map_slice"
    ...
    const-class p2, Landroid/app/slice/Slice;
...
.method public whitelist bindSlice(Landroid/net/Uri;Ljava/util/Set;)Landroid/app/slice/Slice;
    ...
    const-class v1, Landroid/app/slice/Slice;
...
.method public blacklist enforceSlicePermission(Landroid/net/Uri;II[Ljava/lang/String;)V
    ...
    invoke-static {p3, v1}, Landroid/os/UserHandle;->isSameApp(II)Z
    ...
    :cond_0
    iget-object v2, p0, Landroid/app/slice/SliceManager;->mService:Landroid/app/slice/ISliceManager;
    ...
    invoke-interface/range {v2 .. v7}, Landroid/app/slice/ISliceManager;->checkSlicePermission(Landroid/net/Uri;Ljava/lang/String;II[Ljava/lang/String;)I
    ...
    const-string p2, " does not have slice permission for "
...
.method public whitelist getPinnedSlices()Ljava/util/List;
    ...
    invoke-interface {v0, p0}, Landroid/app/slice/ISliceManager;->getPinnedSlices(Ljava/lang/String;)[Landroid/net/Uri;
...
.method public whitelist getPinnedSpecs(Landroid/net/Uri;)Ljava/util/Set;
    ...
    invoke-interface {v1, p1, p0}, Landroid/app/slice/ISliceManager;->getPinnedSpecs(Landroid/net/Uri;Ljava/lang/String;)[Landroid/app/slice/SliceSpec;
...
.method public whitelist getSliceDescendants(Landroid/net/Uri;)Ljava/util/Collection;
    ...
    const-string p1, "Unable to get slice descendants"
...
.method public greylist-max-o grantPermissionFromUser(Landroid/net/Uri;Ljava/lang/String;Z)V
    ...
    invoke-interface {v0, p1, p2, p0, p3}, Landroid/app/slice/ISliceManager;->grantPermissionFromUser(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist grantSlicePermission(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Landroid/app/slice/ISliceManager;->grantSlicePermission(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public greylist-max-o hasSliceAccess()Z
    ...
    invoke-interface {v0, p0}, Landroid/app/slice/ISliceManager;->hasSliceAccess(Ljava/lang/String;)Z
...
.method public whitelist mapIntentToUri(Landroid/content/Intent;)Landroid/net/Uri;
    ...
    const-string/jumbo p1, "map_only"
...
.method public whitelist pinSlice(Landroid/net/Uri;Ljava/util/Set;)V
    ...
    iget-object p0, p0, Landroid/app/slice/SliceManager;->mToken:Landroid/os/IBinder;

    invoke-interface {v0, v1, p1, p2, p0}, Landroid/app/slice/ISliceManager;->pinSlice(Ljava/lang/String;Landroid/net/Uri;[Landroid/app/slice/SliceSpec;Landroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist revokeSlicePermission(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Landroid/app/slice/ISliceManager;->revokeSlicePermission(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist unpinSlice(Landroid/net/Uri;)V
    ...
    invoke-interface {v0, v1, p1, p0}, Landroid/app/slice/ISliceManager;->unpinSlice(Ljava/lang/String;Landroid/net/Uri;Landroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
