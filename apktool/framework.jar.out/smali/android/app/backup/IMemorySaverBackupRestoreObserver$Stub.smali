...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/app/backup/IMemorySaverBackupRestoreObserver;
    ...
    :cond_1
    new-instance v0, Landroid/app/backup/IMemorySaverBackupRestoreObserver$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/app/backup/IMemorySaverBackupRestoreObserver$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_1
    const-string/jumbo p0, "onRestoreCompleted"

    return-object p0

    :cond_2
    const-string/jumbo p0, "onRestoreStart"

    return-object p0

    :cond_3
    const-string/jumbo p0, "onBackupCompleted"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1, p3}, Landroid/app/backup/IMemorySaverBackupRestoreObserver$Stub;->onRestoreCompleted(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/app/backup/IMemorySaverBackupRestoreObserver$Stub;->onRestoreStart(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p3}, Landroid/app/backup/IMemorySaverBackupRestoreObserver$Stub;->onBackupCompleted(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/app/backup/IMemorySaverBackupRestoreObserver$Stub;->onStartBackup(Ljava/lang/String;)V
