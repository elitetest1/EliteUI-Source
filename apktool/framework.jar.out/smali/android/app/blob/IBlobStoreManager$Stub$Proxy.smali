...
.method public blacklist abandonSession(JLjava/lang/String;)V
    ...
    iget-object p0, p0, Landroid/app/blob/IBlobStoreManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist getInterfaceDescriptor()Ljava/lang/String;
    ...
    const-string p0, "android.app.blob.IBlobStoreManager"
...
.method public blacklist getLeaseInfo(Landroid/app/blob/BlobHandle;Ljava/lang/String;)Landroid/app/blob/LeaseInfo;
    ...
    sget-object p0, Landroid/app/blob/LeaseInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/app/blob/LeaseInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist openSession(JLjava/lang/String;)Landroid/app/blob/IBlobStoreSession;
    ...
    invoke-static {p0}, Landroid/app/blob/IBlobStoreSession$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/blob/IBlobStoreSession;
...
.method public blacklist queryBlobsForUser(I)Ljava/util/List;
    ...
    sget-object p0, Landroid/app/blob/BlobInfo;->CREATOR:Landroid/os/Parcelable$Creator;
