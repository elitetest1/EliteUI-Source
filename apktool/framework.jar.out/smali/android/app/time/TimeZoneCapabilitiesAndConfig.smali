...
.method public constructor blacklist <init>(Landroid/app/time/TimeZoneDetectorStatus;Landroid/app/time/TimeZoneCapabilities;Landroid/app/time/TimeZoneConfiguration;)V
    ...
    iput-object p1, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mDetectorStatus:Landroid/app/time/TimeZoneDetectorStatus;
    ...
    iput-object p1, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mConfiguration:Landroid/app/time/TimeZoneConfiguration;
...
.method private static blacklist createFromParcel(Landroid/os/Parcel;)Landroid/app/time/TimeZoneCapabilitiesAndConfig;
    ...
    invoke-direct {v1, v0, v2, p0}, Landroid/app/time/TimeZoneCapabilitiesAndConfig;-><init>(Landroid/app/time/TimeZoneDetectorStatus;Landroid/app/time/TimeZoneCapabilities;Landroid/app/time/TimeZoneConfiguration;)V
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mDetectorStatus:Landroid/app/time/TimeZoneDetectorStatus;

    iget-object v3, p1, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mDetectorStatus:Landroid/app/time/TimeZoneDetectorStatus;

    invoke-virtual {v2, v3}, Landroid/app/time/TimeZoneDetectorStatus;->equals(Ljava/lang/Object;)Z
    ...
    iget-object p0, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mConfiguration:Landroid/app/time/TimeZoneConfiguration;

    iget-object p1, p1, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mConfiguration:Landroid/app/time/TimeZoneConfiguration;

    invoke-virtual {p0, p1}, Landroid/app/time/TimeZoneConfiguration;->equals(Ljava/lang/Object;)Z
...
.method public whitelist getCapabilities()Landroid/app/time/TimeZoneCapabilities;
    ...
    iget-object p0, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mCapabilities:Landroid/app/time/TimeZoneCapabilities;
...
.method public blacklist getDetectorStatus()Landroid/app/time/TimeZoneDetectorStatus;
    ...
    iget-object p0, p0, Landroid/app/time/TimeZoneCapabilitiesAndConfig;->mDetectorStatus:Landroid/app/time/TimeZoneDetectorStatus;
