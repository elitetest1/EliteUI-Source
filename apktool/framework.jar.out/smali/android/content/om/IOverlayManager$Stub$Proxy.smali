...
.method static synthetic blacklist lambda$getAllOverlays$0(Landroid/os/Parcel;Ljava/util/Map;I)V
    ...
    sget-object v0, Landroid/content/om/OverlayInfo;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public blacklist addOverlays(Ljava/util/List;Landroid/content/om/ISamsungOverlayCallback;I)V
    ...
    iget-object p0, p0, Landroid/content/om/IOverlayManager$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist enableWithConstraints(Ljava/lang/String;ILjava/util/List;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public greylist-max-o getAllOverlays(I)Ljava/util/Map;
    ...
    new-instance v2, Landroid/content/om/IOverlayManager$Stub$Proxy$$ExternalSyntheticLambda0;

    invoke-direct {v2, v1, p1}, Landroid/content/om/IOverlayManager$Stub$Proxy$$ExternalSyntheticLambda0;-><init>(Landroid/os/Parcel;Ljava/util/Map;)V
...
.method public blacklist getAllOverlaysInCategory(II)[Landroid/content/om/OverlayInfoExt;
    ...
    sget-object p0, Landroid/content/om/OverlayInfoExt;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public greylist-max-o getInterfaceDescriptor()Ljava/lang/String;
    ...
    const-string p0, "android.content.om.IOverlayManager"
...
.method public blacklist getLastPalette(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-virtual {v1, p1, p0}, Landroid/os/Parcel;->readList(Ljava/util/List;Ljava/lang/ClassLoader;)V

    invoke-virtual {v1, p2, p0}, Landroid/os/Parcel;->readList(Ljava/util/List;Ljava/lang/ClassLoader;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o getOverlayInfo(Ljava/lang/String;I)Landroid/content/om/OverlayInfo;
    ...
    sget-object p0, Landroid/content/om/OverlayInfo;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public blacklist notifyValidatorListener(IZ)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
