...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo p0, "onStateChange"

    return-object p0

    :cond_1
    const-string/jumbo p0, "onKnoxContainerLaunch"

    return-object p0

    :cond_2
    const-string/jumbo p0, "onResetPersona"

    return-object p0

    :cond_3
    const-string/jumbo p0, "onRemovePersona"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    sget-object p4, Lcom/samsung/android/knox/SemPersonaState;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p4}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p4

    check-cast p4, Lcom/samsung/android/knox/SemPersonaState;

    sget-object v0, Lcom/samsung/android/knox/SemPersonaState;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {p0, p1, p4, v0}, Landroid/content/pm/ISystemPersonaObserver$Stub;->onStateChange(ILcom/samsung/android/knox/SemPersonaState;Lcom/samsung/android/knox/SemPersonaState;)V
    ...
    invoke-virtual {p0, p1}, Landroid/content/pm/ISystemPersonaObserver$Stub;->onKnoxContainerLaunch(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/content/pm/ISystemPersonaObserver$Stub;->onResetPersona(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/content/pm/ISystemPersonaObserver$Stub;->onRemovePersona(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/content/pm/ISystemPersonaObserver$Stub;->onPersonaActive(I)V
