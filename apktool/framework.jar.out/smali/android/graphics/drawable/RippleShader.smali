...
.method public blacklist setColor(II)V
    ...
    const-string p1, "in_sparkleColor"

    invoke-virtual {p0, p1, p2}, Landroid/graphics/drawable/RippleShader;->setColorUniform(Ljava/lang/String;I)V
...
.method public blacklist setNoisePhase(F)V
    ...
    const-string v0, "in_turbulencePhase"
    ...
    const-wide v4, 0x3fea666666666667L    # 0.8250000000000001
    ...
    const-string v3, "in_tCircle1"

    invoke-virtual {p0, v3, p1, v2}, Landroid/graphics/drawable/RippleShader;->setFloatUniform(Ljava/lang/String;FF)V

    const-wide v2, -0x4084f765fd8adabaL    # -0.0066

    mul-double/2addr v2, v0

    const-wide v4, 0x3fe599999999999aL    # 0.675
    ...
    const-string v5, "in_tCircle2"

    invoke-virtual {p0, v5, p1, v4}, Landroid/graphics/drawable/RippleShader;->setFloatUniform(Ljava/lang/String;FF)V

    const-wide v4, 0x3fe0ccccccccccccL    # 0.5249999999999999
    ...
    const-wide v2, 0x3f9921fb54442d18L    # 0.02454369260617026

    mul-double/2addr v2, v0

    const-wide v4, 0x40155ce26e06bfeeL    # 5.340707511102648
    ...
    const-string v5, "in_tRotation1"

    invoke-virtual {p0, v5, p1, v4}, Landroid/graphics/drawable/RippleShader;->setFloatUniform(Ljava/lang/String;FF)V

    const-wide v4, -0x4066de04abbbd2e8L    # -0.02454369260617026
    ...
    const-string v1, "in_tRotation2"

    invoke-virtual {p0, v1, p1, v0}, Landroid/graphics/drawable/RippleShader;->setFloatUniform(Ljava/lang/String;FF)V

    const-wide v0, 0x4021475cc9eedf00L    # 8.63937979737193
...
.method public blacklist setResolution(FF)V
    ...
    invoke-virtual {p0, v2, v1, v0}, Landroid/graphics/drawable/RippleShader;->setFloatUniform(Ljava/lang/String;FF)V
    ...
    const-string p2, "in_noiseScale"

    invoke-virtual {p0, p2, p1, v0}, Landroid/graphics/drawable/RippleShader;->setFloatUniform(Ljava/lang/String;FF)V
