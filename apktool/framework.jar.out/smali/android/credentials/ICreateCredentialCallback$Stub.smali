...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/credentials/ICreateCredentialCallback;
    ...
    :cond_1
    new-instance v0, Landroid/credentials/ICreateCredentialCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/credentials/ICreateCredentialCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_2
    const-string/jumbo p0, "onPendingIntent"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1, p3}, Landroid/credentials/ICreateCredentialCallback$Stub;->onError(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_3
    sget-object p1, Landroid/credentials/CreateCredentialResponse;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {p0, p1}, Landroid/credentials/ICreateCredentialCallback$Stub;->onResponse(Landroid/credentials/CreateCredentialResponse;)V
    ...
    invoke-virtual {p0, p1}, Landroid/credentials/ICreateCredentialCallback$Stub;->onPendingIntent(Landroid/app/PendingIntent;)V
