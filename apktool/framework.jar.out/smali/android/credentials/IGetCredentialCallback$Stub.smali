...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/credentials/IGetCredentialCallback;
    ...
    :cond_1
    new-instance v0, Landroid/credentials/IGetCredentialCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/credentials/IGetCredentialCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1, p3}, Landroid/credentials/IGetCredentialCallback$Stub;->onError(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_3
    sget-object p1, Landroid/credentials/GetCredentialResponse;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {p0, p1}, Landroid/credentials/IGetCredentialCallback$Stub;->onResponse(Landroid/credentials/GetCredentialResponse;)V
    ...
    invoke-virtual {p0, p1}, Landroid/credentials/IGetCredentialCallback$Stub;->onPendingIntent(Landroid/app/PendingIntent;)V
