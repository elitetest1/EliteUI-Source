...
.method private final greylist-max-o closePorts()V
    ...
    :cond_1
    iget-object p0, p0, Landroid/filterfw/core/Filter;->mOutputPorts:Ljava/util/HashMap;
...
.method private final greylist-max-o inputConditionsMet()Z
    ...
    iget-boolean p0, p0, Landroid/filterfw/core/Filter;->mLogVerbose:Z

    if-eqz p0, :cond_1

    new-instance p0, Ljava/lang/StringBuilder;

    const-string v0, "Input condition not met: "
...
.method private final greylist-max-o outputConditionsMet()Z
    ...
    const-string v0, "Output condition not met: "
...
.method private final greylist-max-o releasePulledFrames(Landroid/filterfw/core/FilterContext;)V
    ...
    :cond_0
    iget-object p0, p0, Landroid/filterfw/core/Filter;->mFramesToRelease:Ljava/util/HashSet;
...
.method private final greylist-max-o setImmediateInputValue(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0}, Landroid/filterfw/core/FilterPort;->open()V

    const/4 p1, 0x0

    invoke-static {p2, p1}, Landroid/filterfw/core/SimpleFrame;->wrapObject(Ljava/lang/Object;Landroid/filterfw/core/FrameManager;)Landroid/filterfw/core/SimpleFrame;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroid/filterfw/core/FilterPort;->setFrame(Landroid/filterfw/core/Frame;)V
...
.method private final greylist-max-o transferInputFrames(Landroid/filterfw/core/FilterContext;)V
    ...
    iget-object p0, p0, Landroid/filterfw/core/Filter;->mInputPorts:Ljava/util/HashMap;
...
.method private final greylist-max-o wrapInputValue(Ljava/lang/String;Ljava/lang/Object;)Landroid/filterfw/core/Frame;
    ...
    new-instance p0, Landroid/filterfw/core/SerializedFrame;

    invoke-direct {p0, v0, v1}, Landroid/filterfw/core/SerializedFrame;-><init>(Landroid/filterfw/core/FrameFormat;Landroid/filterfw/core/FrameManager;)V

    goto :goto_1

    :cond_2
    new-instance p0, Landroid/filterfw/core/SimpleFrame;

    invoke-direct {p0, v0, v1}, Landroid/filterfw/core/SimpleFrame;-><init>(Landroid/filterfw/core/FrameFormat;Landroid/filterfw/core/FrameManager;)V

    :goto_1
    invoke-virtual {p0, p2}, Landroid/filterfw/core/Frame;->setObjectValue(Ljava/lang/Object;)V
...
.method protected greylist-max-o addProgramPort(Ljava/lang/String;Ljava/lang/String;Ljava/lang/reflect/Field;Ljava/lang/Class;Z)V
    ...
    iget-boolean p0, v2, Landroid/filterfw/core/Filter;->mLogVerbose:Z
    ...
    invoke-virtual {v1, p0}, Landroid/filterfw/core/InputPort;->setPortFormat(Landroid/filterfw/core/FrameFormat;)V

    iget-object p0, v2, Landroid/filterfw/core/Filter;->mInputPorts:Ljava/util/HashMap;
...
.method final declared-synchronized greylist-max-o canProcess()Z
    ...
    const-string v0, "Checking if can process: "
...
.method protected greylist-max-o closeOutputPort(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Landroid/filterfw/core/OutputPort;->close()V
...
.method public final greylist-max-o getInputFormat(Ljava/lang/String;)Landroid/filterfw/core/FrameFormat;
    ...
    invoke-virtual {p0}, Landroid/filterfw/core/InputPort;->getSourceFormat()Landroid/filterfw/core/FrameFormat;
...
.method public final greylist-max-o getInputPort(Ljava/lang/String;)Landroid/filterfw/core/InputPort;
    ...
    const-string p0, " before Filter has been initialized!"
...
.method public final greylist-max-o getName()Ljava/lang/String;
    ...
    iget-object p0, p0, Landroid/filterfw/core/Filter;->mName:Ljava/lang/String;
...
.method public greylist-max-o isOpen()Z
    ...
    iget-boolean p0, p0, Landroid/filterfw/core/Filter;->mIsOpen:Z
...
.method final declared-synchronized greylist-max-o performClose(Landroid/filterfw/core/FilterContext;)V
    ...
    :try_start_0
    iget-boolean v1, p0, Landroid/filterfw/core/Filter;->mIsOpen:Z
...
.method final declared-synchronized greylist-max-o performOpen(Landroid/filterfw/core/FilterContext;)V
    ...
    :try_start_0
    iget-boolean v3, p0, Landroid/filterfw/core/Filter;->mIsOpen:Z
    ...
    iput v4, p0, Landroid/filterfw/core/Filter;->mStatus:I
    ...
    iput-boolean v5, p0, Landroid/filterfw/core/Filter;->mIsOpen:Z
...
.method protected final greylist-max-o pushOutput(Ljava/lang/String;Landroid/filterfw/core/Frame;)V
    ...
    invoke-virtual {p0, p2}, Landroid/filterfw/core/OutputPort;->pushFrame(Landroid/filterfw/core/Frame;)V
...
.method public greylist-max-o setInputFrame(Ljava/lang/String;Landroid/filterfw/core/Frame;)V
    ...
    :cond_0
    invoke-virtual {p0, p2}, Landroid/filterfw/core/FilterPort;->setFrame(Landroid/filterfw/core/Frame;)V
...
.method protected greylist-max-o setWaitsOnInputPort(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p2}, Landroid/filterfw/core/InputPort;->setBlocking(Z)V
...
.method protected greylist-max-o setWaitsOnOutputPort(Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p2}, Landroid/filterfw/core/OutputPort;->setBlocking(Z)V
...
.method protected greylist-max-o transferInputPortFrame(Ljava/lang/String;Landroid/filterfw/core/FilterContext;)V
    ...
    invoke-virtual {p0, p2}, Landroid/filterfw/core/InputPort;->transfer(Landroid/filterfw/core/FilterContext;)V
