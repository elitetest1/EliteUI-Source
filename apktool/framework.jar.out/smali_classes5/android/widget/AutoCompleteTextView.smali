...
.method public constructor whitelist <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-boolean v8, p0, Landroid/widget/AutoCompleteTextView;->mDropDownDismissedOnCompletion:Z

    const/4 v9, 0x0

    iput v9, p0, Landroid/widget/AutoCompleteTextView;->mLastKeyCode:I

    const/4 v10, 0x0

    iput-object v10, p0, Landroid/widget/AutoCompleteTextView;->mValidator:Landroid/widget/AutoCompleteTextView$Validator;

    iput-boolean v8, p0, Landroid/widget/AutoCompleteTextView;->mPopupCanBeUpdated:Z

    new-instance v0, Landroid/widget/AutoCompleteTextView$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0}, Landroid/widget/AutoCompleteTextView$$ExternalSyntheticLambda0;-><init>(Landroid/widget/AutoCompleteTextView;)V

    iput-object v0, p0, Landroid/widget/AutoCompleteTextView;->mBackCallback:Landroid/window/OnBackInvokedCallback;
    ...
    invoke-direct {v2, p1, v7}, Landroid/view/ContextThemeWrapper;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V

    iput-object v2, p0, Landroid/widget/AutoCompleteTextView;->mPopupContext:Landroid/content/Context;
    ...
    invoke-direct {v7, p1, v2}, Landroid/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V

    iput-object v7, p0, Landroid/widget/AutoCompleteTextView;->mPopupContext:Landroid/content/Context;

    goto :goto_0

    :cond_1
    iput-object p1, p0, Landroid/widget/AutoCompleteTextView;->mPopupContext:Landroid/content/Context;

    :goto_0
    iget-object v2, p0, Landroid/widget/AutoCompleteTextView;->mPopupContext:Landroid/content/Context;

    if-eq v2, p1, :cond_2

    sget-object v7, Lcom/android/internal/R$styleable;->AutoCompleteTextView:[I

    invoke-virtual {v2, p2, v7, v5, v6}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v7, v11, v2}, Landroid/content/res/TypedArray;->getLayoutDimension(II)I
    ...
    iget-object v12, p0, Landroid/widget/AutoCompleteTextView;->mPopupContext:Landroid/content/Context;

    invoke-direct {v7, v12, p2, v5, v6}, Landroid/widget/ListPopupWindow;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v7, p0, Landroid/widget/AutoCompleteTextView;->mPopup:Landroid/widget/ListPopupWindow;

    new-instance v3, Landroid/widget/AutoCompleteTextView$$ExternalSyntheticLambda1;

    invoke-direct {v3, p0}, Landroid/widget/AutoCompleteTextView$$ExternalSyntheticLambda1;-><init>(Landroid/widget/AutoCompleteTextView;)V

    invoke-virtual {v7, v3}, Landroid/widget/ListPopupWindow;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    const/16 v3, 0x10

    invoke-virtual {v7, v3}, Landroid/widget/ListPopupWindow;->setSoftInputMode(I)V

    invoke-virtual {v7, v8}, Landroid/widget/ListPopupWindow;->setPromptPosition(I)V

    invoke-virtual {v7, p1}, Landroid/widget/ListPopupWindow;->setListSelector(Landroid/graphics/drawable/Drawable;)V

    new-instance p1, Landroid/widget/AutoCompleteTextView$DropDownItemClickListener;

    invoke-direct {p1, p0, v10}, Landroid/widget/AutoCompleteTextView$DropDownItemClickListener;-><init>(Landroid/widget/AutoCompleteTextView;Landroid/widget/AutoCompleteTextView-IA;)V

    invoke-virtual {v7, p1}, Landroid/widget/ListPopupWindow;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v7, v1}, Landroid/widget/ListPopupWindow;->setWidth(I)V

    invoke-virtual {v7, v2}, Landroid/widget/ListPopupWindow;->setHeight(I)V

    iput v11, p0, Landroid/widget/AutoCompleteTextView;->mHintResource:I

    invoke-virtual {p0, v9}, Landroid/widget/AutoCompleteTextView;->setCompletionHint(Ljava/lang/CharSequence;)V

    const/4 p1, 0x6

    const/4 v1, -0x1

    invoke-virtual {v4, p1, v1}, Landroid/content/res/TypedArray;->getResourceId(II)I
    ...
    invoke-virtual {v4, p1, p1}, Landroid/content/res/TypedArray;->getInt(II)I
    ...
    invoke-virtual {p0, p1}, Landroid/widget/AutoCompleteTextView;->setRawInputType(I)V

    :cond_4
    invoke-virtual {p0, v8}, Landroid/widget/AutoCompleteTextView;->setFocusable(Z)V

    new-instance p1, Landroid/widget/AutoCompleteTextView$MyWatcher;

    invoke-direct {p1, p0, v10}, Landroid/widget/AutoCompleteTextView$MyWatcher;-><init>(Landroid/widget/AutoCompleteTextView;Landroid/widget/AutoCompleteTextView-IA;)V

    iput-object p1, p0, Landroid/widget/AutoCompleteTextView;->mAutoCompleteTextWatcher:Landroid/widget/AutoCompleteTextView$MyWatcher;

    invoke-virtual {p0, p1}, Landroid/widget/AutoCompleteTextView;->addTextChangedListener(Landroid/text/TextWatcher;)V

    new-instance p1, Landroid/widget/AutoCompleteTextView$PassThroughClickListener;

    invoke-direct {p1, p0, v10}, Landroid/widget/AutoCompleteTextView$PassThroughClickListener;-><init>(Landroid/widget/AutoCompleteTextView;Landroid/widget/AutoCompleteTextView-IA;)V

    iput-object p1, p0, Landroid/widget/AutoCompleteTextView;->mPassThroughClickListener:Landroid/widget/AutoCompleteTextView$PassThroughClickListener;
...
.method private blacklist registerOnBackInvokedCallback()V
    ...
    iput-boolean v0, p0, Landroid/widget/AutoCompleteTextView;->mBackCallbackRegistered:Z
...
.method public whitelist clearListSelection()V
    ...
    iget-object p0, p0, Landroid/widget/AutoCompleteTextView;->mPopup:Landroid/widget/ListPopupWindow;
...
.method protected whitelist convertSelectionToString(Ljava/lang/Object;)Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Landroid/widget/AutoCompleteTextView;->mFilter:Landroid/widget/Filter;
...
.method greylist-max-p doAfterTextChanged()V
    ...
    iget-object p0, p0, Landroid/widget/AutoCompleteTextView;->mAutoCompleteTextWatcher:Landroid/widget/AutoCompleteTextView$MyWatcher;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroid/widget/AutoCompleteTextView$MyWatcher;->afterTextChanged(Landroid/text/Editable;)V
...
.method greylist-max-p doBeforeTextChanged()V
    ...
    invoke-virtual {p0, v0, v1, v1, v1}, Landroid/widget/AutoCompleteTextView$MyWatcher;->beforeTextChanged(Ljava/lang/CharSequence;III)V
...
.method public whitelist enoughToFilter()Z
    ...
    iget p0, p0, Landroid/widget/AutoCompleteTextView;->mThreshold:I
...
.method public whitelist getCompletionHint()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Landroid/widget/AutoCompleteTextView;->mHintText:Ljava/lang/CharSequence;
...
.method public whitelist getDropDownAnchor()I
    ...
    iget p0, p0, Landroid/widget/AutoCompleteTextView;->mDropDownAnchorId:I
...
.method public greylist-max-o getDropDownAnimationStyle()I
    ...
    invoke-virtual {p0}, Landroid/widget/ListPopupWindow;->getAnimationStyle()I
...
.method public whitelist getDropDownVerticalOffset()I
    ...
    invoke-virtual {p0}, Landroid/widget/ListPopupWindow;->getVerticalOffset()I
...
.method public whitelist getInputMethodMode()I
    ...
    invoke-virtual {p0}, Landroid/widget/ListPopupWindow;->getInputMethodMode()I
...
.method public whitelist getItemClickListener()Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object p0, p0, Landroid/widget/AutoCompleteTextView;->mItemClickListener:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public whitelist getItemSelectedListener()Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    iget-object p0, p0, Landroid/widget/AutoCompleteTextView;->mItemSelectedListener:Landroid/widget/AdapterView$OnItemSelectedListener;
...
.method public whitelist getListSelection()I
    ...
    invoke-virtual {p0}, Landroid/widget/ListPopupWindow;->getSelectedItemPosition()I
...
.method public whitelist getValidator()Landroid/widget/AutoCompleteTextView$Validator;
    ...
    iget-object p0, p0, Landroid/widget/AutoCompleteTextView;->mValidator:Landroid/widget/AutoCompleteTextView$Validator;
...
.method public greylist-max-o isDropDownAlwaysVisible()Z
    ...
    invoke-virtual {p0}, Landroid/widget/ListPopupWindow;->isDropDownAlwaysVisible()Z
...
.method public greylist-max-o isDropDownDismissedOnCompletion()Z
    ...
    iget-boolean p0, p0, Landroid/widget/AutoCompleteTextView;->mDropDownDismissedOnCompletion:Z
...
.method public whitelist onCommitCompletion(Landroid/view/inputmethod/CompletionInfo;)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ListPopupWindow;->performItemClick(I)Z
...
.method public whitelist setCompletionHint(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ListPopupWindow;->setPromptView(Landroid/view/View;)V
...
.method public greylist setDropDownAlwaysVisible(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ListPopupWindow;->setDropDownAlwaysVisible(Z)V
...
.method public greylist-max-p setDropDownAnimationStyle(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ListPopupWindow;->setAnimationStyle(I)V
...
.method public whitelist setDropDownBackgroundResource(I)V
    ...
    invoke-virtual {v0, p0}, Landroid/widget/ListPopupWindow;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public whitelist setDropDownHorizontalOffset(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ListPopupWindow;->setHorizontalOffset(I)V
...
.method public whitelist setDropDownVerticalOffset(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ListPopupWindow;->setVerticalOffset(I)V
...
.method public greylist setForceIgnoreOutsideTouch(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ListPopupWindow;->setForceIgnoreOutsideTouch(Z)V
...
.method public whitelist setListSelection(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/widget/ListPopupWindow;->setSelection(I)V
...
.method public whitelist setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    iget-object p0, p0, Landroid/widget/AutoCompleteTextView;->mPassThroughClickListener:Landroid/widget/AutoCompleteTextView$PassThroughClickListener;

    invoke-static {p0, p1}, Landroid/widget/AutoCompleteTextView$PassThroughClickListener;->-$$Nest$fputmWrapped(Landroid/widget/AutoCompleteTextView$PassThroughClickListener;Landroid/view/View$OnClickListener;)V
...
.method public greylist-max-r showDropDownAfterLayout()V
    ...
    invoke-virtual {p0}, Landroid/widget/ListPopupWindow;->postShow()V
