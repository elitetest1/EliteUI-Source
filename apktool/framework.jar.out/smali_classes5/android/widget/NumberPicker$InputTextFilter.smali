...
.method public whitelist filter(Ljava/lang/CharSequence;IILandroid/text/Spanned;II)Ljava/lang/CharSequence;
    ...
    invoke-static {p2, p1}, Landroid/widget/NumberPicker;->-$$Nest$mgetSelectedPos(Landroid/widget/NumberPicker;Ljava/lang/String;)I

    move-result p2

    iget-object p3, p0, Landroid/widget/NumberPicker$InputTextFilter;->this$0:Landroid/widget/NumberPicker;

    invoke-static {p3}, Landroid/widget/NumberPicker;->-$$Nest$fgetmMaxValue(Landroid/widget/NumberPicker;)I
    ...
    iget-object p0, p0, Landroid/widget/NumberPicker$InputTextFilter;->this$0:Landroid/widget/NumberPicker;

    invoke-static {p0}, Landroid/widget/NumberPicker;->-$$Nest$fgetmMaxValue(Landroid/widget/NumberPicker;)I
    ...
    invoke-static {p3}, Landroid/widget/NumberPicker;->-$$Nest$fgetmDisplayedValues(Landroid/widget/NumberPicker;)[Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Landroid/widget/NumberPicker;->-$$Nest$mpostSetSelectionCommand(Landroid/widget/NumberPicker;II)V
