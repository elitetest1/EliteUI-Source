...
.field private static final greylist-max-o LOG_TAG:Ljava/lang/String; = "ActivityChooserModel"
...
.method private constructor greylist-max-o <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, v1}, Landroid/widget/ActivityChooserModel$DefaultSorter;-><init>(Landroid/widget/ActivityChooserModel;Landroid/widget/ActivityChooserModel-IA;)V
...
.method private greylist-max-o persistHistoricalDataIfNeeded()V
    ...
    invoke-virtual {v0, v1, p0}, Landroid/widget/ActivityChooserModel$PersistHistoryAsyncTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method private greylist-max-o sortActivitiesIfNeeded()Z
    ...
    iget-object p0, p0, Landroid/widget/ActivityChooserModel;->mHistoricalRecords:Ljava/util/List;

    invoke-static {p0}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p0

    invoke-interface {v0, v1, v2, p0}, Landroid/widget/ActivityChooserModel$ActivitySorter;->sort(Landroid/content/Intent;Ljava/util/List;Ljava/util/List;)V
...
.method protected whitelist test-api finalize()V
    ...
    iget-object p0, p0, Landroid/widget/ActivityChooserModel;->mPackageMonitor:Lcom/android/internal/content/PackageMonitor;
...
.method public greylist getActivity(I)Landroid/content/pm/ResolveInfo;
    ...
    iget-object p0, p0, Landroid/widget/ActivityChooserModel;->mActivities:Ljava/util/List;

    invoke-interface {p0, p1}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/widget/ActivityChooserModel$ActivityResolveInfo;

    iget-object p0, p0, Landroid/widget/ActivityChooserModel$ActivityResolveInfo;->resolveInfo:Landroid/content/pm/ResolveInfo;
...
.method public greylist-max-o getActivityIndex(Landroid/content/pm/ResolveInfo;)I
    ...
    iget-object v3, v3, Landroid/widget/ActivityChooserModel$ActivityResolveInfo;->resolveInfo:Landroid/content/pm/ResolveInfo;
...
.method public greylist-max-o getHistoryMaxSize()I
    ...
    :try_start_0
    iget p0, p0, Landroid/widget/ActivityChooserModel;->mHistoryMaxSize:I
...
.method public greylist-max-o getIntent()Landroid/content/Intent;
    ...
    :try_start_0
    iget-object p0, p0, Landroid/widget/ActivityChooserModel;->mIntent:Landroid/content/Intent;
