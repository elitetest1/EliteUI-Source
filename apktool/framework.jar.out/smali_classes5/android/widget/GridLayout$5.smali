...
.method public blacklist getAlignmentValue(Landroid/view/View;II)I
    ...
    iget-object p0, p0, Landroid/widget/GridLayout$5;->val$ltr:Landroid/widget/GridLayout$Alignment;

    goto :goto_0

    :cond_0
    iget-object p0, p0, Landroid/widget/GridLayout$5;->val$rtl:Landroid/widget/GridLayout$Alignment;

    :goto_0
    invoke-virtual {p0, p1, p2, p3}, Landroid/widget/GridLayout$Alignment;->getAlignmentValue(Landroid/view/View;II)I
...
.method blacklist getGravityOffset(Landroid/view/View;I)I
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Landroid/widget/GridLayout$Alignment;->getGravityOffset(Landroid/view/View;I)I
