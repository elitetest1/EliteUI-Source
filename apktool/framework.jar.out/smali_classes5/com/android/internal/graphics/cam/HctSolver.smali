...
.method static blacklist areInCyclicOrder(DDD)Z
    ...
    invoke-static {p2, p3}, Lcom/android/internal/graphics/cam/HctSolver;->sanitizeRadians(D)D

    move-result-wide p2

    sub-double/2addr p4, p0

    invoke-static {p4, p5}, Lcom/android/internal/graphics/cam/HctSolver;->sanitizeRadians(D)D
...
.method static blacklist bisectToLimit(DD)I
    ...
    invoke-static {v10, v11}, Lcom/android/internal/graphics/cam/HctSolver;->trueDelinearized(D)D

    move-result-wide v10

    invoke-static {v10, v11}, Lcom/android/internal/graphics/cam/HctSolver;->criticalPlaneBelow(D)I
    ...
    invoke-static {v10, v11}, Lcom/android/internal/graphics/cam/HctSolver;->criticalPlaneAbove(D)I
    ...
    sget-object v13, Lcom/android/internal/graphics/cam/HctSolver;->CRITICAL_PLANES:[D

    aget-wide v13, v13, v12

    invoke-static {v2, v13, v14, v0, v6}, Lcom/android/internal/graphics/cam/HctSolver;->setCoordinate([DD[DI)[D

    move-result-object v16

    invoke-static/range {v16 .. v16}, Lcom/android/internal/graphics/cam/HctSolver;->hueOf([D)D
    ...
    invoke-static/range {v10 .. v15}, Lcom/android/internal/graphics/cam/HctSolver;->areInCyclicOrder(DDD)Z
    ...
    invoke-static/range {v10 .. v15}, Lcom/android/internal/graphics/cam/CamUtils;->argbFromLinrgbComponents(DDD)I
...
.method static blacklist bisectToSegment(DD)[[D
    ...
    invoke-static {v11, v12, v6}, Lcom/android/internal/graphics/cam/HctSolver;->nthVertex(DI)[D
    ...
    invoke-static/range {v9 .. v14}, Lcom/android/internal/graphics/cam/HctSolver;->areInCyclicOrder(DDD)Z
...
.method static blacklist findResultByJ(DDD)I
    ...
    invoke-static/range {v24 .. v25}, Lcom/android/internal/graphics/cam/HctSolver;->inverseChromaticAdaptation(D)D

    move-result-wide v7

    invoke-static/range {v30 .. v31}, Lcom/android/internal/graphics/cam/HctSolver;->inverseChromaticAdaptation(D)D

    move-result-wide v9

    invoke-static {v0, v1}, Lcom/android/internal/graphics/cam/HctSolver;->inverseChromaticAdaptation(D)D

    move-result-wide v0

    sget-object v3, Lcom/android/internal/graphics/cam/HctSolver;->LINRGB_FROM_SCALED_DISCOUNT:[[D

    aget-object v24, v3, v17

    aget-wide v28, v24, v17

    mul-double v28, v28, v7

    const/16 v25, 0x1

    aget-wide v30, v24, v25
    ...
    add-double v37, v7, v0

    cmpg-double v0, v33, v20
    ...
    :cond_2
    sget-object v0, Lcom/android/internal/graphics/cam/HctSolver;->Y_FROM_LINRGB:[D
    ...
    :cond_6
    invoke-static/range {v33 .. v38}, Lcom/android/internal/graphics/cam/CamUtils;->argbFromLinrgbComponents(DDD)I
...
.method static blacklist hueOf([D)D
    ...
    invoke-static {v5, v6}, Lcom/android/internal/graphics/cam/HctSolver;->chromaticAdaptation(D)D

    move-result-wide v0

    invoke-static {v13, v14}, Lcom/android/internal/graphics/cam/HctSolver;->chromaticAdaptation(D)D

    move-result-wide v4

    invoke-static {v2, v3}, Lcom/android/internal/graphics/cam/HctSolver;->chromaticAdaptation(D)D
...
.method static blacklist nthVertex(DI)[D
    ...
    invoke-static {v6, v7}, Lcom/android/internal/graphics/cam/HctSolver;->isBounded(D)Z
    ...
    invoke-static {v3, v4}, Lcom/android/internal/graphics/cam/HctSolver;->isBounded(D)Z
