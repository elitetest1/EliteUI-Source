...
.method static constructor blacklist <clinit>()V
    ...
    sput-object v1, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->defaultSecureRandomProvider:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    sput-object v1, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->servicesConstraints:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, v3, v4, v6, v7}, Lcom/android/internal/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;)V
    ...
    new-instance v8, Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;

    const-string v9, "77d0f8c4dad15eb8c4f2f8d6726cefd96d5bb399"

    invoke-static {v9}, Lcom/android/internal/org/bouncycastle/util/encoders/Hex;->decodeStrict(Ljava/lang/String;)[B

    move-result-object v9

    const/16 v10, 0x107

    invoke-direct {v8, v9, v10}, Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;-><init>([BI)V

    invoke-direct {v3, v4, v6, v7, v8}, Lcom/android/internal/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;)V
    ...
    new-instance v9, Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;

    const-string v10, "8d5155894229d5e689ee01e6018a237e2cae64cd"

    invoke-static {v10}, Lcom/android/internal/org/bouncycastle/util/encoders/Hex;->decodeStrict(Ljava/lang/String;)[B

    move-result-object v10

    const/16 v11, 0x5c

    invoke-direct {v9, v10, v11}, Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;-><init>([BI)V

    invoke-direct {v4, v6, v7, v8, v9}, Lcom/android/internal/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;)V
    ...
    invoke-direct {v5, v10, v11}, Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;-><init>([BI)V

    invoke-direct {v6, v7, v8, v9, v5}, Lcom/android/internal/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;)V

    sget-object v5, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar$Property;->DSA_DEFAULT_PARAMS:Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar$Property;

    const/4 v7, 0x4

    new-array v8, v7, [Lcom/android/internal/org/bouncycastle/crypto/params/DSAParameters;
    ...
    invoke-static {v5, v8}, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->localSetGlobalProperty(Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar$Property;[Ljava/lang/Object;)V

    sget-object v5, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar$Property;->DH_DEFAULT_PARAMS:Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar$Property;

    new-array v7, v7, [Lcom/android/internal/org/bouncycastle/crypto/params/DHParameters;
    ...
    invoke-static {v6}, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->toDH(Lcom/android/internal/org/bouncycastle/crypto/params/DSAParameters;)Lcom/android/internal/org/bouncycastle/crypto/params/DHParameters;

    move-result-object v2

    aput-object v2, v7, v12

    invoke-static {v5, v7}, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->localSetGlobalProperty(Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar$Property;[Ljava/lang/Object;)V
    ...
    :cond_0
    sput-boolean v9, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->preconfiguredConstraints:Z
...
.method public static blacklist setSecureRandom(Ljava/security/SecureRandom;)V
    ...
    sget-object p0, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->defaultSecureRandomProvider:Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v0, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->defaultRandomProviderImpl:Lcom/android/internal/org/bouncycastle/crypto/SecureRandomProvider;
...
.method public static blacklist setServicesConstraints(Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesConstraints;)V
    ...
    sget-object p0, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->noConstraintsImpl:Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesConstraints;

    :cond_0
    sget-boolean v0, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->preconfiguredConstraints:Z

    if-eqz v0, :cond_2

    const-string v0, "com.android.internal.org.bouncycastle.constraints.allow_override"
    ...
    :cond_1
    sget-object p0, Lcom/android/internal/org/bouncycastle/crypto/CryptoServicesRegistrar;->LOG:Ljava/util/logging/Logger;
...
.method private static blacklist toDH(Lcom/android/internal/org/bouncycastle/crypto/params/DSAParameters;)Lcom/android/internal/org/bouncycastle/crypto/params/DHParameters;
    ...
    invoke-virtual {v0}, Lcom/android/internal/org/bouncycastle/crypto/params/DSAValidationParameters;->getSeed()[B
    ...
    invoke-direct {v8, v0, p0}, Lcom/android/internal/org/bouncycastle/crypto/params/DHValidationParameters;-><init>([BI)V
