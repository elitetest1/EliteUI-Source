...
.method public constructor blacklist <init>(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
    ...
    iget-object v1, p0, Lcom/android/internal/app/AbstractResolverComparator;->mPmMap:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/android/internal/app/AbstractResolverComparator;->mUsmMap:Ljava/util/Map;
...
.method protected final blacklist afterCompute()V
    ...
    iget-object p0, p0, Lcom/android/internal/app/AbstractResolverComparator;->mAfterCompute:Lcom/android/internal/app/AbstractResolverComparator$AfterCompute;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lcom/android/internal/app/AbstractResolverComparator$AfterCompute;->afterCompute()V
...
.method blacklist beforeCompute()V
    ...
    iget-object p0, p0, Lcom/android/internal/app/AbstractResolverComparator;->mHandler:Landroid/os/Handler;

    if-nez p0, :cond_0

    const-string p0, "Error: Handler is Null; Needs to be initialized."
...
.method public final blacklist compare(Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;Lcom/android/internal/app/ResolverActivity$ResolvedComponentInfo;)I
    ...
    iget p0, v2, Landroid/content/pm/ResolveInfo;->targetUserId:I
    ...
    iget-object p0, p0, Lcom/android/internal/app/AbstractResolverComparator;->mAzComparator:Ljava/util/Comparator;
