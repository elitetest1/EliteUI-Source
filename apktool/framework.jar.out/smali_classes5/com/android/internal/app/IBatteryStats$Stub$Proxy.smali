...
.method public whitelist asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Lcom/android/internal/app/IBatteryStats$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist getBatteryUsageStats(Ljava/util/List;)Ljava/util/List;
    ...
    sget-object p0, Landroid/os/BatteryUsageStats;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public blacklist getBluetoothBatteryStats()Landroid/os/BluetoothBatteryStats;
    ...
    sget-object p0, Landroid/os/BluetoothBatteryStats;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/os/BluetoothBatteryStats;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o getCellularBatteryStats()Landroid/os/connectivity/CellularBatteryStats;
    ...
    sget-object p0, Landroid/os/connectivity/CellularBatteryStats;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/os/connectivity/CellularBatteryStats;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist getDeviceBatteryInfo(Ljava/lang/String;)Lcom/samsung/android/os/SemCompanionDeviceBatteryInfo;
    ...
    sget-object p0, Lcom/samsung/android/os/SemCompanionDeviceBatteryInfo;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public greylist-max-o getGpsBatteryStats()Landroid/os/connectivity/GpsBatteryStats;
    ...
    sget-object p0, Landroid/os/connectivity/GpsBatteryStats;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/os/connectivity/GpsBatteryStats;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o getInterfaceDescriptor()Ljava/lang/String;
    ...
    const-string p0, "com.android.internal.app.IBatteryStats"
...
.method public blacklist getSemBatteryUsageStats()Landroid/os/SemBatterySipper;
    ...
    sget-object p0, Landroid/os/SemBatterySipper;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/os/SemBatterySipper;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist getWakeLockStats()Landroid/os/WakeLockStats;
    ...
    sget-object p0, Landroid/os/WakeLockStats;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/os/WakeLockStats;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o getWifiBatteryStats()Landroid/os/connectivity/WifiBatteryStats;
    ...
    sget-object p0, Landroid/os/connectivity/WifiBatteryStats;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/os/connectivity/WifiBatteryStats;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist noteDualScreenState(IIII)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public blacklist registerBatteryStatsCallback(Lcom/android/internal/app/IBatteryStatsCallback;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public greylist-max-o takeUidSnapshot(I)Landroid/os/health/HealthStatsParceler;
    ...
    sget-object p0, Landroid/os/health/HealthStatsParceler;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/os/health/HealthStatsParceler;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist unregisterBatteryStatsCallback(Lcom/android/internal/app/IBatteryStatsCallback;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
