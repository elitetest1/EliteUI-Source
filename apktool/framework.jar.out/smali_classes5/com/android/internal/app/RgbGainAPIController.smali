...
.method public constructor blacklist <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Lcom/android/internal/app/RgbGainAPIController;->mContext:Landroid/content/Context;

    iput p2, p0, Lcom/android/internal/app/RgbGainAPIController;->mUserId:I

    new-instance p1, Lcom/android/internal/app/RgbGainAPIController$1;
    ...
    invoke-direct {p1, p0, p2}, Lcom/android/internal/app/RgbGainAPIController$1;-><init>(Lcom/android/internal/app/RgbGainAPIController;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/android/internal/app/RgbGainAPIController;->mContentObserver:Landroid/database/ContentObserver;
...
.method private blacklist getMetricsLogger()Lcom/android/internal/logging/MetricsLogger;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/internal/app/RgbGainAPIController;->mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;
...
.method private blacklist onSettingChanged(Ljava/lang/String;)V
    ...
    :pswitch_0
    iget-object p1, p0, Lcom/android/internal/app/RgbGainAPIController;->mCallback:Lcom/android/internal/app/RgbGainAPIController$Callback;

    invoke-virtual {p0}, Lcom/android/internal/app/RgbGainAPIController;->getRgbGainGreenLevel()I

    move-result p0

    invoke-interface {p1, p0}, Lcom/android/internal/app/RgbGainAPIController$Callback;->onRgbGainGreenLevelChanged(I)V
    ...
    invoke-interface {p1, p0}, Lcom/android/internal/app/RgbGainAPIController$Callback;->onRgbGainRedLevelChanged(I)V
    ...
    invoke-interface {p1, p0}, Lcom/android/internal/app/RgbGainAPIController$Callback;->onActivated(Z)V
    ...
    invoke-interface {p1, p0}, Lcom/android/internal/app/RgbGainAPIController$Callback;->onRgbGainBlueLevelChanged(I)V
...
.method public blacklist getRgbGainBlueLevel()I
    ...
    const-string v1, "Using default value for setting: rgb_gain_api_display_blue_level"
...
.method public blacklist getRgbGainGreenLevel()I
    ...
    const-string v1, "Using default value for setting: rgb_gain_api_display_green_level"
...
.method public blacklist getRgbGainRedLevel()I
    ...
    const-string v1, "Using default value for setting: rgb_gain_api_display_red_level"
...
.method public blacklist isActivated()Z
    ...
    iget p0, p0, Lcom/android/internal/app/RgbGainAPIController;->mUserId:I
...
.method public blacklist setListener(Lcom/android/internal/app/RgbGainAPIController$Callback;)V
    ...
    iget-object p1, p0, Lcom/android/internal/app/RgbGainAPIController;->mContext:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object p1

    iget-object p0, p0, Lcom/android/internal/app/RgbGainAPIController;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, Lcom/android/internal/app/RgbGainAPIController;->mContentObserver:Landroid/database/ContentObserver;
