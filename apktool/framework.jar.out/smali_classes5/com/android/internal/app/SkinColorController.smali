...
.method public constructor blacklist <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Lcom/android/internal/app/SkinColorController;->mContext:Landroid/content/Context;

    iput p2, p0, Lcom/android/internal/app/SkinColorController;->mUserId:I

    new-instance p1, Lcom/android/internal/app/SkinColorController$1;
    ...
    invoke-direct {p1, p0, p2}, Lcom/android/internal/app/SkinColorController$1;-><init>(Lcom/android/internal/app/SkinColorController;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/android/internal/app/SkinColorController;->mContentObserver:Landroid/database/ContentObserver;
...
.method private blacklist getMetricsLogger()Lcom/android/internal/logging/MetricsLogger;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/internal/app/SkinColorController;->mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;
...
.method private blacklist onSettingChanged(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/internal/app/SkinColorController;->mCallback:Lcom/android/internal/app/SkinColorController$Callback;

    invoke-virtual {p0}, Lcom/android/internal/app/SkinColorController;->isActivated()Z

    move-result p0

    invoke-interface {p1, p0}, Lcom/android/internal/app/SkinColorController$Callback;->onActivated(Z)V
    ...
    invoke-interface {p1, p0}, Lcom/android/internal/app/SkinColorController$Callback;->onLevelChanged(I)V
...
.method public blacklist getSkinColorLevel()I
    ...
    const-string v0, "SkinColorController"

    const-string v1, "Using default value for setting: skin_color_display_color_level"
...
.method public blacklist isActivated()Z
    ...
    iget p0, p0, Lcom/android/internal/app/SkinColorController;->mUserId:I
...
.method public blacklist setListener(Lcom/android/internal/app/SkinColorController$Callback;)V
    ...
    iget-object p1, p0, Lcom/android/internal/app/SkinColorController;->mContext:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object p1

    iget-object p0, p0, Lcom/android/internal/app/SkinColorController;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, Lcom/android/internal/app/SkinColorController;->mContentObserver:Landroid/database/ContentObserver;
