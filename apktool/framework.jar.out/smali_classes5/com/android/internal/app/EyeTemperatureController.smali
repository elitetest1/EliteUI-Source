...
.method public constructor blacklist <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Lcom/android/internal/app/EyeTemperatureController;->mContext:Landroid/content/Context;

    iput p2, p0, Lcom/android/internal/app/EyeTemperatureController;->mUserId:I

    new-instance p1, Lcom/android/internal/app/EyeTemperatureController$1;
    ...
    invoke-direct {p1, p0, p2}, Lcom/android/internal/app/EyeTemperatureController$1;-><init>(Lcom/android/internal/app/EyeTemperatureController;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/android/internal/app/EyeTemperatureController;->mContentObserver:Landroid/database/ContentObserver;
...
.method private blacklist getMetricsLogger()Lcom/android/internal/logging/MetricsLogger;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/internal/app/EyeTemperatureController;->mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;
...
.method private blacklist onSettingChanged(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/internal/app/EyeTemperatureController;->mCallback:Lcom/android/internal/app/EyeTemperatureController$Callback;

    invoke-virtual {p0}, Lcom/android/internal/app/EyeTemperatureController;->isActivated()Z

    move-result p0

    invoke-interface {p1, p0}, Lcom/android/internal/app/EyeTemperatureController$Callback;->onActivated(Z)V
    ...
    invoke-interface {p1, p0}, Lcom/android/internal/app/EyeTemperatureController$Callback;->onLevelChanged(I)V
...
.method public blacklist getEyeTempLevel()I
    ...
    const-string v0, "EyeTemperatureController"

    const-string v1, "Using default value for setting: eye_temp_display_temp_level"
...
.method public blacklist isActivated()Z
    ...
    iget p0, p0, Lcom/android/internal/app/EyeTemperatureController;->mUserId:I
...
.method public blacklist setListener(Lcom/android/internal/app/EyeTemperatureController$Callback;)V
    ...
    iget-object p1, p0, Lcom/android/internal/app/EyeTemperatureController;->mContext:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object p1

    iget-object p0, p0, Lcom/android/internal/app/EyeTemperatureController;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, Lcom/android/internal/app/EyeTemperatureController;->mContentObserver:Landroid/database/ContentObserver;
