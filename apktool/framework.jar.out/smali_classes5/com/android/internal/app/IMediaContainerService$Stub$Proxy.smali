...
.method public whitelist asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Lcom/android/internal/app/IMediaContainerService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public greylist-max-o getInterfaceDescriptor()Ljava/lang/String;
    ...
    const-string p0, "com.android.internal.app.IMediaContainerService"
...
.method public greylist-max-o getMinimalPackageInfo(Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/PackageInfoLite;
    ...
    sget-object p0, Landroid/content/pm/PackageInfoLite;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/content/pm/PackageInfoLite;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o getObbInfo(Ljava/lang/String;)Landroid/content/res/ObbInfo;
    ...
    sget-object p0, Landroid/content/res/ObbInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/content/res/ObbInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
