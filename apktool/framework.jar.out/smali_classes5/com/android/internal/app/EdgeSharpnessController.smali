...
.method public constructor blacklist <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Lcom/android/internal/app/EdgeSharpnessController;->mContext:Landroid/content/Context;

    iput p2, p0, Lcom/android/internal/app/EdgeSharpnessController;->mUserId:I

    new-instance p1, Lcom/android/internal/app/EdgeSharpnessController$1;
    ...
    invoke-direct {p1, p0, p2}, Lcom/android/internal/app/EdgeSharpnessController$1;-><init>(Lcom/android/internal/app/EdgeSharpnessController;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/android/internal/app/EdgeSharpnessController;->mContentObserver:Landroid/database/ContentObserver;
...
.method private blacklist getMetricsLogger()Lcom/android/internal/logging/MetricsLogger;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/internal/app/EdgeSharpnessController;->mMetricsLogger:Lcom/android/internal/logging/MetricsLogger;
...
.method private blacklist onSettingChanged(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/internal/app/EdgeSharpnessController;->mCallback:Lcom/android/internal/app/EdgeSharpnessController$Callback;

    invoke-virtual {p0}, Lcom/android/internal/app/EdgeSharpnessController;->isActivated()Z

    move-result p0

    invoke-interface {p1, p0}, Lcom/android/internal/app/EdgeSharpnessController$Callback;->onActivated(Z)V
    ...
    invoke-interface {p1, p0}, Lcom/android/internal/app/EdgeSharpnessController$Callback;->onEdgeSharpnessIntensityLevelChanged(I)V
...
.method public blacklist getEdgeSharpnessIntensityLevel()I
    ...
    iget p0, p0, Lcom/android/internal/app/EdgeSharpnessController;->mUserId:I
...
.method public blacklist setListener(Lcom/android/internal/app/EdgeSharpnessController$Callback;)V
    ...
    iget-object p1, p0, Lcom/android/internal/app/EdgeSharpnessController;->mContext:Landroid/content/Context;

    invoke-virtual {p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object p1

    iget-object p0, p0, Lcom/android/internal/app/EdgeSharpnessController;->mContentObserver:Landroid/database/ContentObserver;
    ...
    iget-object v1, p0, Lcom/android/internal/app/EdgeSharpnessController;->mContentObserver:Landroid/database/ContentObserver;
