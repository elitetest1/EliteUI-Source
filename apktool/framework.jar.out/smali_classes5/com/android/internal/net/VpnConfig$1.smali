...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Lcom/android/internal/net/VpnConfig;
    ...
    new-instance p0, Lcom/android/internal/net/VpnConfig;

    invoke-direct {p0}, Lcom/android/internal/net/VpnConfig;-><init>()V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/internal/net/VpnConfig;->allowPortBypass:Z

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v0

    iput v0, p0, Lcom/android/internal/net/VpnConfig;->dport:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v0

    iput v0, p0, Lcom/android/internal/net/VpnConfig;->fwmark:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v0

    iput v0, p0, Lcom/android/internal/net/VpnConfig;->priority:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v0

    iput v0, p0, Lcom/android/internal/net/VpnConfig;->netTableId:I
    ...
    iput-wide v4, p0, Lcom/android/internal/net/VpnConfig;->startTime:J
    ...
    :goto_8
    iput-boolean v1, p0, Lcom/android/internal/net/VpnConfig;->excludeLocalRoutes:Z
...
.method public blacklist newArray(I)[Lcom/android/internal/net/VpnConfig;
    ...
    new-array p0, p1, [Lcom/android/internal/net/VpnConfig;
