...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lcom/android/internal/telephony/IWwanSelectorCallback;
    ...
    check-cast v0, Lcom/android/internal/telephony/IWwanSelectorCallback;

    return-object v0

    :cond_1
    new-instance v0, Lcom/android/internal/telephony/IWwanSelectorCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/android/internal/telephony/IWwanSelectorCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_1
    const-string/jumbo p0, "onDomainSelected"

    return-object p0

    :cond_2
    const-string/jumbo p0, "onRequestEmergencyNetworkScan"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1, p3}, Lcom/android/internal/telephony/IWwanSelectorCallback$Stub;->onDomainSelected(IZ)V
    ...
    invoke-static {v0}, Lcom/android/internal/telephony/IWwanSelectorResultCallback$Stub;->asInterface(Landroid/os/IBinder;)Lcom/android/internal/telephony/IWwanSelectorResultCallback;

    move-result-object v0

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1, p3, p4, v0}, Lcom/android/internal/telephony/IWwanSelectorCallback$Stub;->onRequestEmergencyNetworkScan([IIZLcom/android/internal/telephony/IWwanSelectorResultCallback;)V
