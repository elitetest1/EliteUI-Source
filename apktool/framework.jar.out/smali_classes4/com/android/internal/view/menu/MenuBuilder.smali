...
.method private greylist-max-o addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    iget-object p1, v0, Lcom/android/internal/view/menu/MenuBuilder;->mCurrentMenuInfo:Landroid/view/ContextMenu$ContextMenuInfo;

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lcom/android/internal/view/menu/MenuItemImpl;->setMenuInfo(Landroid/view/ContextMenu$ContextMenuInfo;)V

    :cond_0
    iget-object p1, v0, Lcom/android/internal/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;

    invoke-static {p1, v4}, Lcom/android/internal/view/menu/MenuBuilder;->findInsertIndex(Ljava/util/ArrayList;I)I
...
.method greylist-max-o dispatchMenuItemSelected(Lcom/android/internal/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mCallback:Lcom/android/internal/view/menu/MenuBuilder$Callback;

    if-eqz p0, :cond_0

    invoke-interface {p0, p1, p2}, Lcom/android/internal/view/menu/MenuBuilder$Callback;->onMenuItemSelected(Lcom/android/internal/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z
...
.method greylist-max-o findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Lcom/android/internal/view/menu/MenuItemImpl;
    ...
    invoke-virtual {v6}, Lcom/android/internal/view/menu/MenuItemImpl;->getAlphabeticShortcut()C
    ...
    :cond_2
    invoke-virtual {v6}, Lcom/android/internal/view/menu/MenuItemImpl;->getNumericShortcut()C
...
.method public greylist-max-o getActionItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;
...
.method public greylist getContext()Landroid/content/Context;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mContext:Landroid/content/Context;
...
.method public greylist-max-o getExpandedItem()Lcom/android/internal/view/menu/MenuItemImpl;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mExpandedItem:Lcom/android/internal/view/menu/MenuItemImpl;
...
.method public greylist getHeaderIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mHeaderIcon:Landroid/graphics/drawable/Drawable;
...
.method public greylist getHeaderTitle()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mHeaderTitle:Ljava/lang/CharSequence;
...
.method public greylist-max-o getHeaderView()Landroid/view/View;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mHeaderView:Landroid/view/View;
...
.method public whitelist getItem(I)Landroid/view/MenuItem;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mItems:Ljava/util/ArrayList;
...
.method public greylist-max-r getNonActionItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
...
.method greylist-max-o getOptionalIconsVisible()Z
    ...
    iget-boolean p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mOptionalIconsVisible:Z
...
.method greylist-max-o getResources()Landroid/content/res/Resources;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mResources:Landroid/content/res/Resources;
...
.method public greylist getVisibleItems()Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mVisibleItems:Ljava/util/ArrayList;
...
.method public greylist-max-o isGroupDividerEnabled()Z
    ...
    iget-boolean p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mGroupDividerEnabled:Z
...
.method greylist-max-o isQwertyMode()Z
    ...
    iget-boolean p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mQwertyMode:Z
...
.method public greylist-max-o isShortcutsVisible()Z
    ...
    iget-boolean p0, p0, Lcom/android/internal/view/menu/MenuBuilder;->mShortcutsVisible:Z
