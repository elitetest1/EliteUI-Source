...
.method public whitelist onAudioStateChanged(Landroid/telecom/Phone;Landroid/telecom/AudioState;)V
    ...
    iget-object p0, p0, Landroid/telecom/InCallService$2;->this$0:Landroid/telecom/InCallService;

    invoke-virtual {p0, p2}, Landroid/telecom/InCallService;->onAudioStateChanged(Landroid/telecom/AudioState;)V
...
.method public whitelist onBringToForeground(Landroid/telecom/Phone;Z)V
    ...
    invoke-virtual {p0, p2}, Landroid/telecom/InCallService;->onBringToForeground(Z)V
...
.method public whitelist onCallAdded(Landroid/telecom/Phone;Landroid/telecom/Call;)V
    ...
    invoke-virtual {p0, p2}, Landroid/telecom/InCallService;->onCallAdded(Landroid/telecom/Call;)V
...
.method public whitelist onCallAudioStateChanged(Landroid/telecom/Phone;Landroid/telecom/CallAudioState;)V
    ...
    invoke-virtual {p0, p2}, Landroid/telecom/InCallService;->onCallAudioStateChanged(Landroid/telecom/CallAudioState;)V
...
.method public whitelist onCallRemoved(Landroid/telecom/Phone;Landroid/telecom/Call;)V
    ...
    invoke-virtual {p0, p2}, Landroid/telecom/InCallService;->onCallRemoved(Landroid/telecom/Call;)V
...
.method public whitelist onCanAddCallChanged(Landroid/telecom/Phone;Z)V
    ...
    invoke-virtual {p0, p2}, Landroid/telecom/InCallService;->onCanAddCallChanged(Z)V
...
.method public whitelist onSilenceRinger(Landroid/telecom/Phone;)V
    ...
    invoke-virtual {p0}, Landroid/telecom/InCallService;->onSilenceRinger()V
