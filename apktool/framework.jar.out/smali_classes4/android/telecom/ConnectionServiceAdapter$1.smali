...
.method protected whitelist onReceiveResult(ILandroid/os/Bundle;)V
    ...
    :try_start_0
    iget-object p1, p0, Landroid/telecom/ConnectionServiceAdapter$1;->val$executor:Ljava/util/concurrent/Executor;

    iget-object p0, p0, Landroid/telecom/ConnectionServiceAdapter$1;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance p2, Landroid/telecom/ConnectionServiceAdapter$1$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0}, Landroid/telecom/ConnectionServiceAdapter$1$$ExternalSyntheticLambda0;-><init>(Landroid/os/OutcomeReceiver;)V
    ...
    new-instance v2, Landroid/telecom/ConnectionServiceAdapter$1$$ExternalSyntheticLambda1;

    invoke-direct {v2, p0, p2}, Landroid/telecom/ConnectionServiceAdapter$1$$ExternalSyntheticLambda1;-><init>(Landroid/os/OutcomeReceiver;Landroid/os/Bundle;)V
