...
.method private greylist-max-o decodeLiteral()Landroid/util/JsonToken;
    ...
    sget-object p0, Landroid/util/JsonToken;->STRING:Landroid/util/JsonToken;
    ...
    sget-object p0, Landroid/util/JsonToken;->BOOLEAN:Landroid/util/JsonToken;
...
.method private greylist-max-o decodeNumber([CII)Landroid/util/JsonToken;
    ...
    sget-object p0, Landroid/util/JsonToken;->NUMBER:Landroid/util/JsonToken;
...
.method private greylist-max-o getSnippet()Ljava/lang/CharSequence;
    ...
    iget p0, p0, Landroid/util/JsonReader;->pos:I
...
.method private greylist-max-o nextString(C)Ljava/lang/String;
    ...
    iget-object p0, p0, Landroid/util/JsonReader;->stringPool:Lcom/android/internal/util/StringPool;

    sub-int/2addr v5, v1

    sub-int/2addr v5, v4

    invoke-virtual {p0, v3, v1, v5}, Lcom/android/internal/util/StringPool;->get([CII)Ljava/lang/String;
...
.method private greylist-max-o peekStack()Landroid/util/JsonScope;
    ...
    iget-object p0, p0, Landroid/util/JsonReader;->stack:Ljava/util/List;
...
.method private greylist-max-o readLiteral()Landroid/util/JsonToken;
    ...
    :cond_0
    iget-object p0, p0, Landroid/util/JsonReader;->token:Landroid/util/JsonToken;
...
.method public whitelist test-api close()V
    ...
    iget-object p0, p0, Landroid/util/JsonReader;->in:Ljava/io/Reader;
...
.method public whitelist isLenient()Z
    ...
    iget-boolean p0, p0, Landroid/util/JsonReader;->lenient:Z
...
.method public whitelist nextInt()I
    ...
    iget-object p0, p0, Landroid/util/JsonReader;->value:Ljava/lang/String;
