...
.method private blacklist getCardIdForDefaultEuicc()I
    ...
    iget-object p0, p0, Landroid/telephony/euicc/EuiccManager;->mContext:Landroid/content/Context;
...
.method private blacklist refreshCardIdIfUninitialized()Z
    ...
    :cond_0
    iget p0, p0, Landroid/telephony/euicc/EuiccManager;->mCardId:I
...
.method public whitelist continueOperation(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    const-string p0, "android.telephony.euicc.extra.EMBEDDED_SUBSCRIPTION_RESOLUTION_CALLBACK_INTENT"
    ...
    invoke-static {p0}, Landroid/telephony/euicc/EuiccManager;->sendUnavailableError(Landroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Lcom/android/internal/telephony/euicc/IEuiccController;->continueOperation(ILandroid/content/Intent;Landroid/os/Bundle;)V
    :try_end_0
...
.method public whitelist createForCardId(I)Landroid/telephony/euicc/EuiccManager;
    ...
    invoke-direct {v0, p0, p1}, Landroid/telephony/euicc/EuiccManager;-><init>(Landroid/content/Context;I)V
...
.method public whitelist deleteSubscription(ILandroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, v1, p1, p0, p2}, Lcom/android/internal/telephony/euicc/IEuiccController;->deleteSubscription(IILjava/lang/String;Landroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist eraseSubscriptions(ILandroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, p0, p1, p2}, Lcom/android/internal/telephony/euicc/IEuiccController;->eraseSubscriptionsWithOptions(IILandroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist eraseSubscriptions(Landroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/android/internal/telephony/euicc/IEuiccController;->eraseSubscriptions(ILandroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist getAvailableMemoryInBytes()J
    ...
    invoke-interface {v0, v1, p0}, Lcom/android/internal/telephony/euicc/IEuiccController;->getAvailableMemoryInBytes(ILjava/lang/String;)J
...
.method public whitelist getDefaultDownloadableSubscriptionList(Landroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, v1, p0, p1}, Lcom/android/internal/telephony/euicc/IEuiccController;->getDefaultDownloadableSubscriptionList(ILjava/lang/String;Landroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist getDownloadableSubscriptionMetadata(Landroid/telephony/euicc/DownloadableSubscription;Landroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, v1, p1, p0, p2}, Lcom/android/internal/telephony/euicc/IEuiccController;->getDownloadableSubscriptionMetadata(ILandroid/telephony/euicc/DownloadableSubscription;Ljava/lang/String;Landroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist getEid()Ljava/lang/String;
    ...
    invoke-interface {v0, v1, p0}, Lcom/android/internal/telephony/euicc/IEuiccController;->getEid(ILjava/lang/String;)Ljava/lang/String;
...
.method public whitelist getEuiccInfo()Landroid/telephony/euicc/EuiccInfo;
    ...
    invoke-interface {v0, p0}, Lcom/android/internal/telephony/euicc/IEuiccController;->getEuiccInfo(I)Landroid/telephony/euicc/EuiccInfo;
...
.method public whitelist getOtaStatus()I
    ...
    invoke-interface {v0, p0}, Lcom/android/internal/telephony/euicc/IEuiccController;->getOtaStatus(I)I
...
.method public whitelist getSupportedCountries()Ljava/util/List;
    ...
    invoke-interface {p0, v0}, Lcom/android/internal/telephony/euicc/IEuiccController;->getSupportedCountries(Z)Ljava/util/List;
...
.method public whitelist isEnabled()Z
    ...
    const-string v2, "CscFeature_RIL_SupportForceEsimDeactivate"
...
.method public whitelist isPsimConversionSupported(I)Z
    ...
    invoke-interface {p0, p1}, Lcom/android/internal/telephony/euicc/IEuiccController;->isPsimConversionSupported(I)Z
...
.method public whitelist isSimPortAvailable(I)Z
    ...
    invoke-interface {v0, v1, p1, p0}, Lcom/android/internal/telephony/euicc/IEuiccController;->isSimPortAvailable(IILjava/lang/String;)Z
...
.method public whitelist isSupportedCountry(Ljava/lang/String;)Z
    ...
    invoke-interface {p0, p1}, Lcom/android/internal/telephony/euicc/IEuiccController;->isSupportedCountry(Ljava/lang/String;)Z
...
.method public greylist-max-o retainSubscriptionsForFactoryReset(Landroid/app/PendingIntent;)V
    ...
    invoke-interface {v0, p0, p1}, Lcom/android/internal/telephony/euicc/IEuiccController;->retainSubscriptionsForFactoryReset(ILandroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist setPsimConversionSupportedCarriers(Ljava/util/Set;)V
    ...
    invoke-interface {p1, p0}, Lcom/android/internal/telephony/euicc/IEuiccController;->setPsimConversionSupportedCarriers([I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string p1, "Euicc is not enabled"
...
.method public whitelist setSupportedCountries(Ljava/util/List;)V
    ...
    invoke-interface {p0, v0, p1}, Lcom/android/internal/telephony/euicc/IEuiccController;->setSupportedCountries(ZLjava/util/List;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public whitelist startResolutionActivity(Landroid/app/Activity;ILandroid/content/Intent;Landroid/app/PendingIntent;)V
    ...
    const-string p0, "android.telephony.euicc.extra.EMBEDDED_SUBSCRIPTION_RESOLUTION_INTENT"

    const-class v0, Landroid/app/PendingIntent;

    invoke-virtual {p3, p0, v0}, Landroid/content/Intent;->getParcelableExtra(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    const-string p3, "android.telephony.euicc.extra.EMBEDDED_SUBSCRIPTION_RESOLUTION_CALLBACK_INTENT"

    invoke-virtual {v3, p3, p4}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    ...
    const-string p1, "Invalid result intent"
...
.method public whitelist switchToSubscription(IILandroid/app/PendingIntent;)V
    ...
    :cond_2
    const-string p0, "EuiccManager"

    const-string p1, "Not permitted to use switchToSubscription with portIndex"

    invoke-static {p0, p1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    new-instance p0, Ljava/lang/SecurityException;

    const-string p1, "Must have carrier privileges to use switchToSubscription with portIndex"
...
.method public whitelist switchToSubscription(ILandroid/app/PendingIntent;)V
    ...
    const-string/jumbo p1, "switchToSubscription without portIndex is not allowed for disable operation"

    invoke-static {p0, p1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    new-instance p0, Ljava/lang/IllegalArgumentException;

    const-string p1, "Must use switchToSubscription with portIndex API for disable operation"
    ...
    invoke-interface {v0, v1, p1, p0, p2}, Lcom/android/internal/telephony/euicc/IEuiccController;->switchToSubscription(IILjava/lang/String;Landroid/app/PendingIntent;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
