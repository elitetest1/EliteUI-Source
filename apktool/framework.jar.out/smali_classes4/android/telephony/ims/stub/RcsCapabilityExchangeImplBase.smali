...
.method public whitelist publishCapabilities(Ljava/lang/String;Landroid/telephony/ims/stub/RcsCapabilityExchangeImplBase$PublishResponseCallback;)V
    ...
    const-string p0, "RcsCapExchangeImplBase"

    const-string/jumbo p1, "publishCapabilities called with no implementation."
    ...
    :try_start_0
    invoke-interface {p2, p0}, Landroid/telephony/ims/stub/RcsCapabilityExchangeImplBase$PublishResponseCallback;->onCommandError(I)V
    :try_end_0
...
.method public whitelist sendOptionsCapabilityRequest(Landroid/net/Uri;Ljava/util/Set;Landroid/telephony/ims/stub/RcsCapabilityExchangeImplBase$OptionsResponseCallback;)V
    ...
    const-string/jumbo p1, "sendOptionsCapabilityRequest called with no implementation."
...
.method public whitelist subscribeForCapabilities(Ljava/util/Collection;Landroid/telephony/ims/stub/RcsCapabilityExchangeImplBase$SubscribeResponseCallback;)V
    ...
    const-string/jumbo p1, "subscribeForCapabilities called with no implementation."
    ...
    :try_start_0
    invoke-interface {p2, p0}, Landroid/telephony/ims/stub/RcsCapabilityExchangeImplBase$SubscribeResponseCallback;->onCommandError(I)V
    :try_end_0
    .catch Landroid/telephony/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
