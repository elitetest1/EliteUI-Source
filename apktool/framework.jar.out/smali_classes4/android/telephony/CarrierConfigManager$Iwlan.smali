...
.method private static blacklist getDefaults()Landroid/os/PersistableBundle;
    ...
    const-string v1, "iwlan.supports_ike_session_multiple_sa_proposals_bool"

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "iwlan.supports_child_session_multiple_sa_proposals_bool"
    ...
    const-string v1, "iwlan.dpd_timer_sec_int"

    const/16 v3, 0x78

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "iwlan.max_retries_int"
    ...
    const-string v7, "iwlan.diffie_hellman_groups_int_array"
    ...
    const-string v8, "iwlan.supported_ike_session_encryption_algorithms_int_array"

    invoke-virtual {v0, v8, v7}, Landroid/os/PersistableBundle;->putIntArray(Ljava/lang/String;[I)V

    const-string v7, "iwlan.supported_ike_session_aead_algorithms_int_array"

    new-array v8, v2, [I

    invoke-virtual {v0, v7, v8}, Landroid/os/PersistableBundle;->putIntArray(Ljava/lang/String;[I)V

    const-string v7, "iwlan.supported_child_session_encryption_algorithms_int_array"
    ...
    const-string v7, "iwlan.supported_child_session_aead_algorithms_int_array"
    ...
    const-string v6, "iwlan.supported_integrity_algorithms_int_array"
    ...
    const-string v8, "iwlan.ike_session_encryption_aes_cbc_key_size_int_array"

    invoke-virtual {v0, v8, v7}, Landroid/os/PersistableBundle;->putIntArray(Ljava/lang/String;[I)V

    const-string v7, "iwlan.child_session_aes_cbc_key_size_int_array"
    ...
    const-string v7, "iwlan.ike_session_encryption_aes_ctr_key_size_int_array"
    ...
    const-string v7, "iwlan.child_session_aes_ctr_key_size_int_array"
    ...
    const-string v4, "iwlan.ike_session_encryption_aes_gcm_key_size_int_array"

    new-array v5, v2, [I

    invoke-virtual {v0, v4, v5}, Landroid/os/PersistableBundle;->putIntArray(Ljava/lang/String;[I)V

    const-string v4, "iwlan.child_session_aes_gcm_key_size_int_array"
    ...
    const-string v6, "iwlan.epdg_address_priority_int_array"

    invoke-virtual {v0, v6, v5}, Landroid/os/PersistableBundle;->putIntArray(Ljava/lang/String;[I)V

    const-string v5, "iwlan.epdg_plmn_priority_int_array"
    ...
    const-string v4, "iwlan.ike_local_id_type_int"

    invoke-virtual {v0, v4, v3}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v3, "iwlan.ike_remote_id_type_int"
    ...
    const-string v1, "iwlan.supports_eap_aka_fast_reauth_bool"

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "iwlan.epdg_address_ip_type_preference_int"
