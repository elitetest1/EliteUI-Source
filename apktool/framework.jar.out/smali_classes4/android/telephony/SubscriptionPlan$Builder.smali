...
.method public whitelist build()Landroid/telephony/SubscriptionPlan;
    ...
    iget-object p0, p0, Landroid/telephony/SubscriptionPlan$Builder;->plan:Landroid/telephony/SubscriptionPlan;
...
.method public whitelist setDataLimit(JI)Landroid/telephony/SubscriptionPlan$Builder;
    ...
    const-string p1, "Limit behavior must be defined"
    ...
    const-string p1, "Limit bytes must be positive"
...
.method public whitelist setDataUsage(JJ)Landroid/telephony/SubscriptionPlan$Builder;
    ...
    const-string p1, "Usage time must be positive"
    ...
    const-string p1, "Usage bytes must be positive"
...
.method public whitelist setSubscriptionStatus(I)Landroid/telephony/SubscriptionPlan$Builder;
    ...
    const-string p1, "Subscription status must be defined with a valid value"
