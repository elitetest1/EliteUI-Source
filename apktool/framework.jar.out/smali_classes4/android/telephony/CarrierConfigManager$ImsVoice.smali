...
.method private static blacklist getDefaults()Landroid/os/PersistableBundle;
    ...
    const-string v4, "imsvoice.amr_codec_attribute_payload_format_int"

    invoke-virtual {v3, v4, v2}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v5, "98"

    invoke-virtual {v1, v5, v3}, Landroid/os/PersistableBundle;->putPersistableBundle(Ljava/lang/String;Landroid/os/PersistableBundle;)V

    const-string v3, "imsvoice.amrwb_payload_description_bundle"
