...
.method private static blacklist getDefaults()Landroid/os/PersistableBundle;
    ...
    const-string v1, "imsss.ut_requires_ims_registration_bool"

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsss.use_csfb_on_xcap_over_ut_failure_bool"

    const/4 v3, 0x1

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsss.ut_supported_when_ps_data_off_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsss.network_initiated_ussd_over_ims_supported_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsss.ut_supported_when_roaming_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsss.ut_iptype_home_int"

    const/4 v4, 0x2

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsss.ut_iptype_roaming_int"

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsss.ut_as_server_port_int"

    const/16 v4, 0x50

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsss.ut_transport_type_int"
    ...
    const-string v1, "imsss.ut_as_server_fqdn_string"

    const-string v4, ""

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "imsss.terminal_based_call_waiting_default_enabled_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsss.terminal_based_call_waiting_sync_type_int"
