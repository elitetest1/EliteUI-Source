...
.method private static blacklist getDefaults()Landroid/os/PersistableBundle;
    ...
    const-string v1, "imsrtt.text_on_default_bearer_supported_bool"

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsrtt.text_qos_precondition_supported_bool"

    const/4 v2, 0x1

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsrtt.text_as_bandwidth_kbps_int"

    const/4 v2, 0x4

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsrtt.text_rs_bandwidth_bps_int"

    const/16 v2, 0x64

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsrtt.text_rr_bandwidth_bps_int"
    ...
    const-string v2, "imsrtt.red_payload_type_int"

    const/16 v3, 0x70

    invoke-virtual {v1, v2, v3}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v2, "imsrtt.t140_payload_type_int"

    const/16 v3, 0x6f

    invoke-virtual {v1, v2, v3}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v2, "imsrtt.text_codec_capability_payload_types_bundle"
