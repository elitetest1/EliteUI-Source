...
.method protected whitelist onReceiveResult(ILandroid/os/Bundle;)V
    ...
    const-string p1, "emergency_mode_enabled"
    ...
    iget-object p2, p0, Landroid/telephony/satellite/SatelliteManager$4;->val$executor:Ljava/util/concurrent/Executor;

    iget-object p0, p0, Landroid/telephony/satellite/SatelliteManager$4;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance v0, Landroid/telephony/satellite/SatelliteManager$4$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$4$$ExternalSyntheticLambda0;-><init>(Landroid/os/OutcomeReceiver;Z)V
    ...
    :cond_0
    const-string p1, "KEY_EMERGENCY_MODE_ENABLED does not exist."

    invoke-static {p1}, Landroid/telephony/satellite/SatelliteManager;->-$$Nest$smloge(Ljava/lang/String;)V

    iget-object p1, p0, Landroid/telephony/satellite/SatelliteManager$4;->val$executor:Ljava/util/concurrent/Executor;

    iget-object p0, p0, Landroid/telephony/satellite/SatelliteManager$4;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance p2, Landroid/telephony/satellite/SatelliteManager$4$$ExternalSyntheticLambda1;

    invoke-direct {p2, p0}, Landroid/telephony/satellite/SatelliteManager$4$$ExternalSyntheticLambda1;-><init>(Landroid/os/OutcomeReceiver;)V
    ...
    new-instance v0, Landroid/telephony/satellite/SatelliteManager$4$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$4$$ExternalSyntheticLambda2;-><init>(Landroid/os/OutcomeReceiver;I)V
