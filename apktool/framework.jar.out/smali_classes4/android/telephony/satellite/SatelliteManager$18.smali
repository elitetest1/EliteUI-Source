...
.method protected whitelist onReceiveResult(ILandroid/os/Bundle;)V
    ...
    const-string/jumbo p1, "satellite_communication_allowed"
    ...
    iget-object p2, p0, Landroid/telephony/satellite/SatelliteManager$18;->val$executor:Ljava/util/concurrent/Executor;

    iget-object p0, p0, Landroid/telephony/satellite/SatelliteManager$18;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance v0, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda0;

    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda0;-><init>(Landroid/os/OutcomeReceiver;Z)V
    ...
    :cond_0
    const-string p1, "KEY_SATELLITE_COMMUNICATION_ALLOWED does not exist."

    invoke-static {p1}, Landroid/telephony/satellite/SatelliteManager;->-$$Nest$smloge(Ljava/lang/String;)V

    iget-object p1, p0, Landroid/telephony/satellite/SatelliteManager$18;->val$executor:Ljava/util/concurrent/Executor;

    iget-object p0, p0, Landroid/telephony/satellite/SatelliteManager$18;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance p2, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda1;

    invoke-direct {p2, p0}, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda1;-><init>(Landroid/os/OutcomeReceiver;)V
    ...
    new-instance v0, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$18$$ExternalSyntheticLambda2;-><init>(Landroid/os/OutcomeReceiver;I)V
