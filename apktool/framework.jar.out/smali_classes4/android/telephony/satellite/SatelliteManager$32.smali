...
.method protected whitelist onReceiveResult(ILandroid/os/Bundle;)V
    ...
    const-string/jumbo p1, "request_provision_subscriber_id"
    ...
    const-class v0, Landroid/telephony/satellite/SatelliteSubscriberProvisionStatus;
    ...
    iget-object p2, p0, Landroid/telephony/satellite/SatelliteManager$32;->val$executor:Ljava/util/concurrent/Executor;

    iget-object p0, p0, Landroid/telephony/satellite/SatelliteManager$32;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance v0, Landroid/telephony/satellite/SatelliteManager$32$$ExternalSyntheticLambda2;

    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$32$$ExternalSyntheticLambda2;-><init>(Landroid/os/OutcomeReceiver;Ljava/util/List;)V
    ...
    :cond_0
    const-string p1, "KEY_REQUEST_PROVISION_SUBSCRIBER_ID_TOKEN does not exist."

    invoke-static {p1}, Landroid/telephony/satellite/SatelliteManager;->-$$Nest$smloge(Ljava/lang/String;)V

    iget-object p1, p0, Landroid/telephony/satellite/SatelliteManager$32;->val$executor:Ljava/util/concurrent/Executor;

    iget-object p0, p0, Landroid/telephony/satellite/SatelliteManager$32;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance p2, Landroid/telephony/satellite/SatelliteManager$32$$ExternalSyntheticLambda3;

    invoke-direct {p2, p0}, Landroid/telephony/satellite/SatelliteManager$32$$ExternalSyntheticLambda3;-><init>(Landroid/os/OutcomeReceiver;)V
    ...
    new-instance v0, Landroid/telephony/satellite/SatelliteManager$32$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$32$$ExternalSyntheticLambda4;-><init>(Landroid/os/OutcomeReceiver;I)V
