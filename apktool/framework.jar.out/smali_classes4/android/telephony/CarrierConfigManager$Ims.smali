...
.method private static blacklist getDefaults()Landroid/os/PersistableBundle;
    ...
    const-string v1, "ims.publish_service_desc_feature_tag_map_override_string_array"
    ...
    const-string v1, "ims.subscribe_retry_duration_millis_long"
    ...
    const-string v3, "ims.rcs_feature_tag_allowed_string_array"
    ...
    const-string v3, "ims.mmtel_requires_provisioning_bundle"
    ...
    const-string v3, "ims.rcs_requires_provisioning_bundle"

    invoke-virtual {v0, v3, v1}, Landroid/os/PersistableBundle;->putPersistableBundle(Ljava/lang/String;Landroid/os/PersistableBundle;)V

    const-string v1, "ims.gruu_enabled_bool"

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "ims.sip_over_ipsec_enabled_bool"
    ...
    const-string v1, "ims.registration_event_package_supported_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "ims.sip_timer_t1_millis_int"

    const/16 v4, 0x7d0

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_timer_t2_millis_int"

    const/16 v4, 0x3e80

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_timer_t4_millis_int"

    const/16 v4, 0x4268

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_timer_b_millis_int"

    const v4, 0x1f400

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_timer_c_millis_int"

    const v5, 0x33450

    invoke-virtual {v0, v1, v5}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_timer_d_millis_int"

    const v5, 0x1fbd0

    invoke-virtual {v0, v1, v5}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_timer_f_millis_int"

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_timer_h_millis_int"

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_timer_j_millis_int"

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_server_port_number_int"

    const/16 v4, 0x13c4

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.request_uri_type_int"

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.sip_preferred_transport_int"

    const/4 v4, 0x2

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.ipv4_sip_mtu_size_cellular_int"

    const/16 v5, 0x5dc

    invoke-virtual {v0, v1, v5}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.ipv6_sip_mtu_size_cellular_int"

    invoke-virtual {v0, v1, v5}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.registration_expiry_timer_sec_int"

    const v5, 0x927c0

    invoke-virtual {v0, v1, v5}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.registration_retry_base_timer_millis_int"

    const/16 v6, 0x7530

    invoke-virtual {v0, v1, v6}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.registration_retry_max_timer_millis_int"

    const v6, 0x1b7740

    invoke-virtual {v0, v1, v6}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "ims.registration_subscribe_expiry_timer_sec_int"
    ...
    const-string v1, "ims.ipsec_authentication_algorithms_int_array"
    ...
    const-string v1, "ims.ipsec_encryption_algorithms_int_array"
    ...
    const-string v1, "ims.geolocation_pidf_in_sip_register_support_int_array"
    ...
    const-string v1, "ims.geolocation_pidf_in_sip_invite_support_int_array"
