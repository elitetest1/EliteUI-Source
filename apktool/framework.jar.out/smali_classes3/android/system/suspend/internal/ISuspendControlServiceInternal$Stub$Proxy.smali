...
.method public whitelist asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Landroid/system/suspend/internal/ISuspendControlServiceInternal$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist getInterfaceDescriptor()Ljava/lang/String;
    ...
    const-string p0, "android.system.suspend.internal.ISuspendControlServiceInternal"
...
.method public blacklist getSuspendStats()Landroid/system/suspend/internal/SuspendInfo;
    ...
    sget-object p0, Landroid/system/suspend/internal/SuspendInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/system/suspend/internal/SuspendInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist getWakeLockStats()[Landroid/system/suspend/internal/WakeLockInfo;
    ...
    sget-object p0, Landroid/system/suspend/internal/WakeLockInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p0

    check-cast p0, [Landroid/system/suspend/internal/WakeLockInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist getWakeupStats()[Landroid/system/suspend/internal/WakeupInfo;
    ...
    sget-object p0, Landroid/system/suspend/internal/WakeupInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p0

    check-cast p0, [Landroid/system/suspend/internal/WakeupInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
