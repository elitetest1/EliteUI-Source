...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/net/metrics/RaEvent;
    ...
    new-instance p0, Landroid/net/metrics/RaEvent;

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Landroid/net/metrics/RaEvent;-><init>(Landroid/os/Parcel;Landroid/net/metrics/RaEvent-IA;)V
...
.method public blacklist newArray(I)[Landroid/net/metrics/RaEvent;
    ...
    new-array p0, p1, [Landroid/net/metrics/RaEvent;
