...
.method public greylist-max-o addConnectResult(IILjava/lang/String;)V
    ...
    iget-object p0, p0, Landroid/net/metrics/NetworkMetrics;->pendingSummary:Landroid/net/metrics/NetworkMetrics$Summary;

    iget-object p0, p0, Landroid/net/metrics/NetworkMetrics$Summary;->connectLatencies:Landroid/net/metrics/NetworkMetrics$Metrics;

    int-to-double p1, p2

    invoke-virtual {p0, p1, p2}, Landroid/net/metrics/NetworkMetrics$Metrics;->count(D)V
...
.method public greylist-max-o addDnsResult(III)V
    ...
    invoke-virtual {v0, p1, v1, p3}, Landroid/net/metrics/DnsEvent;->addResult(BBI)Z

    move-result p1

    iget-object v0, p0, Landroid/net/metrics/NetworkMetrics;->pendingSummary:Landroid/net/metrics/NetworkMetrics$Summary;

    iget-object v0, v0, Landroid/net/metrics/NetworkMetrics$Summary;->dnsLatencies:Landroid/net/metrics/NetworkMetrics$Metrics;
    ...
    iget-object v0, v0, Landroid/net/metrics/NetworkMetrics$Summary;->dnsErrorRate:Landroid/net/metrics/NetworkMetrics$Metrics;
    ...
    :goto_0
    invoke-virtual {v0, v3, v4}, Landroid/net/metrics/NetworkMetrics$Metrics;->count(D)V
    ...
    invoke-virtual {p1, v1, v2}, Landroid/net/metrics/NetworkMetrics$Metrics;->count(D)V

    :cond_3
    iget-object p0, p0, Landroid/net/metrics/NetworkMetrics;->pendingSummary:Landroid/net/metrics/NetworkMetrics$Summary;

    invoke-static {p0}, Landroid/net/metrics/NetworkMetrics$Summary;->-$$Nest$mmarkUpdated(Landroid/net/metrics/NetworkMetrics$Summary;)V
...
.method public greylist-max-o getPendingStats()Landroid/net/metrics/NetworkMetrics$Summary;
    ...
    iget-object p0, p0, Landroid/net/metrics/NetworkMetrics;->summary:Landroid/net/metrics/NetworkMetrics$Summary;

    invoke-virtual {p0, v0}, Landroid/net/metrics/NetworkMetrics$Summary;->merge(Landroid/net/metrics/NetworkMetrics$Summary;)V
