...
.method private blacklist checkPermissions()V
    ...
    iget-object p0, p0, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService$1;->this$0:Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;

    const-string v0, "android.permission.NETWORK_SETUP_WIZARD"

    invoke-virtual {p0, v0}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->checkCallingOrSelfPermission(Ljava/lang/String;)I
    ...
    const-string v0, "Calling process must have NETWORK_SETTINGS or NETWORK_SETUP_WIZARD permission"
...
.method private synthetic blacklist lambda$connectHotspotNetwork$2(Landroid/net/wifi/sharedconnectivity/app/HotspotNetwork;)V
    ...
    invoke-virtual {p0, p1}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->onConnectHotspotNetwork(Landroid/net/wifi/sharedconnectivity/app/HotspotNetwork;)V
...
.method private synthetic blacklist lambda$connectKnownNetwork$4(Landroid/net/wifi/sharedconnectivity/app/KnownNetwork;)V
    ...
    invoke-virtual {p0, p1}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->onConnectKnownNetwork(Landroid/net/wifi/sharedconnectivity/app/KnownNetwork;)V
...
.method private synthetic blacklist lambda$disconnectHotspotNetwork$3(Landroid/net/wifi/sharedconnectivity/app/HotspotNetwork;)V
    ...
    invoke-virtual {p0, p1}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->onDisconnectHotspotNetwork(Landroid/net/wifi/sharedconnectivity/app/HotspotNetwork;)V
...
.method private synthetic blacklist lambda$forgetKnownNetwork$5(Landroid/net/wifi/sharedconnectivity/app/KnownNetwork;)V
    ...
    invoke-virtual {p0, p1}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->onForgetKnownNetwork(Landroid/net/wifi/sharedconnectivity/app/KnownNetwork;)V
...
.method private synthetic blacklist lambda$registerCallback$0(Landroid/net/wifi/sharedconnectivity/service/ISharedConnectivityCallback;)V
    ...
    invoke-static {p0, p1}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->-$$Nest$monRegisterCallback(Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;Landroid/net/wifi/sharedconnectivity/service/ISharedConnectivityCallback;)V
...
.method private synthetic blacklist lambda$unregisterCallback$1(Landroid/net/wifi/sharedconnectivity/service/ISharedConnectivityCallback;)V
    ...
    invoke-static {p0, p1}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->-$$Nest$monUnregisterCallback(Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;Landroid/net/wifi/sharedconnectivity/service/ISharedConnectivityCallback;)V
...
.method public blacklist getHotspotNetworkConnectionStatus()Landroid/net/wifi/sharedconnectivity/app/HotspotNetworkConnectionStatus;
    ...
    invoke-static {p0}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->-$$Nest$fgetmHotspotNetworkConnectionStatus(Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;)Landroid/net/wifi/sharedconnectivity/app/HotspotNetworkConnectionStatus;
...
.method public blacklist getHotspotNetworks()Ljava/util/List;
    ...
    invoke-static {p0}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->-$$Nest$fgetmHotspotNetworks(Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;)Ljava/util/List;
...
.method public blacklist getKnownNetworkConnectionStatus()Landroid/net/wifi/sharedconnectivity/app/KnownNetworkConnectionStatus;
    ...
    invoke-static {p0}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->-$$Nest$fgetmKnownNetworkConnectionStatus(Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;)Landroid/net/wifi/sharedconnectivity/app/KnownNetworkConnectionStatus;
...
.method public blacklist getKnownNetworks()Ljava/util/List;
    ...
    invoke-static {p0}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->-$$Nest$fgetmKnownNetworks(Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;)Ljava/util/List;
...
.method public blacklist getSettingsState()Landroid/net/wifi/sharedconnectivity/app/SharedConnectivitySettingsState;
    ...
    invoke-static {p0}, Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;->-$$Nest$fgetmSettingsState(Landroid/net/wifi/sharedconnectivity/service/SharedConnectivityService;)Landroid/net/wifi/sharedconnectivity/app/SharedConnectivitySettingsState;
