...
.method private blacklist setupSignaturesMap()V
    ...
    iget-object p0, p0, Landroid/sec/clipboard/util/SemClipboardPolicy;->mSignaturesMap:Landroid/util/SparseArray;
...
.method public blacklist canAccessSemClipboard(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    const-string p0, "Failed to get packageName"

    invoke-static {v4, p0}, Landroid/sec/clipboard/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string p1, " is not exist in uid packages : "
    ...
    invoke-virtual {v1, p2, v0, p3}, Landroid/content/pm/PackageManager;->getPackageInfoAsUser(Ljava/lang/String;Landroid/content/pm/PackageManager$PackageInfoFlags;I)Landroid/content/pm/PackageInfo;
    ...
    const-string p0, "App is system App"

    invoke-static {v4, p0}, Landroid/sec/clipboard/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    return v2

    :cond_3
    const-string v0, "com.samsung.android.clipboard.ACCESS_SEMCLIPBOARD"

    invoke-virtual {v1, v0, p2}, Landroid/content/pm/PackageManager;->checkPermission(Ljava/lang/String;Ljava/lang/String;)I

    move-result v0

    if-nez v0, :cond_4

    const-string p0, "SemClipboard Permission is granted"
    ...
    iget-object p1, p0, Landroid/sec/clipboard/util/SemClipboardPolicy;->mSignaturesMap:Landroid/util/SparseArray;
    ...
    invoke-direct {v1, v5}, Landroid/content/pm/Signature;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Landroid/sec/clipboard/util/SemClipboardPolicy;->hasSamsungKey(Ljava/util/List;)Z

    move-result p3

    if-eqz p3, :cond_6

    const-string p0, "App key is samsung key"
    ...
    :cond_6
    const-string p3, "App key is not samsung key!!!"

    invoke-static {v4, p3}, Landroid/sec/clipboard/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    iget-object p3, p0, Landroid/sec/clipboard/util/SemClipboardPolicy;->mSemClipboardAccessAllowList:Ljava/util/HashMap;
    ...
    const-string p0, "Allow lists does not include this App"
    ...
    invoke-direct {p0, p1, p3}, Landroid/sec/clipboard/util/SemClipboardPolicy;->isMatchedSignature(Ljava/util/List;I)Z

    move-result p0

    if-nez p0, :cond_8

    const-string p1, "Allow lists don\'t match this App"

    invoke-static {v4, p1}, Landroid/sec/clipboard/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_0
    ...
    const-string p1, "Failed to get packageName for uid : "
