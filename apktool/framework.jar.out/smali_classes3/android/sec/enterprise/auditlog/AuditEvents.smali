...
.field public static final blacklist AUDIT_ADD_TRUSTED:Ljava/lang/String; = "Admin %s has added a certificate to the trusted DB. Subject : %s, Issuer : %s"

.field public static final blacklist AUDIT_ADD_UNTRUSTED:Ljava/lang/String; = "Admin %s has added a certificate to the untrusted DB. Subject : %s, Issuer : %s"
...
.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_ACCOUNT_TO_THE_ADDITION_ALLOWLIST:Ljava/lang/String; = "Admin %s has added account %s to the addition allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_ACCOUNT_TO_THE_ADDITION_BLOCKLIST:Ljava/lang/String; = "Admin %s has added account %s to the addition blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_ACCOUNT_TO_THE_REMOVAL_ALLOWLIST:Ljava/lang/String; = "Admin %s has added account %s to the removal allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_ACCOUNT_TO_THE_REMOVAL_BLOCKLIST:Ljava/lang/String; = "Admin %s has added account %s to the removal blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_APPROVED_INSTALLER_ALLOWLIST:Ljava/lang/String; = "Admin %s has added approved installer allowlist %s."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_APPROVED_INSTALLER_BLOCKLIST:Ljava/lang/String; = "Admin %s has added approved installer blocklist %s."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_SSID_TO_THE_RESTRICTION_ALLOWLIST:Ljava/lang/String; = "Admin %s has added SSID %s to the restriction allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_SSID_TO_THE_RESTRICTION_BLOCKLIST:Ljava/lang/String; = "Admin %s has added SSID %s to the restriction blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_TO_APP_SIGNATURE_ALLOWLIST:Ljava/lang/String; = "Admin %s has added %s to app signature allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_TO_APP_SIGNATURE_BLOCKLIST:Ljava/lang/String; = "Admin %s has added %s to app signature blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_TO_CAMERA_ALLOWLIST:Ljava/lang/String; = "Admin %s has added %s : %s to camera allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_TO_PACKAGE_NAME_ALLOWLIST:Ljava/lang/String; = "Admin %s has added %s to package name allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_TO_PACKAGE_NAME_BLOCKLIST:Ljava/lang/String; = "Admin %s has added %s to package name blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_ADDED_TO_PERMISSION_BLOCKLIST:Ljava/lang/String; = "Admin %s has added %s to permission blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_ACCESS_TO_WIFI_SSID:Ljava/lang/String; = "Admin %s has allowed access to Wifi SSID: %s"

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_AIRPLANE_MODE:Ljava/lang/String; = "Admin %s has allowed airplane mode."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_BIOMETRIC_AUTHENTICATION_FACE:Ljava/lang/String; = "Admin %s has allowed BIOMETRIC_AUTHENTICATION_FACE"

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_BIOMETRIC_AUTHENTICATION_FINGERPRINT:Ljava/lang/String; = "Admin %s has allowed BIOMETRIC_AUTHENTICATION_FINGERPRINT"

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_BIOMETRIC_AUTHENTICATION_IRIS:Ljava/lang/String; = "Admin %s has allowed BIOMETRIC_AUTHENTICATION_IRIS"

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_BLUETOOTH_PROFILE:Ljava/lang/String; = "Admin %s has allowed %s bluetooth profile."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_CAMERA:Ljava/lang/String; = "Admin %s has allowed camera."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_DATA_SAVING:Ljava/lang/String; = "Admin %s has allowed data saving."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_DEVELOPER_MODE:Ljava/lang/String; = "Admin %s has allowed developer mode."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_INSTALLATION_OF_NON_G_PLAY_APPLICATION:Ljava/lang/String; = "Admin %s has allowed installation of non-Google-Play application."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_MICROPHONE:Ljava/lang/String; = "Admin %s has allowed microphone."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_MOVING_APPLICATIONS_TO_CONTAINER:Ljava/lang/String; = "Admin %s has allowed moving applications to container."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_MOVING_FILES_TO_CONTAINER:Ljava/lang/String; = "Admin %s has allowed moving files to container."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_MOVING_FILES_TO_OWNER:Ljava/lang/String; = "Admin %s has allowed moving files to owner."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_SHARING_CLIPBOARD_TO_OWNER_FROM_WORKSPACE:Ljava/lang/String; = "Admin %s has allowed sharing clipboard to owner from Workspace."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_SVOICE:Ljava/lang/String; = "Admin %s has allowed SVoice."
...
.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_TO_INSTALL_APPLICATION:Ljava/lang/String; = "Admin %s has allowed to install application %s"

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_USB_HOST_STORAGE:Ljava/lang/String; = "Admin %s has allowed USB Host Storage."

.field public static final blacklist AUDIT_ADMIN_HAS_ALLOWED_USER_TO_SET_VPN_ALWAYS_ON_MODE:Ljava/lang/String; = "Admin %s has allowed user to set VPN Always On mode."

.field public static final blacklist AUDIT_ADMIN_HAS_BLOCKED_BLUETOOTH_PROFILE:Ljava/lang/String; = "Admin %s has blocked %s bluetooth profile."

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_ALLOW_BLUETOOTH:Ljava/lang/String; = "Admin %s has changed allow bluetooth to %s"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_BANNER_SETTINGS:Ljava/lang/String; = "Admin %s has changed banner settings."

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_BANNER_WALLPAPER_TO_FILE:Ljava/lang/String; = "Admin %s has changed banner wallpaper to file %s"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_BLUETOOTH_ENABLED:Ljava/lang/String; = "Admin %s has changed bluetooth enabled to %s"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_LOCK_SCREEN_STATE_TO_DISABLED:Ljava/lang/String; = "Admin %s has changed lock screen state to disabled"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_LOCK_SCREEN_STATE_TO_ENABLED:Ljava/lang/String; = "Admin %s has changed lock screen state to enabled"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_LOCK_SCREEN_STRING:Ljava/lang/String; = "Admin %s has changed lock screen string to %s"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_MAXIMUM_FAILED_PASSWORDS_FOR_DISABLE:Ljava/lang/String; = "Admin %s has changed maximum failed passwords for disable to %d"
...
.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_NFC_STATE_CHANGE:Ljava/lang/String; = "Admin %s has changed NFC state change to %s"
...
.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_PASSWORD_FORBIDDEN:Ljava/lang/String; = "Admin %s has changed password forbidden strings to %s"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_PASSWORD_MAXIMUM_CHARACTER_OCCURRENCES:Ljava/lang/String; = "Admin %s has changed password maximum character occurrences to %d"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_PASSWORD_MAXIMUM_CHARACTER_SEQUENCE_LENGTH:Ljava/lang/String; = "Admin %s has changed password maximum character sequence length to %d"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_PASSWORD_MAXIMUM_NUMERIC_SEQUENCE:Ljava/lang/String; = "Admin %s has changed password maximum numeric sequence to %d"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_PASSWORD_MINIMUM_CHARACTER_CHANGE_LENGTH:Ljava/lang/String; = "Admin %s has changed password minimum number of changed characters to %d"
...
.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_PASSWORD_REQUIRED_PATTERN_TO_REGEX:Ljava/lang/String; = "Admin %s has changed password required pattern to %s"
...
.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_WIFI_ALLOWED:Ljava/lang/String; = "Admin %s has changed Wifi allowed to %s"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_WIFI_ENABLED:Ljava/lang/String; = "Admin %s has changed Wifi enabled to %s"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_WIFI_SSID_RESTRICTION_ENABLE:Ljava/lang/String; = "Admin %s has changed Wifi SSID restriction to %s"

.field public static final blacklist AUDIT_ADMIN_HAS_CHANGED_WIFI_STATE_CHANGE_ALLOWED:Ljava/lang/String; = "Admin %s has changed Wifi state change allowed to %s"
...
.field public static final blacklist AUDIT_ADMIN_HAS_CLEARED_THE_LOCK_SCREEN_STRING:Ljava/lang/String; = "Admin %s has cleared the lock screen string."
...
.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_ACCESS_TO_EXTERNAL_SD_CARD:Ljava/lang/String; = "Admin %s has disabled access to external SDCard."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_APPLICATION:Ljava/lang/String; = "Admin %s has disabled application %s."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_AUTOMATIC_TIME:Ljava/lang/String; = "Admin %s has disabled automatic time."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_AUTOSYNC_OF_G_ACCOUNT:Ljava/lang/String; = "Admin %s has disabled Autosync of Google account."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_AUTO_FILL_SETTINGS:Ljava/lang/String; = "Admin %s has disabled Auto Fill Setting"

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_BLUETOOTH_DISCOVERABLE_STATE:Ljava/lang/String; = "Admin %s has disabled Bluetooth discoverable state."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_BLUETOOTH_LIMITED_DISCOVERABLE_STATE:Ljava/lang/String; = "Admin %s has disabled bluetooth limited discoverable state."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_BLUETOOTH_TETHERING:Ljava/lang/String; = "Admin %s has disabled bluetooth Tethering."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_CELLULAR_DATA:Ljava/lang/String; = "Admin %s has disabled cellular data."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_CERTIFICATE_REVOCATION:Ljava/lang/String; = "Admin %s has disabled certificate revocation check for %s"

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_DATE_TIME_CHANGES:Ljava/lang/String; = "Admin %s has disabled date time changes."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_OCSP:Ljava/lang/String; = "Admin %s has disabled OCSP for %s"

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_REBOOT_BANNER:Ljava/lang/String; = "Admin %s has disabled reboot banner."
...
.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_SBEAM:Ljava/lang/String; = "Admin %s has disabled SBeam."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_USB_DEBUGGING:Ljava/lang/String; = "Admin %s has disabled USB debugging."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_USB_MEDIA_PLAYER_MTP:Ljava/lang/String; = "Admin %s has disabled USB Media Player (MTP)."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_USB_TETHERING_SETTING:Ljava/lang/String; = "Admin %s has disabled USB Tethering setting."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_VPN:Ljava/lang/String; = "Admin %s has disabled Vpn."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_VPN_ALWAYS_ON_MODE:Ljava/lang/String; = "Admin %s has disabled VPN Always On mode."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_WIFI_DIRECT:Ljava/lang/String; = "Admin %s has disabled Wifi Direct."

.field public static final blacklist AUDIT_ADMIN_HAS_DISABLED_WIFI_TETHERING_SETTING:Ljava/lang/String; = "Admin %s has disabled Wifi Tethering setting."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_AIRPLANE_MODE:Ljava/lang/String; = "Admin %s has disallowed airplane mode."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_BIOMETRIC_AUTHENTICATION_FACE:Ljava/lang/String; = "Admin %s has disallowed BIOMETRIC_AUTHENTICATION_FACE"

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_BIOMETRIC_AUTHENTICATION_FINGERPRINT:Ljava/lang/String; = "Admin %s has disallowed BIOMETRIC_AUTHENTICATION_FINGERPRINT"

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_BIOMETRIC_AUTHENTICATION_IRIS:Ljava/lang/String; = "Admin %s has disallowed BIOMETRIC_AUTHENTICATION_IRIS"

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_CAMERA:Ljava/lang/String; = "Admin %s has disallowed camera."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_DATA_SAVING:Ljava/lang/String; = "Admin %s has disallowed data saving."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_DEVELOPER_MODE:Ljava/lang/String; = "Admin %s has disallowed developer mode."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_INSTALLATION_OF_NON_G_PLAY_APPLICATION:Ljava/lang/String; = "Admin %s has disallowed installation of non-Google-Play application."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_MICROPHONE:Ljava/lang/String; = "Admin %s has disallowed microphone."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_MOVING_APPLICATIONS_TO_CONTAINER:Ljava/lang/String; = "Admin %s has disallowed moving applications to container."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_MOVING_FILES_TO_CONTAINER:Ljava/lang/String; = "Admin %s has disallowed moving files to container."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_MOVING_FILES_TO_OWNER:Ljava/lang/String; = "Admin %s has disallowed moving files to owner."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_SHARING_CLIPBOARD_TO_OWNER_FROM_WORKSPACE:Ljava/lang/String; = "Admin %s has disallowed sharing clipboard to owner from Workspace."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_SVOICE:Ljava/lang/String; = "Admin %s has disallowed SVoice."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_TO_INSTALL_APPLICATION:Ljava/lang/String; = "Admin %s has disallowed to install application %s"

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_USB_HOST_STORAGE:Ljava/lang/String; = "Admin %s has disallowed USB Host Storage."

.field public static final blacklist AUDIT_ADMIN_HAS_DISALLOWED_USER_TO_SET_VPN_ALWAYS_ON_MODE:Ljava/lang/String; = "Admin %s has disallowed user to set VPN Always On mode."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_ACCESS_TO_EXTERNAL_SD_CARD:Ljava/lang/String; = "Admin %s has enabled access to external SDCard."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_APPLICATION:Ljava/lang/String; = "Admin %s has enabled application %s."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_AUTOMATIC_TIME:Ljava/lang/String; = "Admin %s has enabled automatic time."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_AUTOSYNC_OF_G_ACCOUNT:Ljava/lang/String; = "Admin %s has enabled Autosync of Google account."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_AUTO_FILL_SETTINGS:Ljava/lang/String; = "Admin %s has enabled Auto Fill Setting"

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_BLUETOOTH_DISCOVERABLE_STATE:Ljava/lang/String; = "Admin %s has enabled Bluetooth discoverable state."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_BLUETOOTH_LIMITED_DISCOVERABLE_STATE:Ljava/lang/String; = "Admin %s has enabled bluetooth limited discoverable state."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_BLUETOOTH_TETHERING:Ljava/lang/String; = "Admin %s has enabled bluetooth Tethering."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_CELLULAR_DATA:Ljava/lang/String; = "Admin %s has enabled cellular data."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_CERTIFICATE_REVOCATION:Ljava/lang/String; = "Admin %s has enabled certificate revocation check for %s"

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_DATE_TIME_CHANGES:Ljava/lang/String; = "Admin %s has enabled date time changes."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_OCSP:Ljava/lang/String; = "Admin %s has enabled OCSP for %s"

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_REBOOT_BANNER:Ljava/lang/String; = "Admin %s has enabled reboot banner."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_REBOOT_BANNER_WITH_TEXT:Ljava/lang/String; = "Admin %s has enabled reboot banner with text %s"
...
.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_SBEAM:Ljava/lang/String; = "Admin %s has enabled SBeam."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_USB_DEBUGGING:Ljava/lang/String; = "Admin %s has enabled USB debugging."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_USB_MEDIA_PLAYER_MTP:Ljava/lang/String; = "Admin %s has enabled USB Media Player (MTP)."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_USB_TETHERING_SETTING:Ljava/lang/String; = "Admin %s has enabled USB Tethering setting."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_VPN:Ljava/lang/String; = "Admin %s has enabled Vpn."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_VPN_PROFILE_TO_ALWAYS_ON_MODE:Ljava/lang/String; = "Admin %s has enabled %s VPN profile to Always On mode."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_WIFI_DIRECT:Ljava/lang/String; = "Admin %s has enabled Wifi Direct."

.field public static final blacklist AUDIT_ADMIN_HAS_ENABLED_WIFI_TETHERING_SETTING:Ljava/lang/String; = "Admin %s has enabled Wifi Tethering setting."

.field public static final blacklist AUDIT_ADMIN_HAS_INSTALLED_APPLICATION:Ljava/lang/String; = "Admin %s has installed application %s"

.field public static final blacklist AUDIT_ADMIN_HAS_INSTALLED_APPLICATION_FROM_PATH:Ljava/lang/String; = "Admin %s has installed application from %s."

.field public static final blacklist AUDIT_ADMIN_HAS_INSTALLED_APPLICATION_FROM_PATH_ON_SD_CARD:Ljava/lang/String; = "Admin %s has installed application from %s on SdCard."
...
.field public static final blacklist AUDIT_ADMIN_HAS_LOCKED_WORKSPACE:Ljava/lang/String; = "Admin %s has locked Workspace."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ACCOUNT_FROM_ADDITION_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed account %s from addition allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ACCOUNT_FROM_ADDITION_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed account %s from addition blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ACCOUNT_FROM_REMOVAL_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed account %s from removal allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ACCOUNT_FROM_REMOVAL_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed account %s from removal blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ALL_ACCOUNTS_FROM_ADDITION_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed all accounts from addition allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ALL_ACCOUNTS_FROM_ADDITION_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed all accounts from addition blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ALL_ACCOUNTS_FROM_REMOVAL_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed all accounts from removal allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ALL_ACCOUNTS_FROM_REMOVAL_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed all accounts from removal blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ALL_SSIDS_FROM_THE_RESTRICTION_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed all SSIDs from the restriction allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_ALL_SSID_FROM_THE_RESTRICTION_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed all SSIDs from the restriction blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_APPLICATION:Ljava/lang/String; = "Admin %s has removed application %s."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_APPLICATION_KEEPING_DATA_AND_CACHE:Ljava/lang/String; = "Admin %s has removed application %s keeping data and cache."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_APPROVED_INSTALLER_FROM_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed approved installer from allowlist %s."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_APPROVED_INSTALLER_FROM_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed approved installer from blocklist %s."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_FROM_APP_SIGNATURE_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed %s from app signature allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_FROM_APP_SIGNATURE_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed %s from app signature blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_FROM_CAMERA_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed %s : %s from camera allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_FROM_PACKAGE_NAME_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed %s from package name allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_FROM_PACKAGE_NAME_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed %s from package name blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_FROM_PERMISSION_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed %s from permission blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_SSID_FROM_THE_RESTRICTION_ALLOWLIST:Ljava/lang/String; = "Admin %s has removed SSID %s from the restriction allowlist."

.field public static final blacklist AUDIT_ADMIN_HAS_REMOVED_SSID_FROM_THE_RESTRICTION_BLOCKLIST:Ljava/lang/String; = "Admin %s has removed SSID %s from the restriction blocklist."

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_ENCRYPTION_OF_EXTERNAL_STORAGE:Ljava/lang/String; = "Admin %s has requested encryption of external storage"

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_ENCRYPTION_OF_INTERNAL_STORAGE:Ljava/lang/String; = "Admin %s has requested encryption of internal storage"

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_FULL_WIPE_OF_DEVICE:Ljava/lang/String; = "Admin %s has requested full wipe of device."

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_TO_CLEAR_CREDENTIAL_STORAGES:Ljava/lang/String; = "Admin %s has requested to clear credential storages"

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_TO_DELETE_CERTIFICATE_KEYSTORE_ALIAS_SUBJECT_ISSUER:Ljava/lang/String; = "Admin %s has requested to delete a certificate. Keystore(s) : %s, Alias : %s, Subject : %s, Issuer : %s"

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_TO_DISABLE_CCMODE:Ljava/lang/String; = "Admin %s has requested to disable CCMode."

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_TO_ENABLE_CCMODE:Ljava/lang/String; = "Admin %s has requested to enable CCMode."

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_TO_INSTALL_CERTIFICATE_KEYSTORE_AND_NAME:Ljava/lang/String; = "Admin %s has requested to install a certificate. Keystore(s) : %s, Name : %s"

.field public static final blacklist AUDIT_ADMIN_HAS_REQUESTED_WIPE_OF_DEVICE_EXTERNAL_MEMORY:Ljava/lang/String; = "Admin %s has requested wipe of device external memory."

.field public static final blacklist AUDIT_ADMIN_HAS_RESET_BANNER_SETTINGS:Ljava/lang/String; = "Admin %s has reset banner settings."

.field public static final blacklist AUDIT_ADMIN_HAS_RESET_BANNER_WALLPAPER:Ljava/lang/String; = "Admin %s has reset banner wallpaper."

.field public static final blacklist AUDIT_ADMIN_HAS_SET_ITSELF_AS_NOT_REMOVABLE:Ljava/lang/String; = "Admin %s has set itself as not removable"

.field public static final blacklist AUDIT_ADMIN_HAS_SET_ITSELF_AS_REMOVABLE:Ljava/lang/String; = "Admin %s has set itself as removable"

.field public static final blacklist AUDIT_ADMIN_HAS_SET_NEW_WIFI_PROFILE_SSID_SECURITY_TYPE:Ljava/lang/String; = "Admin %s has set a new wifi profile: SSID: %s Security type: %s CA certificate: %s Client credentials: %s"

.field public static final blacklist AUDIT_ADMIN_HAS_SET_PACKAGE_NAME_AS_NOT_REMOVABLE:Ljava/lang/String; = "Admin %s has set %s as not removable"

.field public static final blacklist AUDIT_ADMIN_HAS_SET_PACKAGE_NAME_AS_REMOVABLE:Ljava/lang/String; = "Admin %s has set %s as removable"

.field public static final blacklist AUDIT_ADMIN_HAS_STARTED_GPS:Ljava/lang/String; = "Admin %s has started GPS"

.field public static final blacklist AUDIT_ADMIN_HAS_STOPPED_GPS:Ljava/lang/String; = "Admin %s has stopped GPS"

.field public static final blacklist AUDIT_ADMIN_HAS_SUCCESSFULLY_LOCKED_WORKSPACE:Ljava/lang/String; = "Admin %s has successfully locked Workspace"

.field public static final blacklist AUDIT_ADMIN_HAS_SUCCESSFULLY_REMOVED_WORKSPACE:Ljava/lang/String; = "Admin %s has successfully removed Workspace %d"

.field public static final blacklist AUDIT_ADMIN_HAS_SUCCESSFULLY_REQUESTED_TO_CREATE_CONTAINER:Ljava/lang/String; = "Admin %s has successfully requested to create container."

.field public static final blacklist AUDIT_ADMIN_HAS_SUCCESSFULLY_UNLOCKED_WORKSPACE:Ljava/lang/String; = "Admin %s has successfully unlocked Workspace"

.field public static final blacklist AUDIT_ADMIN_HAS_UNLOCKED_WORKSPACE:Ljava/lang/String; = "Admin %s has unlocked Workspace."
...
.field public static final blacklist AUDIT_APPLICATION_COEXISTENT_INSTALLATION_IS_ALLOWED_BY_ADMIN_FOR_SEPARATED_APPS:Ljava/lang/String; = "Application %s coexistence installation is allowed by admin %s for Separated Apps"
...
.field public static final blacklist AUDIT_APPLICATION_INSTALLED_FROM_INSECURE_FILE_PATH:Ljava/lang/String; = "Application installed from %s an insecure file path"
...
.field public static final blacklist AUDIT_CAPTURING_SCREENSHOT_FAILURE:Ljava/lang/String; = "Capturing screenshot failure"

.field public static final blacklist AUDIT_CAPTURING_SCREENSHOT_SUCCESS:Ljava/lang/String; = "Capturing screenshot success"
...
.field public static final blacklist AUDIT_CLIENT_DEVICE_CONNECTED_TO_WIFI_HOTSPOT:Ljava/lang/String; = "Client device connected to Wi-Fi hotspot"

.field public static final blacklist AUDIT_CLIENT_DEVICE_DISCONNECTED_FROM_WIFI_HOTSPOT:Ljava/lang/String; = "Client device disconnected from Wi-Fi hotspot"
...
.field public static final blacklist AUDIT_DISABLING_BLUETOOTH:Ljava/lang/String; = "Disabling Bluetooth"
...
.field public static final blacklist AUDIT_FAIL_DECRYPT_FILE:Ljava/lang/String; = "AUDIT: user_id[%d]/pid[%d]/ino[%d]/err[%d] failed to decrypt file[%s]"

.field public static final blacklist AUDIT_FAIL_ENCRYPT_FILE:Ljava/lang/String; = "AUDIT: user_id[%d]/pid[%d]/ino[%d]/err[%d] failed to encrypt file[%s]"
...
.field public static final blacklist AUDIT_INCORRECT_BIOMETRIC_AUTHENTICATION_ATTEMPTS_LIMIT_REACHED:Ljava/lang/String; = "Incorrect biometric authentication attempts %d limit reached"
...
.field public static final blacklist AUDIT_MICROPHONE_DISABLED:Ljava/lang/String; = "Microphone disabled by %s"

.field public static final blacklist AUDIT_MICROPHONE_ENABLED:Ljava/lang/String; = "Microphone enabled by %s"
...
.field public static final blacklist AUDIT_PACKAGE_INSTALLED_FROM_SOURCE:Ljava/lang/String; = "Application %s - version %s - installed successfully. Installer package: %s"
...
.field public static final blacklist AUDIT_REMOVE_TRUSTED:Ljava/lang/String; = "Admin %s has removed a certificate from the trusted DB. Subject : %s, Issuer : %s"

.field public static final blacklist AUDIT_REMOVE_UNTRUSTED:Ljava/lang/String; = "Admin %s has removed a certificate from the untrusted DB. Subject : %s, Issuer : %s"
