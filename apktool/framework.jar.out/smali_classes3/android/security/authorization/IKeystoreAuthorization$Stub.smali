...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string p0, "getLastAuthTime"

    return-object p0

    :pswitch_1
    const-string p0, "getAuthTokensForCredStore"

    return-object p0

    :pswitch_2
    const-string/jumbo p0, "onNonLskfUnlockMethodsExpired"

    return-object p0

    :pswitch_3
    const-string/jumbo p0, "onWeakUnlockMethodsExpired"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, v2, v3, p1}, Landroid/security/authorization/IKeystoreAuthorization$Stub;->getLastAuthTime(J[I)J
    ...
    invoke-virtual {v2, p0}, Landroid/security/authorization/IKeystoreAuthorization$Stub;->onNonLskfUnlockMethodsExpired(I)V
    ...
    invoke-virtual {v2, p0}, Landroid/security/authorization/IKeystoreAuthorization$Stub;->onWeakUnlockMethodsExpired(I)V
    ...
    invoke-virtual {v2, p0, p1, p4}, Landroid/security/authorization/IKeystoreAuthorization$Stub;->onDeviceLocked(I[JZ)V
    ...
    invoke-virtual {v2, p0, p1}, Landroid/security/authorization/IKeystoreAuthorization$Stub;->onDeviceUnlocked(I[B)V
    ...
    sget-object p0, Landroid/hardware/security/keymint/HardwareAuthToken;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/hardware/security/keymint/HardwareAuthToken;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {v2, p0}, Landroid/security/authorization/IKeystoreAuthorization$Stub;->addAuthToken(Landroid/hardware/security/keymint/HardwareAuthToken;)V
