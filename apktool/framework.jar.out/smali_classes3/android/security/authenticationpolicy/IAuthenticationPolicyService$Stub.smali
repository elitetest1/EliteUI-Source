...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/security/authenticationpolicy/IAuthenticationPolicyService;
    ...
    check-cast v0, Landroid/security/authenticationpolicy/IAuthenticationPolicyService;

    return-object v0

    :cond_1
    new-instance v0, Landroid/security/authenticationpolicy/IAuthenticationPolicyService$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/security/authenticationpolicy/IAuthenticationPolicyService$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string p0, "disableSecureLockDevice"

    return-object p0

    :cond_1
    const-string p0, "enableSecureLockDevice"
...
.method protected blacklist disableSecureLockDevice_enforcePermission()V
    ...
    iget-object p0, p0, Landroid/security/authenticationpolicy/IAuthenticationPolicyService$Stub;->mEnforcer:Landroid/os/PermissionEnforcer;
    ...
    const-string v2, "android.permission.MANAGE_SECURE_LOCK_DEVICE"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_2
    sget-object p1, Landroid/security/authenticationpolicy/DisableSecureLockDeviceParams;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/security/authenticationpolicy/DisableSecureLockDeviceParams;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/security/authenticationpolicy/IAuthenticationPolicyService$Stub;->disableSecureLockDevice(Landroid/security/authenticationpolicy/DisableSecureLockDeviceParams;)I
    ...
    :cond_3
    sget-object p1, Landroid/security/authenticationpolicy/EnableSecureLockDeviceParams;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/security/authenticationpolicy/EnableSecureLockDeviceParams;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/security/authenticationpolicy/IAuthenticationPolicyService$Stub;->enableSecureLockDevice(Landroid/security/authenticationpolicy/EnableSecureLockDeviceParams;)I
