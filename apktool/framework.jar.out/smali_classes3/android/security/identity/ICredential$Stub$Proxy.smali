...
.method public whitelist asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Landroid/security/identity/ICredential$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist getAuthKeysNeedingCertification()[Landroid/security/identity/AuthKeyParcel;
    ...
    sget-object p0, Landroid/security/identity/AuthKeyParcel;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p0

    check-cast p0, [Landroid/security/identity/AuthKeyParcel;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist getEntries([B[Landroid/security/identity/RequestNamespaceParcel;[B[BZZZ)Landroid/security/identity/GetEntriesResultParcel;
    ...
    sget-object p0, Landroid/security/identity/GetEntriesResultParcel;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/security/identity/GetEntriesResultParcel;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist getInterfaceDescriptor()Ljava/lang/String;
    ...
    const-string p0, "android.security.identity.ICredential"
...
.method public blacklist update()Landroid/security/identity/IWritableCredential;
    ...
    invoke-static {p0}, Landroid/security/identity/IWritableCredential$Stub;->asInterface(Landroid/os/IBinder;)Landroid/security/identity/IWritableCredential;
