...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/security/identity/RequestEntryParcel;
    ...
    new-instance p0, Landroid/security/identity/RequestEntryParcel;

    invoke-direct {p0}, Landroid/security/identity/RequestEntryParcel;-><init>()V

    invoke-virtual {p0, p1}, Landroid/security/identity/RequestEntryParcel;->readFromParcel(Landroid/os/Parcel;)V
...
.method public blacklist newArray(I)[Landroid/security/identity/RequestEntryParcel;
    ...
    new-array p0, p1, [Landroid/security/identity/RequestEntryParcel;
