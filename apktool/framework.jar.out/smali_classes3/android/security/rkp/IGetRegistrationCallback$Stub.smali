...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/security/rkp/IGetRegistrationCallback;
    ...
    check-cast v0, Landroid/security/rkp/IGetRegistrationCallback;

    return-object v0

    :cond_1
    new-instance v0, Landroid/security/rkp/IGetRegistrationCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/security/rkp/IGetRegistrationCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1}, Landroid/security/rkp/IGetRegistrationCallback$Stub;->onError(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Landroid/security/rkp/IRegistration$Stub;->asInterface(Landroid/os/IBinder;)Landroid/security/rkp/IRegistration;

    move-result-object p1

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/security/rkp/IGetRegistrationCallback$Stub;->onSuccess(Landroid/security/rkp/IRegistration;)V
