...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/security/metrics/KeystoreAtomPayload;
    ...
    new-instance p0, Landroid/security/metrics/KeystoreAtomPayload;

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Landroid/security/metrics/KeystoreAtomPayload;-><init>(Landroid/os/Parcel;Landroid/security/metrics/KeystoreAtomPayload-IA;)V
...
.method public blacklist newArray(I)[Landroid/security/metrics/KeystoreAtomPayload;
    ...
    new-array p0, p1, [Landroid/security/metrics/KeystoreAtomPayload;
