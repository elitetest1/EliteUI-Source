...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/service/remotelockscreenvalidation/IRemoteLockscreenValidationCallback;
    ...
    check-cast v0, Landroid/service/remotelockscreenvalidation/IRemoteLockscreenValidationCallback;

    return-object v0

    :cond_1
    new-instance v0, Landroid/service/remotelockscreenvalidation/IRemoteLockscreenValidationCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/service/remotelockscreenvalidation/IRemoteLockscreenValidationCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1}, Landroid/service/remotelockscreenvalidation/IRemoteLockscreenValidationCallback$Stub;->onFailure(Ljava/lang/String;)V

    goto :goto_0

    :cond_3
    sget-object p1, Landroid/app/RemoteLockscreenValidationResult;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {p0, p1}, Landroid/service/remotelockscreenvalidation/IRemoteLockscreenValidationCallback$Stub;->onSuccess(Landroid/app/RemoteLockscreenValidationResult;)V
