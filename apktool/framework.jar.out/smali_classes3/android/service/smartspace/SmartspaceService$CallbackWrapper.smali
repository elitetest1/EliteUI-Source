...
.method public blacklist accept(Ljava/util/List;)V
    ...
    :try_start_0
    iget-object p0, p0, Landroid/service/smartspace/SmartspaceService$CallbackWrapper;->mCallback:Landroid/app/smartspace/ISmartspaceCallback;
    ...
    invoke-interface {p0, v0}, Landroid/app/smartspace/ISmartspaceCallback;->onResult(Landroid/content/pm/ParceledListSlice;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public blacklist isCallback(Landroid/app/smartspace/ISmartspaceCallback;)Z
    ...
    const-string p0, "SmartspaceService"
    ...
    :cond_0
    invoke-interface {p0}, Landroid/app/smartspace/ISmartspaceCallback;->asBinder()Landroid/os/IBinder;
