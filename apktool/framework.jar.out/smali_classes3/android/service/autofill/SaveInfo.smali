...
.method public static blacklist copy(Landroid/service/autofill/SaveInfo;[Landroid/view/autofill/AutofillId;)Landroid/service/autofill/SaveInfo;
    ...
    new-instance v1, Landroid/service/autofill/SaveInfo;

    move-object v2, v1

    iget v1, v0, Landroid/service/autofill/SaveInfo;->mType:I

    move-object v3, v2

    iget v2, v0, Landroid/service/autofill/SaveInfo;->mNegativeButtonStyle:I

    move-object v4, v3

    iget v3, v0, Landroid/service/autofill/SaveInfo;->mPositiveButtonStyle:I

    move-object v5, v4

    iget-object v4, v0, Landroid/service/autofill/SaveInfo;->mNegativeActionListener:Landroid/content/IntentSender;

    move-object v6, v5

    iget-object v5, v0, Landroid/service/autofill/SaveInfo;->mSemNegativeSecondActionListener:Landroid/content/IntentSender;

    move-object v7, v6

    iget-object v6, v0, Landroid/service/autofill/SaveInfo;->mRequiredIds:[Landroid/view/autofill/AutofillId;
    ...
    iget-object v8, v0, Landroid/service/autofill/SaveInfo;->mDescription:Ljava/lang/CharSequence;

    move-object v10, v9

    iget v9, v0, Landroid/service/autofill/SaveInfo;->mFlags:I

    move-object v11, v10

    iget-object v10, v0, Landroid/service/autofill/SaveInfo;->mCustomDescription:Landroid/service/autofill/CustomDescription;

    move-object v12, v11

    iget-object v11, v0, Landroid/service/autofill/SaveInfo;->mValidator:Landroid/service/autofill/InternalValidator;

    move-object v13, v12

    iget-object v12, v0, Landroid/service/autofill/SaveInfo;->mSanitizerKeys:[Landroid/service/autofill/InternalSanitizer;

    move-object v14, v13

    iget-object v13, v0, Landroid/service/autofill/SaveInfo;->mSanitizerValues:[[Landroid/view/autofill/AutofillId;

    iget-object v0, v0, Landroid/service/autofill/SaveInfo;->mTriggerId:Landroid/view/autofill/AutofillId;
...
.method public greylist-max-o getCustomDescription()Landroid/service/autofill/CustomDescription;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mCustomDescription:Landroid/service/autofill/CustomDescription;
...
.method public greylist-max-o getDescription()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mDescription:Ljava/lang/CharSequence;
...
.method public greylist-max-o getFlags()I
    ...
    iget p0, p0, Landroid/service/autofill/SaveInfo;->mFlags:I
...
.method public greylist-max-o getNegativeActionListener()Landroid/content/IntentSender;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mNegativeActionListener:Landroid/content/IntentSender;
...
.method public greylist-max-o getNegativeActionStyle()I
    ...
    iget p0, p0, Landroid/service/autofill/SaveInfo;->mNegativeButtonStyle:I
...
.method public greylist-max-o getOptionalIds()[Landroid/view/autofill/AutofillId;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mOptionalIds:[Landroid/view/autofill/AutofillId;
...
.method public blacklist getPositiveActionStyle()I
    ...
    iget p0, p0, Landroid/service/autofill/SaveInfo;->mPositiveButtonStyle:I
...
.method public greylist-max-o getRequiredIds()[Landroid/view/autofill/AutofillId;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mRequiredIds:[Landroid/view/autofill/AutofillId;
...
.method public greylist-max-o getSanitizerKeys()[Landroid/service/autofill/InternalSanitizer;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mSanitizerKeys:[Landroid/service/autofill/InternalSanitizer;
...
.method public greylist-max-o getSanitizerValues()[[Landroid/view/autofill/AutofillId;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mSanitizerValues:[[Landroid/view/autofill/AutofillId;
...
.method public greylist-max-o getTriggerId()Landroid/view/autofill/AutofillId;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mTriggerId:Landroid/view/autofill/AutofillId;
...
.method public greylist-max-o getType()I
    ...
    iget p0, p0, Landroid/service/autofill/SaveInfo;->mType:I
...
.method public greylist-max-o getValidator()Landroid/service/autofill/InternalValidator;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mValidator:Landroid/service/autofill/InternalValidator;
...
.method public blacklist semGetNegativeSecondActionListener()Landroid/content/IntentSender;
    ...
    iget-object p0, p0, Landroid/service/autofill/SaveInfo;->mSemNegativeSecondActionListener:Landroid/content/IntentSender;
