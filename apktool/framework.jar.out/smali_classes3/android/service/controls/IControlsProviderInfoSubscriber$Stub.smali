...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/service/controls/IControlsProviderInfoSubscriber;
    ...
    :cond_1
    new-instance v0, Landroid/service/controls/IControlsProviderInfoSubscriber$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/service/controls/IControlsProviderInfoSubscriber$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    sget-object p3, Landroid/service/controls/ControlsProviderInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p3}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Landroid/service/controls/ControlsProviderInfo;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1, p3}, Landroid/service/controls/IControlsProviderInfoSubscriber$Stub;->onNext(Landroid/os/IBinder;Landroid/service/controls/ControlsProviderInfo;)V
