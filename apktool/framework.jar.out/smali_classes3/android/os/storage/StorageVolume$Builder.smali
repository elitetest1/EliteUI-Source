...
.method public blacklist build()Landroid/os/storage/StorageVolume;
    ...
    iget-object v2, v0, Landroid/os/storage/StorageVolume$Builder;->mPath:Ljava/io/File;
    ...
    iget-object v12, v0, Landroid/os/storage/StorageVolume$Builder;->mOwner:Landroid/os/UserHandle;

    iget-object v13, v0, Landroid/os/storage/StorageVolume$Builder;->mStorageUuid:Ljava/util/UUID;

    iget-object v14, v0, Landroid/os/storage/StorageVolume$Builder;->mUuid:Ljava/lang/String;

    iget-object v15, v0, Landroid/os/storage/StorageVolume$Builder;->mState:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v15}, Landroid/os/storage/StorageVolume;-><init>(Ljava/lang/String;Ljava/io/File;Ljava/io/File;Ljava/lang/String;ZZZZZJLandroid/os/UserHandle;Ljava/util/UUID;Ljava/lang/String;Ljava/lang/String;)V
