...
.method public blacklist get()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Landroid/os/BluetoothServiceManager$ServiceRegisterer;->mServiceName:Ljava/lang/String;
...
.method public blacklist getOrThrow()Landroid/os/IBinder;
    ...
    :catch_0
    new-instance v0, Landroid/os/BluetoothServiceManager$ServiceNotFoundException;

    iget-object p0, p0, Landroid/os/BluetoothServiceManager$ServiceRegisterer;->mServiceName:Ljava/lang/String;

    invoke-direct {v0, p0}, Landroid/os/BluetoothServiceManager$ServiceNotFoundException;-><init>(Ljava/lang/String;)V
