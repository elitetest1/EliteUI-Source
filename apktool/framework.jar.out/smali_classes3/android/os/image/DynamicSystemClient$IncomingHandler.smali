...
.method public whitelist handleMessage(Landroid/os/Message;)V
    ...
    iget-object p0, p0, Landroid/os/image/DynamicSystemClient$IncomingHandler;->mWeakClient:Ljava/lang/ref/WeakReference;

    invoke-virtual {p0}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/os/image/DynamicSystemClient;

    if-eqz p0, :cond_0

    invoke-static {p0, p1}, Landroid/os/image/DynamicSystemClient;->-$$Nest$mhandleMessage(Landroid/os/image/DynamicSystemClient;Landroid/os/Message;)V
