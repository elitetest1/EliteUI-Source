...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/os/instrumentation/TargetProcess;
    ...
    new-instance p0, Landroid/os/instrumentation/TargetProcess;

    invoke-direct {p0}, Landroid/os/instrumentation/TargetProcess;-><init>()V

    invoke-virtual {p0, p1}, Landroid/os/instrumentation/TargetProcess;->readFromParcel(Landroid/os/Parcel;)V
...
.method public blacklist newArray(I)[Landroid/os/instrumentation/TargetProcess;
    ...
    new-array p0, p1, [Landroid/os/instrumentation/TargetProcess;
