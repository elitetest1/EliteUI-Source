...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/os/SemDevicePowerInfo;
    ...
    new-instance p0, Landroid/os/SemDevicePowerInfo;

    invoke-direct {p0, p1}, Landroid/os/SemDevicePowerInfo;-><init>(Landroid/os/Parcel;)V
...
.method public blacklist newArray(I)[Landroid/os/SemDevicePowerInfo;
    ...
    new-array p0, p1, [Landroid/os/SemDevicePowerInfo;
