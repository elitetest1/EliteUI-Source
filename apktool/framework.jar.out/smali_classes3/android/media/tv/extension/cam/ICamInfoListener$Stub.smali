...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/media/tv/extension/cam/ICamInfoListener;
    ...
    check-cast v0, Landroid/media/tv/extension/cam/ICamInfoListener;

    return-object v0

    :cond_1
    new-instance v0, Landroid/media/tv/extension/cam/ICamInfoListener$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/media/tv/extension/cam/ICamInfoListener$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo p0, "onNewTypeCamInsert"

    return-object p0

    :cond_1
    const-string/jumbo p0, "onSlotInfoChanged"

    return-object p0

    :cond_2
    const-string/jumbo p0, "onCamInfoChanged"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1, p3}, Landroid/media/tv/extension/cam/ICamInfoListener$Stub;->onNewTypeCamInsert(ILandroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p3}, Landroid/media/tv/extension/cam/ICamInfoListener$Stub;->onSlotInfoChanged(ILandroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1, p3}, Landroid/media/tv/extension/cam/ICamInfoListener$Stub;->onCamInfoChanged(ILandroid/os/Bundle;)V
