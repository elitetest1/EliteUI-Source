...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/media/tv/extension/scan/ITargetRegion;
    ...
    check-cast v0, Landroid/media/tv/extension/scan/ITargetRegion;

    return-object v0

    :cond_1
    new-instance v0, Landroid/media/tv/extension/scan/ITargetRegion$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/media/tv/extension/scan/ITargetRegion$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_1
    const-string/jumbo p0, "setTargetRegion"

    return-object p0

    :cond_2
    const-string p0, "getTargetRegions"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {p1}, Landroid/media/tv/extension/scan/ITargetRegionListener$Stub;->asInterface(Landroid/os/IBinder;)Landroid/media/tv/extension/scan/ITargetRegionListener;

    move-result-object p1

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/media/tv/extension/scan/ITargetRegion$Stub;->setListener(Landroid/media/tv/extension/scan/ITargetRegionListener;)I
    ...
    invoke-virtual {p0, p1}, Landroid/media/tv/extension/scan/ITargetRegion$Stub;->setTargetRegion(Landroid/os/Bundle;)I
