...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/media/audiopolicy/AudioMixingRule$AudioMixMatchCriterion;
    ...
    new-instance p0, Landroid/media/audiopolicy/AudioMixingRule$AudioMixMatchCriterion;

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Landroid/media/audiopolicy/AudioMixingRule$AudioMixMatchCriterion;-><init>(Landroid/os/Parcel;Landroid/media/audiopolicy/AudioMixingRule-IA;)V
...
.method public blacklist newArray(I)[Landroid/media/audiopolicy/AudioMixingRule$AudioMixMatchCriterion;
    ...
    new-array p0, p1, [Landroid/media/audiopolicy/AudioMixingRule$AudioMixMatchCriterion;
