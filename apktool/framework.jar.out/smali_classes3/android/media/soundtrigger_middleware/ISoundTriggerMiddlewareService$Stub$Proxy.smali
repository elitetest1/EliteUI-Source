...
.method public whitelist asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Landroid/media/soundtrigger_middleware/ISoundTriggerMiddlewareService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist attachAsMiddleman(ILandroid/media/permission/Identity;Landroid/media/permission/Identity;Landroid/media/soundtrigger_middleware/ISoundTriggerCallback;Z)Landroid/media/soundtrigger_middleware/ISoundTriggerModule;
    ...
    invoke-static {p0}, Landroid/media/soundtrigger_middleware/ISoundTriggerModule$Stub;->asInterface(Landroid/os/IBinder;)Landroid/media/soundtrigger_middleware/ISoundTriggerModule;
...
.method public blacklist getInterfaceDescriptor()Ljava/lang/String;
    ...
    const-string p0, "android.media.soundtrigger_middleware.ISoundTriggerMiddlewareService"
...
.method public blacklist listModulesAsMiddleman(Landroid/media/permission/Identity;Landroid/media/permission/Identity;)[Landroid/media/soundtrigger_middleware/SoundTriggerModuleDescriptor;
    ...
    sget-object p0, Landroid/media/soundtrigger_middleware/SoundTriggerModuleDescriptor;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p0

    check-cast p0, [Landroid/media/soundtrigger_middleware/SoundTriggerModuleDescriptor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
