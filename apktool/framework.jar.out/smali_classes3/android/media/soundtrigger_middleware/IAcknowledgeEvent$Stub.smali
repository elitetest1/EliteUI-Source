...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/media/soundtrigger_middleware/IAcknowledgeEvent;
    ...
    check-cast v0, Landroid/media/soundtrigger_middleware/IAcknowledgeEvent;

    return-object v0

    :cond_1
    new-instance v0, Landroid/media/soundtrigger_middleware/IAcknowledgeEvent$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/media/soundtrigger_middleware/IAcknowledgeEvent$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
