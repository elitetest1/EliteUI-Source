...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo p0, "notifyCaptureBoundsChanged"

    return-object p0

    :pswitch_1
    const-string/jumbo p0, "notifyWindowingModeChanged"

    return-object p0

    :pswitch_2
    const-string/jumbo p0, "notifyAppSelectorDisplayed"

    return-object p0

    :pswitch_3
    const-string/jumbo p0, "notifyPermissionRequestCancelled"

    return-object p0

    :pswitch_4
    const-string/jumbo p0, "notifyPermissionRequestDisplayed"

    return-object p0

    :pswitch_5
    const-string/jumbo p0, "notifyPermissionRequestInitiated"

    return-object p0

    :pswitch_6
    const-string/jumbo p0, "setUserReviewGrantedConsentResult"

    return-object p0

    :pswitch_7
    const-string/jumbo p0, "setContentRecordingSession"
    ...
    :pswitch_a
    const-string/jumbo p0, "notifyActiveProjectionCapturedContentVisibilityChanged"
    ...
    :pswitch_d
    const-string/jumbo p0, "requestConsentForInvalidProjection"

    return-object p0

    :pswitch_e
    const-string p0, "isCurrentProjection"

    return-object p0

    :pswitch_f
    const-string p0, "getProjection"
...
.method protected blacklist addCallback_enforcePermission()V
    ...
    iget-object p0, p0, Landroid/media/projection/IMediaProjectionManager$Stub;->mEnforcer:Landroid/os/PermissionEnforcer;
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1, p3, p4}, Landroid/media/projection/IMediaProjectionManager$Stub;->notifyCaptureBoundsChanged(IILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p1, p3, p4}, Landroid/media/projection/IMediaProjectionManager$Stub;->notifyWindowingModeChanged(III)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->notifyAppSelectorDisplayed(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->notifyPermissionRequestCancelled(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->notifyPermissionRequestDisplayed(I)V
    ...
    invoke-virtual {p0, p1, p3}, Landroid/media/projection/IMediaProjectionManager$Stub;->notifyPermissionRequestInitiated(II)V
    ...
    invoke-virtual {p0, p1, p4}, Landroid/media/projection/IMediaProjectionManager$Stub;->setUserReviewGrantedConsentResult(ILandroid/media/projection/IMediaProjection;)V
    ...
    :pswitch_7
    sget-object p1, Landroid/view/ContentRecordingSession;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {p0, p1, p4}, Landroid/media/projection/IMediaProjectionManager$Stub;->setContentRecordingSession(Landroid/view/ContentRecordingSession;Landroid/media/projection/IMediaProjection;)Z
    ...
    invoke-virtual {p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->addCallback(Landroid/media/projection/IMediaProjectionWatcherCallback;)Landroid/media/projection/MediaProjectionInfo;
    ...
    invoke-virtual {p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->notifyActiveProjectionCapturedContentVisibilityChanged(Z)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->stopActiveProjection(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->requestConsentForInvalidProjection(Landroid/media/projection/IMediaProjection;)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->isCurrentProjection(Landroid/media/projection/IMediaProjection;)Z
    ...
    invoke-virtual {p0, p1, p4}, Landroid/media/projection/IMediaProjectionManager$Stub;->getProjection(ILjava/lang/String;)Landroid/media/projection/IMediaProjection;
    ...
    invoke-virtual/range {v2 .. v7}, Landroid/media/projection/IMediaProjectionManager$Stub;->createProjection(ILjava/lang/String;IZI)Landroid/media/projection/IMediaProjection;
    ...
    invoke-virtual {v2, p0, p1}, Landroid/media/projection/IMediaProjectionManager$Stub;->hasProjectionPermission(ILjava/lang/String;)Z
