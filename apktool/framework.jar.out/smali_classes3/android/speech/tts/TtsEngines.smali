...
.method private greylist-max-o getEngineInfo(Landroid/content/pm/ResolveInfo;Landroid/content/pm/PackageManager;)Landroid/speech/tts/TextToSpeech$EngineInfo;
    ...
    iput-boolean p0, v1, Landroid/speech/tts/TextToSpeech$EngineInfo;->system:Z
...
.method private greylist-max-o settingsActivityFromServiceInfo(Landroid/content/pm/ServiceInfo;Landroid/content/pm/PackageManager;)Ljava/lang/String;
    ...
    const-string v0, "Error parsing metadata for "

    const-string v1, "TtsEngines"

    const-string v2, "No meta-data found for :"
    ...
    const-string/jumbo v2, "tts-engine"
    ...
    const-string v2, " uses unknown tag :"
    ...
    const-string p2, "Could not load resources for : "
...
.method public greylist getEngines()Ljava/util/List;
    ...
    :cond_2
    sget-object p0, Landroid/speech/tts/TtsEngines$EngineInfoComparator;->INSTANCE:Landroid/speech/tts/TtsEngines$EngineInfoComparator;
...
.method public greylist-max-o getHighestRankedEngineName()Ljava/lang/String;
    ...
    check-cast p0, Landroid/speech/tts/TextToSpeech$EngineInfo;
...
.method public greylist-max-o getLocalePrefForEngine(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Locale;
    ...
    const-string p2, "Failed to parse locale "
...
.method public greylist-max-o isLocaleSetToDefaultForEngine(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Landroid/speech/tts/TtsEngines;->mContext:Landroid/content/Context;

    invoke-virtual {p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object p0

    const-string/jumbo v0, "tts_default_locale"

    invoke-static {p0, v0}, Landroid/provider/Settings$Secure;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p0, p1}, Landroid/speech/tts/TtsEngines;->parseEnginePrefFromList(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public greylist parseLocaleString(Ljava/lang/String;)Ljava/util/Locale;
    ...
    invoke-direct {v4, v3, v5, p0}, Ljava/util/Locale;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
