...
.method public whitelist bulkTransfer(Landroid/hardware/usb/UsbEndpoint;[BIII)I
    ...
    invoke-direct/range {p0 .. p5}, Landroid/hardware/usb/UsbDeviceConnection;->native_bulk_request(I[BIII)I
...
.method public whitelist close()V
    ...
    iget-object p0, p0, Landroid/hardware/usb/UsbDeviceConnection;->mCloseGuard:Ldalvik/system/CloseGuard;
...
.method public greylist-max-o getContext()Landroid/content/Context;
    ...
    iget-object p0, p0, Landroid/hardware/usb/UsbDeviceConnection;->mContext:Landroid/content/Context;
...
.method greylist-max-o open(Ljava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/content/Context;)Z
    ...
    const-string p2, "UsbDeviceConnection.close"

    invoke-virtual {p0, p2}, Ldalvik/system/CloseGuard;->open(Ljava/lang/String;)V
...
.method public whitelist requestWait()Landroid/hardware/usb/UsbRequest;
    ...
    :goto_1
    invoke-virtual {v0, p0}, Landroid/hardware/usb/UsbRequest;->dequeue(Z)V
...
.method public whitelist requestWait(J)Landroid/hardware/usb/UsbRequest;
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/usb/UsbRequest;->dequeue(Z)V
