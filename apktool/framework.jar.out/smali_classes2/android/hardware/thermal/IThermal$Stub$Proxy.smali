...
.method public whitelist asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Landroid/hardware/thermal/IThermal$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist forecastSkinTemperature(I)F
    ...
    const-string p1, "Method forecastSkinTemperature is unimplemented."
...
.method public blacklist getCoolingDevices()[Landroid/hardware/thermal/CoolingDevice;
    ...
    sget-object p0, Landroid/hardware/thermal/CoolingDevice;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p0

    check-cast p0, [Landroid/hardware/thermal/CoolingDevice;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v2, "Method getCoolingDevices is unimplemented."
...
.method public blacklist getCoolingDevicesWithType(I)[Landroid/hardware/thermal/CoolingDevice;
    ...
    const-string p1, "Method getCoolingDevicesWithType is unimplemented."
...
.method public blacklist getInterfaceDescriptor()Ljava/lang/String;
    ...
    sget-object p0, Landroid/hardware/thermal/IThermal$Stub$Proxy;->DESCRIPTOR:Ljava/lang/String;
...
.method public declared-synchronized blacklist getInterfaceHash()Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/hardware/thermal/IThermal$Stub$Proxy;->mCachedHash:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public blacklist getInterfaceVersion()I
    ...
    iput v2, p0, Landroid/hardware/thermal/IThermal$Stub$Proxy;->mCachedVersion:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :goto_0
    iget p0, p0, Landroid/hardware/thermal/IThermal$Stub$Proxy;->mCachedVersion:I
...
.method public blacklist getTemperatureThresholds()[Landroid/hardware/thermal/TemperatureThreshold;
    ...
    sget-object p0, Landroid/hardware/thermal/TemperatureThreshold;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p0

    check-cast p0, [Landroid/hardware/thermal/TemperatureThreshold;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    const-string v2, "Method getTemperatureThresholds is unimplemented."
...
.method public blacklist getTemperatureThresholdsWithType(I)[Landroid/hardware/thermal/TemperatureThreshold;
    ...
    const-string p1, "Method getTemperatureThresholdsWithType is unimplemented."
...
.method public blacklist getTemperatures()[Landroid/hardware/thermal/Temperature;
    ...
    sget-object p0, Landroid/hardware/thermal/Temperature;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p0

    check-cast p0, [Landroid/hardware/thermal/Temperature;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist registerCoolingDeviceChangedCallbackWithType(Landroid/hardware/thermal/ICoolingDeviceChangedCallback;I)V
    ...
    const-string p1, "Method registerCoolingDeviceChangedCallbackWithType is unimplemented."
...
.method public blacklist registerThermalChangedCallbackWithType(Landroid/hardware/thermal/IThermalChangedCallback;I)V
    ...
    const-string p1, "Method registerThermalChangedCallbackWithType is unimplemented."
...
.method public blacklist unregisterCoolingDeviceChangedCallback(Landroid/hardware/thermal/ICoolingDeviceChangedCallback;)V
    ...
    const-string p1, "Method unregisterCoolingDeviceChangedCallback is unimplemented."
