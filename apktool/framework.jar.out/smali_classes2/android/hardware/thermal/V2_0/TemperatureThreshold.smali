...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v3, Landroid/hardware/thermal/V2_0/TemperatureThreshold;

    invoke-direct {v3}, Landroid/hardware/thermal/V2_0/TemperatureThreshold;-><init>()V

    mul-int/lit8 v5, v1, 0x58

    int-to-long v5, v5

    invoke-virtual {v3, v4, p0, v5, v6}, Landroid/hardware/thermal/V2_0/TemperatureThreshold;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    :cond_6
    iget p0, p0, Landroid/hardware/thermal/V2_0/TemperatureThreshold;->vrThrottlingThreshold:F
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object p1, p0, Landroid/hardware/thermal/V2_0/TemperatureThreshold;->hotThrottlingThresholds:[F

    const/4 v2, 0x7

    invoke-virtual {p2, v0, v1, p1, v2}, Landroid/os/HwBlob;->copyToFloatArray(J[FI)V

    const-wide/16 v0, 0x34

    add-long/2addr v0, p3

    iget-object p1, p0, Landroid/hardware/thermal/V2_0/TemperatureThreshold;->coldThrottlingThresholds:[F
    ...
    iput p1, p0, Landroid/hardware/thermal/V2_0/TemperatureThreshold;->vrThrottlingThreshold:F
