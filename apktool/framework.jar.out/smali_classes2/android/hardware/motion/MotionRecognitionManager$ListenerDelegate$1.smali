...
.method public whitelist onMotionEvent(Lcom/samsung/android/gesture/SemMotionRecognitionEvent;)V
    ...
    invoke-virtual {v0, p1}, Landroid/hardware/motion/MREvent;->setPanningDzImage(I)V

    iget-object p0, p0, Landroid/hardware/motion/MotionRecognitionManager$ListenerDelegate$1;->this$0:Landroid/hardware/motion/MotionRecognitionManager$ListenerDelegate;

    invoke-static {p0}, Landroid/hardware/motion/MotionRecognitionManager$ListenerDelegate;->-$$Nest$fgetmoldListener(Landroid/hardware/motion/MotionRecognitionManager$ListenerDelegate;)Landroid/hardware/motion/MRListener;

    move-result-object p0

    invoke-interface {p0, v0}, Landroid/hardware/motion/MRListener;->onMotionListener(Landroid/hardware/motion/MREvent;)V
