...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/hardware/tv/tuner/ILnb;
    ...
    check-cast v0, Landroid/hardware/tv/tuner/ILnb;

    return-object v0

    :cond_1
    new-instance v0, Landroid/hardware/tv/tuner/ILnb$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/tv/tuner/ILnb$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/tv/tuner/ILnb$Stub;->sendDiseqcMessage([B)V
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/tv/tuner/ILnb$Stub;->setSatellitePosition(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/tv/tuner/ILnb$Stub;->setTone(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/tv/tuner/ILnb$Stub;->setVoltage(I)V
    ...
    invoke-static {p1}, Landroid/hardware/tv/tuner/ILnbCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/tv/tuner/ILnbCallback;

    move-result-object p1

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/hardware/tv/tuner/ILnb$Stub;->setCallback(Landroid/hardware/tv/tuner/ILnbCallback;)V
