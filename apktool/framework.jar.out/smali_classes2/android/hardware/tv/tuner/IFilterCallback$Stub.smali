...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/hardware/tv/tuner/IFilterCallback;
    ...
    check-cast v0, Landroid/hardware/tv/tuner/IFilterCallback;

    return-object v0

    :cond_1
    new-instance v0, Landroid/hardware/tv/tuner/IFilterCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/tv/tuner/IFilterCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/tv/tuner/IFilterCallback$Stub;->onFilterStatus(B)V

    goto :goto_0

    :cond_5
    sget-object p1, Landroid/hardware/tv/tuner/DemuxFilterEvent;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Landroid/hardware/tv/tuner/DemuxFilterEvent;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/hardware/tv/tuner/IFilterCallback$Stub;->onFilterEvent([Landroid/hardware/tv/tuner/DemuxFilterEvent;)V
