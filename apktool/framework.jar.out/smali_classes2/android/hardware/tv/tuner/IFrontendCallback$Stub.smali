...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/hardware/tv/tuner/IFrontendCallback;
    ...
    check-cast v0, Landroid/hardware/tv/tuner/IFrontendCallback;

    return-object v0

    :cond_1
    new-instance v0, Landroid/hardware/tv/tuner/IFrontendCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/tv/tuner/IFrontendCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    sget-object p3, Landroid/hardware/tv/tuner/FrontendScanMessage;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p3}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Landroid/hardware/tv/tuner/FrontendScanMessage;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1, p3}, Landroid/hardware/tv/tuner/IFrontendCallback$Stub;->onScanMessage(ILandroid/hardware/tv/tuner/FrontendScanMessage;)V
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/tv/tuner/IFrontendCallback$Stub;->onEvent(I)V
