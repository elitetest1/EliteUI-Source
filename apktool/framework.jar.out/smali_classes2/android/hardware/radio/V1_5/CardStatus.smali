...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v4, p0, v5, v6}, Landroid/hardware/radio/V1_5/CardStatus;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    :cond_3
    iget-object p0, p0, Landroid/hardware/radio/V1_5/CardStatus;->applications:Ljava/util/ArrayList;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/hardware/radio/V1_4/CardStatus;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object p2, p0, Landroid/hardware/radio/V1_5/CardStatus;->applications:Ljava/util/ArrayList;
    ...
    new-instance p4, Landroid/hardware/radio/V1_5/AppStatus;

    invoke-direct {p4}, Landroid/hardware/radio/V1_5/AppStatus;-><init>()V

    mul-int/lit8 v0, p2, 0x48

    int-to-long v0, v0

    invoke-virtual {p4, v2, p1, v0, v1}, Landroid/hardware/radio/V1_5/AppStatus;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/hardware/radio/V1_4/CardStatus;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-object p3, p0, Landroid/hardware/radio/V1_5/CardStatus;->applications:Ljava/util/ArrayList;

    invoke-virtual {p3, v3}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Landroid/hardware/radio/V1_5/AppStatus;

    mul-int/lit8 v4, v3, 0x48

    int-to-long v4, v4

    invoke-virtual {p3, p2, v4, v5}, Landroid/hardware/radio/V1_5/AppStatus;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
