...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, v4, p0, v5, v6}, Landroid/hardware/radio/V1_6/UrspRule;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v3, v1, p1, v4, v5}, Landroid/hardware/radio/V1_6/TrafficDescriptor;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object p3, p0, Landroid/hardware/radio/V1_6/UrspRule;->routeSelectionDescriptor:Ljava/util/ArrayList;
    ...
    new-instance p3, Landroid/hardware/radio/V1_6/RouteSelectionDescriptor;

    invoke-direct {p3}, Landroid/hardware/radio/V1_6/RouteSelectionDescriptor;-><init>()V

    mul-int/lit8 p4, v9, 0x30

    int-to-long v2, p4

    invoke-virtual {p3, v1, p2, v2, v3}, Landroid/hardware/radio/V1_6/RouteSelectionDescriptor;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V

    iget-object p4, p0, Landroid/hardware/radio/V1_6/UrspRule;->routeSelectionDescriptor:Ljava/util/ArrayList;
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-object v0, p0, Landroid/hardware/radio/V1_6/UrspRule;->trafficDescriptors:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Landroid/hardware/radio/V1_6/UrspRule;->trafficDescriptors:Ljava/util/ArrayList;

    invoke-virtual {v6, v4}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/hardware/radio/V1_6/TrafficDescriptor;

    mul-int/lit8 v7, v4, 0x30

    int-to-long v7, v7

    invoke-virtual {v6, v3, v7, v8}, Landroid/hardware/radio/V1_6/TrafficDescriptor;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-object v0, p0, Landroid/hardware/radio/V1_6/UrspRule;->routeSelectionDescriptor:Ljava/util/ArrayList;
    ...
    check-cast p3, Landroid/hardware/radio/V1_6/RouteSelectionDescriptor;

    mul-int/lit8 v3, v5, 0x30

    int-to-long v3, v3

    invoke-virtual {p3, p2, v3, v4}, Landroid/hardware/radio/V1_6/RouteSelectionDescriptor;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
