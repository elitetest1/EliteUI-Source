...
.method public greylist-max-o onGeofenceAdd(II)V
    ...
    iget-object p0, p0, Landroid/hardware/location/GeofenceHardware$GeofenceHardwareCallbackWrapper;->mCallback:Ljava/lang/ref/WeakReference;

    invoke-virtual {p0}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/hardware/location/GeofenceHardwareCallback;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p1, p2}, Landroid/hardware/location/GeofenceHardwareCallback;->onGeofenceAdd(II)V
...
.method public greylist-max-o onGeofencePause(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/hardware/location/GeofenceHardwareCallback;->onGeofencePause(II)V
...
.method public greylist-max-o onGeofenceRemove(II)V
    ...
    iget-object p0, p0, Landroid/hardware/location/GeofenceHardware$GeofenceHardwareCallbackWrapper;->this$0:Landroid/hardware/location/GeofenceHardware;

    invoke-static {p0, v0}, Landroid/hardware/location/GeofenceHardware;->-$$Nest$mremoveCallback(Landroid/hardware/location/GeofenceHardware;Landroid/hardware/location/GeofenceHardwareCallback;)V
...
.method public greylist-max-o onGeofenceResume(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/hardware/location/GeofenceHardwareCallback;->onGeofenceResume(II)V
