...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v3, Landroid/hardware/contexthub/V1_2/ContextHubMsg;

    invoke-direct {v3}, Landroid/hardware/contexthub/V1_2/ContextHubMsg;-><init>()V

    mul-int/lit8 v5, v1, 0x30

    int-to-long v5, v5

    invoke-virtual {v3, v4, p0, v5, v6}, Landroid/hardware/contexthub/V1_2/ContextHubMsg;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    :cond_3
    iget-object p0, p0, Landroid/hardware/contexthub/V1_2/ContextHubMsg;->permissions:Ljava/util/ArrayList;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/hardware/contexthub/V1_0/ContextHubMsg;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object p2, p0, Landroid/hardware/contexthub/V1_2/ContextHubMsg;->permissions:Ljava/util/ArrayList;
    ...
    iget-object p4, p0, Landroid/hardware/contexthub/V1_2/ContextHubMsg;->permissions:Ljava/util/ArrayList;
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/hardware/contexthub/V1_0/ContextHubMsg;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-object p3, p0, Landroid/hardware/contexthub/V1_2/ContextHubMsg;->permissions:Ljava/util/ArrayList;
