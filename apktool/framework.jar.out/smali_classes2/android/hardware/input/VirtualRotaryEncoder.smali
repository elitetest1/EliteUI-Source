...
.method public whitelist sendScrollEvent(Landroid/hardware/input/VirtualRotaryEncoderScrollEvent;)V
    ...
    const-string v0, "Failed to send scroll event from virtual rotary "

    :try_start_0
    iget-object v1, p0, Landroid/hardware/input/VirtualRotaryEncoder;->mVirtualDevice:Landroid/companion/virtual/IVirtualDevice;

    iget-object v2, p0, Landroid/hardware/input/VirtualRotaryEncoder;->mToken:Landroid/os/IBinder;

    invoke-interface {v1, v2, p1}, Landroid/companion/virtual/IVirtualDevice;->sendRotaryEncoderScrollEvent(Landroid/os/IBinder;Landroid/hardware/input/VirtualRotaryEncoderScrollEvent;)Z
    ...
    iget-object p0, p0, Landroid/hardware/input/VirtualRotaryEncoder;->mConfig:Landroid/hardware/input/VirtualInputDeviceConfig;
