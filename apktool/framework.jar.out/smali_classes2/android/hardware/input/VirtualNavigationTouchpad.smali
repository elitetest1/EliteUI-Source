...
.method public whitelist sendTouchEvent(Landroid/hardware/input/VirtualTouchEvent;)V
    ...
    const-string v0, "Failed to send touch event to virtual navigation touchpad "

    :try_start_0
    iget-object v1, p0, Landroid/hardware/input/VirtualNavigationTouchpad;->mVirtualDevice:Landroid/companion/virtual/IVirtualDevice;

    iget-object v2, p0, Landroid/hardware/input/VirtualNavigationTouchpad;->mToken:Landroid/os/IBinder;

    invoke-interface {v1, v2, p1}, Landroid/companion/virtual/IVirtualDevice;->sendTouchEvent(Landroid/os/IBinder;Landroid/hardware/input/VirtualTouchEvent;)Z
    ...
    iget-object p0, p0, Landroid/hardware/input/VirtualNavigationTouchpad;->mConfig:Landroid/hardware/input/VirtualInputDeviceConfig;
