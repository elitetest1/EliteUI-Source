...
.method public whitelist asBinder()Landroid/os/IBinder;
    ...
    iget-object p0, p0, Landroid/hardware/camera2/ICameraDeviceUser$Stub$Proxy;->mRemote:Landroid/os/IBinder;
...
.method public blacklist getCaptureResultMetadataQueue()Landroid/hardware/common/fmq/MQDescriptor;
    ...
    sget-object p0, Landroid/hardware/common/fmq/MQDescriptor;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/hardware/common/fmq/MQDescriptor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public greylist-max-o getInterfaceDescriptor()Ljava/lang/String;
    ...
    const-string p0, "android.hardware.camera2.ICameraDeviceUser"
...
.method public blacklist startStreaming([I[I)Landroid/hardware/camera2/utils/SubmitInfo;
    ...
    sget-object p0, Landroid/hardware/camera2/utils/SubmitInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, p0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Landroid/hardware/camera2/utils/SubmitInfo;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public blacklist switchToOffline(Landroid/hardware/camera2/ICameraDeviceCallbacks;[I)Landroid/hardware/camera2/ICameraOfflineSession;
    ...
    invoke-static {p0}, Landroid/hardware/camera2/ICameraOfflineSession$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/camera2/ICameraOfflineSession;
