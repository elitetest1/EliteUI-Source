...
.method public whitelist test-api run()V
    ...
    invoke-static {v0}, Landroid/hardware/camera2/impl/CameraDeviceImpl;->-$$Nest$fgetmIsPrimaryClient(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Z

    move-result v2

    invoke-virtual {v1, v0, v2}, Landroid/hardware/camera2/impl/CameraDeviceImpl$StateCallbackKK;->onOpenedInSharedMode(Landroid/hardware/camera2/CameraDevice;Z)V
    ...
    iget-object p0, p0, Landroid/hardware/camera2/impl/CameraDeviceImpl$3;->this$0:Landroid/hardware/camera2/impl/CameraDeviceImpl;

    invoke-static {p0}, Landroid/hardware/camera2/impl/CameraDeviceImpl;->-$$Nest$fgetmIsPrimaryClient(Landroid/hardware/camera2/impl/CameraDeviceImpl;)Z

    move-result v1

    invoke-virtual {v0, p0, v1}, Landroid/hardware/camera2/CameraDevice$StateCallback;->onOpenedInSharedMode(Landroid/hardware/camera2/CameraDevice;Z)V
