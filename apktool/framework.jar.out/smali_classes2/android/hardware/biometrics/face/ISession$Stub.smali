...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_2
    const-string p0, "enrollWithOptions"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :pswitch_0
    sget-object p1, Landroid/hardware/biometrics/face/FaceEnrollOptions;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/hardware/biometrics/face/FaceEnrollOptions;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/hardware/biometrics/face/ISession$Stub;->enrollWithOptions(Landroid/hardware/biometrics/face/FaceEnrollOptions;)Landroid/hardware/biometrics/common/ICancellationSignal;
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/biometrics/face/ISession$Stub;->onContextChanged(Landroid/hardware/biometrics/common/OperationContext;)V
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/biometrics/face/ISession$Stub;->detectInteractionWithContext(Landroid/hardware/biometrics/common/OperationContext;)Landroid/hardware/biometrics/common/ICancellationSignal;
    ...
    invoke-virtual {v3, p0, p1, p4}, Landroid/hardware/biometrics/face/ISession$Stub;->authenticateWithContext(JLandroid/hardware/biometrics/common/OperationContext;)Landroid/hardware/biometrics/common/ICancellationSignal;
    ...
    invoke-virtual {v3}, Landroid/hardware/biometrics/face/ISession$Stub;->close()V
    ...
    invoke-virtual {v3, p0}, Landroid/hardware/biometrics/face/ISession$Stub;->resetLockout(Landroid/hardware/keymaster/HardwareAuthToken;)V
    ...
    invoke-virtual {v3}, Landroid/hardware/biometrics/face/ISession$Stub;->invalidateAuthenticatorId()V
    ...
    invoke-virtual {v3}, Landroid/hardware/biometrics/face/ISession$Stub;->getAuthenticatorId()V
    ...
    invoke-virtual {v3, p0, p1, p4}, Landroid/hardware/biometrics/face/ISession$Stub;->setFeature(Landroid/hardware/keymaster/HardwareAuthToken;BZ)V
    ...
    invoke-virtual {v3}, Landroid/hardware/biometrics/face/ISession$Stub;->getFeatures()V
    ...
    invoke-virtual {v3, p0}, Landroid/hardware/biometrics/face/ISession$Stub;->removeEnrollments([I)V
    ...
    invoke-virtual {v3}, Landroid/hardware/biometrics/face/ISession$Stub;->enumerateEnrollments()V
    ...
    invoke-virtual {v3}, Landroid/hardware/biometrics/face/ISession$Stub;->detectInteraction()Landroid/hardware/biometrics/common/ICancellationSignal;
    ...
    invoke-virtual {v3, p0, p1}, Landroid/hardware/biometrics/face/ISession$Stub;->authenticate(J)Landroid/hardware/biometrics/common/ICancellationSignal;
    ...
    invoke-virtual {v3, p0, p1, p4, v0}, Landroid/hardware/biometrics/face/ISession$Stub;->enroll(Landroid/hardware/keymaster/HardwareAuthToken;B[BLandroid/hardware/common/NativeHandle;)Landroid/hardware/biometrics/common/ICancellationSignal;
    ...
    invoke-virtual {v3, p0}, Landroid/hardware/biometrics/face/ISession$Stub;->getEnrollmentConfig(B)[Landroid/hardware/biometrics/face/EnrollmentStageConfig;
    ...
    invoke-virtual {v3, p0, p1}, Landroid/hardware/biometrics/face/ISession$Stub;->revokeChallenge(J)V
    ...
    invoke-virtual {v3}, Landroid/hardware/biometrics/face/ISession$Stub;->generateChallenge()V
