...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/IGnssAntennaInfoCallback;
    ...
    check-cast v0, Landroid/hardware/gnss/IGnssAntennaInfoCallback;

    return-object v0

    :cond_1
    new-instance v0, Landroid/hardware/gnss/IGnssAntennaInfoCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/gnss/IGnssAntennaInfoCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string p0, "gnssAntennaInfoCb"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_4
    sget-object p1, Landroid/hardware/gnss/IGnssAntennaInfoCallback$GnssAntennaInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Landroid/hardware/gnss/IGnssAntennaInfoCallback$GnssAntennaInfo;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/hardware/gnss/IGnssAntennaInfoCallback$Stub;->gnssAntennaInfoCb([Landroid/hardware/gnss/IGnssAntennaInfoCallback$GnssAntennaInfo;)V
