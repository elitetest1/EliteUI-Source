...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/IGnssDebug;
    ...
    check-cast v0, Landroid/hardware/gnss/IGnssDebug;

    return-object v0

    :cond_1
    new-instance v0, Landroid/hardware/gnss/IGnssDebug$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/gnss/IGnssDebug$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
