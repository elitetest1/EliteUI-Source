...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsInterface;
    ...
    check-cast v0, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsInterface;

    return-object v0

    :cond_1
    new-instance v0, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsInterface$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsInterface$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_1
    const-string p0, "setCorrections"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {p1}, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsCallback;

    move-result-object p1

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsInterface$Stub;->setCallback(Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsCallback;)V
    ...
    :cond_5
    sget-object p1, Landroid/hardware/gnss/measurement_corrections/MeasurementCorrections;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/hardware/gnss/measurement_corrections/MeasurementCorrections;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/hardware/gnss/measurement_corrections/IMeasurementCorrectionsInterface$Stub;->setCorrections(Landroid/hardware/gnss/measurement_corrections/MeasurementCorrections;)V
