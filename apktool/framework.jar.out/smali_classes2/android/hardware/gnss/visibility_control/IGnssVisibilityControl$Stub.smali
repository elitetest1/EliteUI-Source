...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/visibility_control/IGnssVisibilityControl;
    ...
    check-cast v0, Landroid/hardware/gnss/visibility_control/IGnssVisibilityControl;

    return-object v0

    :cond_1
    new-instance v0, Landroid/hardware/gnss/visibility_control/IGnssVisibilityControl$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/gnss/visibility_control/IGnssVisibilityControl$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_1
    const-string p0, "enableNfwLocationAccess"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {p1}, Landroid/hardware/gnss/visibility_control/IGnssVisibilityControlCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/visibility_control/IGnssVisibilityControlCallback;

    move-result-object p1

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/hardware/gnss/visibility_control/IGnssVisibilityControl$Stub;->setCallback(Landroid/hardware/gnss/visibility_control/IGnssVisibilityControlCallback;)V
    ...
    invoke-virtual {p0, p1}, Landroid/hardware/gnss/visibility_control/IGnssVisibilityControl$Stub;->enableNfwLocationAccess([Ljava/lang/String;)V
