...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v3, Landroid/hardware/gnss/V1_0/IGnssDebug$DebugData;

    invoke-direct {v3}, Landroid/hardware/gnss/V1_0/IGnssDebug$DebugData;-><init>()V

    mul-int/lit8 v5, v1, 0x70

    int-to-long v5, v5

    invoke-virtual {v3, v4, p0, v5, v6}, Landroid/hardware/gnss/V1_0/IGnssDebug$DebugData;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    :cond_4
    iget-object p0, p0, Landroid/hardware/gnss/V1_0/IGnssDebug$DebugData;->satelliteDataArray:Ljava/util/ArrayList;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/hardware/gnss/V1_0/IGnssDebug$PositionDebug;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, v1, v2}, Landroid/hardware/gnss/V1_0/IGnssDebug$TimeDebug;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object p2, p0, Landroid/hardware/gnss/V1_0/IGnssDebug$DebugData;->satelliteDataArray:Ljava/util/ArrayList;
    ...
    new-instance p4, Landroid/hardware/gnss/V1_0/IGnssDebug$SatelliteData;

    invoke-direct {p4}, Landroid/hardware/gnss/V1_0/IGnssDebug$SatelliteData;-><init>()V

    mul-int/lit8 v0, p2, 0x14

    int-to-long v0, v0

    invoke-virtual {p4, v2, p1, v0, v1}, Landroid/hardware/gnss/V1_0/IGnssDebug$SatelliteData;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/hardware/gnss/V1_0/IGnssDebug$PositionDebug;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/hardware/gnss/V1_0/IGnssDebug$TimeDebug;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget-object p3, p0, Landroid/hardware/gnss/V1_0/IGnssDebug$DebugData;->satelliteDataArray:Ljava/util/ArrayList;

    invoke-virtual {p3, v3}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Landroid/hardware/gnss/V1_0/IGnssDebug$SatelliteData;

    mul-int/lit8 v4, v3, 0x14

    int-to-long v4, v4

    invoke-virtual {p3, p2, v4, v5}, Landroid/hardware/gnss/V1_0/IGnssDebug$SatelliteData;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
