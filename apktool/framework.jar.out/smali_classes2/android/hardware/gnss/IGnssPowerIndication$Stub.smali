...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/IGnssPowerIndication;
    ...
    check-cast v0, Landroid/hardware/gnss/IGnssPowerIndication;

    return-object v0

    :cond_1
    new-instance v0, Landroid/hardware/gnss/IGnssPowerIndication$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/hardware/gnss/IGnssPowerIndication$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string p0, "requestGnssPowerStats"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {p1}, Landroid/hardware/gnss/IGnssPowerIndicationCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/gnss/IGnssPowerIndicationCallback;

    move-result-object p1

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/hardware/gnss/IGnssPowerIndication$Stub;->setCallback(Landroid/hardware/gnss/IGnssPowerIndicationCallback;)V
