...
.method constructor blacklist <init>(I)V
    ...
    new-array p1, p1, [Landroid/internal/framework/protobuf/nano/FieldData;

    iput-object p1, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mData:[Landroid/internal/framework/protobuf/nano/FieldData;
...
.method private blacklist gc()V
    ...
    sget-object v7, Landroid/internal/framework/protobuf/nano/FieldArray;->DELETED:Landroid/internal/framework/protobuf/nano/FieldData;
    ...
    :cond_2
    iput-boolean v3, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mGarbage:Z

    iput v5, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mSize:I
...
.method private blacklist idealIntArraySize(I)I
    ...
    invoke-direct {p0, p1}, Landroid/internal/framework/protobuf/nano/FieldArray;->idealByteArraySize(I)I
...
.method public final blacklist clone()Landroid/internal/framework/protobuf/nano/FieldArray;
    ...
    iget-object v3, v1, Landroid/internal/framework/protobuf/nano/FieldArray;->mFieldNumbers:[I
    ...
    invoke-virtual {v2}, Landroid/internal/framework/protobuf/nano/FieldData;->clone()Landroid/internal/framework/protobuf/nano/FieldData;
...
.method blacklist dataAt(I)Landroid/internal/framework/protobuf/nano/FieldData;
    ...
    :cond_0
    iget-object p0, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mData:[Landroid/internal/framework/protobuf/nano/FieldData;
...
.method public whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    :cond_1
    check-cast p1, Landroid/internal/framework/protobuf/nano/FieldArray;

    invoke-virtual {p0}, Landroid/internal/framework/protobuf/nano/FieldArray;->size()I

    move-result v1

    invoke-virtual {p1}, Landroid/internal/framework/protobuf/nano/FieldArray;->size()I
    ...
    iget-object v3, p1, Landroid/internal/framework/protobuf/nano/FieldArray;->mFieldNumbers:[I

    iget v4, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mSize:I

    invoke-direct {p0, v1, v3, v4}, Landroid/internal/framework/protobuf/nano/FieldArray;->arrayEquals([I[II)Z
    ...
    iget-object p1, p1, Landroid/internal/framework/protobuf/nano/FieldArray;->mData:[Landroid/internal/framework/protobuf/nano/FieldData;

    iget v3, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mSize:I

    invoke-direct {p0, v1, p1, v3}, Landroid/internal/framework/protobuf/nano/FieldArray;->arrayEquals([Landroid/internal/framework/protobuf/nano/FieldData;[Landroid/internal/framework/protobuf/nano/FieldData;I)Z
...
.method blacklist get(I)Landroid/internal/framework/protobuf/nano/FieldData;
    ...
    sget-object p1, Landroid/internal/framework/protobuf/nano/FieldArray;->DELETED:Landroid/internal/framework/protobuf/nano/FieldData;
...
.method public whitelist test-api hashCode()I
    ...
    invoke-virtual {v2}, Landroid/internal/framework/protobuf/nano/FieldData;->hashCode()I
...
.method blacklist put(ILandroid/internal/framework/protobuf/nano/FieldData;)V
    ...
    sget-object v4, Landroid/internal/framework/protobuf/nano/FieldArray;->DELETED:Landroid/internal/framework/protobuf/nano/FieldData;

    if-ne v3, v4, :cond_1

    iget-object p0, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mFieldNumbers:[I
    ...
    :cond_1
    iget-boolean v2, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mGarbage:Z
    ...
    new-array v1, v1, [Landroid/internal/framework/protobuf/nano/FieldData;
    ...
    iget-object p1, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mData:[Landroid/internal/framework/protobuf/nano/FieldData;

    aput-object p2, p1, v0

    iget p1, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mSize:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mSize:I
...
.method blacklist remove(I)V
    ...
    iput-boolean p1, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mGarbage:Z
...
.method blacklist size()I
    ...
    :cond_0
    iget p0, p0, Landroid/internal/framework/protobuf/nano/FieldArray;->mSize:I
