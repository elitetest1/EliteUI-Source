...
.method public static blacklist asInterface(Landroid/os/IBinder;)Landroid/media/INearbyMediaDevicesProvider;
    ...
    :cond_1
    new-instance v0, Landroid/media/INearbyMediaDevicesProvider$Stub$Proxy;

    invoke-direct {v0, p0}, Landroid/media/INearbyMediaDevicesProvider$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string p0, "unregisterNearbyDevicesCallback"

    return-object p0

    :cond_1
    const-string p0, "registerNearbyDevicesCallback"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {p1}, Landroid/media/INearbyMediaDevicesUpdateCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/media/INearbyMediaDevicesUpdateCallback;

    move-result-object p1

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Landroid/media/INearbyMediaDevicesProvider$Stub;->unregisterNearbyDevicesCallback(Landroid/media/INearbyMediaDevicesUpdateCallback;)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/INearbyMediaDevicesProvider$Stub;->registerNearbyDevicesCallback(Landroid/media/INearbyMediaDevicesUpdateCallback;)V
