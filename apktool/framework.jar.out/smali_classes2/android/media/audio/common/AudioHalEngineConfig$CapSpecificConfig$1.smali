...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/media/audio/common/AudioHalEngineConfig$CapSpecificConfig;
    ...
    new-instance p0, Landroid/media/audio/common/AudioHalEngineConfig$CapSpecificConfig;

    invoke-direct {p0}, Landroid/media/audio/common/AudioHalEngineConfig$CapSpecificConfig;-><init>()V

    invoke-virtual {p0, p1}, Landroid/media/audio/common/AudioHalEngineConfig$CapSpecificConfig;->readFromParcel(Landroid/os/Parcel;)V
...
.method public blacklist newArray(I)[Landroid/media/audio/common/AudioHalEngineConfig$CapSpecificConfig;
    ...
    new-array p0, p1, [Landroid/media/audio/common/AudioHalEngineConfig$CapSpecificConfig;
