...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/media/audio/common/AudioHalCapParameter$StreamVolumeProfile;
    ...
    new-instance p0, Landroid/media/audio/common/AudioHalCapParameter$StreamVolumeProfile;

    invoke-direct {p0}, Landroid/media/audio/common/AudioHalCapParameter$StreamVolumeProfile;-><init>()V

    invoke-virtual {p0, p1}, Landroid/media/audio/common/AudioHalCapParameter$StreamVolumeProfile;->readFromParcel(Landroid/os/Parcel;)V
...
.method public blacklist newArray(I)[Landroid/media/audio/common/AudioHalCapParameter$StreamVolumeProfile;
    ...
    new-array p0, p1, [Landroid/media/audio/common/AudioHalCapParameter$StreamVolumeProfile;
