...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/media/audio/common/AudioHalCapCriterionV2$TelephonyMode;
    ...
    new-instance p0, Landroid/media/audio/common/AudioHalCapCriterionV2$TelephonyMode;

    invoke-direct {p0}, Landroid/media/audio/common/AudioHalCapCriterionV2$TelephonyMode;-><init>()V

    invoke-virtual {p0, p1}, Landroid/media/audio/common/AudioHalCapCriterionV2$TelephonyMode;->readFromParcel(Landroid/os/Parcel;)V
...
.method public blacklist newArray(I)[Landroid/media/audio/common/AudioHalCapCriterionV2$TelephonyMode;
    ...
    new-array p0, p1, [Landroid/media/audio/common/AudioHalCapCriterionV2$TelephonyMode;
