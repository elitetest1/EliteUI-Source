...
.method private greylist-max-o updateText(Ljava/lang/String;Z)V
    ...
    iget-object p0, p0, Landroid/media/Cea708CCWidget$CCWindowLayout;->mBuilder:Landroid/text/SpannableStringBuilder;

    invoke-virtual {p1, p0}, Landroid/media/Cea708CCWidget$CCView;->setText(Ljava/lang/CharSequence;)V
    ...
    :cond_6
    iget-object p0, p0, Landroid/media/Cea708CCWidget$CCWindowLayout;->mCCView:Landroid/media/Cea708CCWidget$CCView;

    invoke-virtual {p0, v2}, Landroid/media/Cea708CCWidget$CCView;->setText(Ljava/lang/CharSequence;)V
...
.method private greylist-max-o updateTextSize()V
    ...
    invoke-virtual {p0, v3}, Landroid/media/Cea708CCWidget$CCView;->setTextSize(F)V
...
.method public greylist-max-o clearText()V
    ...
    invoke-virtual {p0, v0}, Landroid/media/Cea708CCWidget$CCView;->setText(Ljava/lang/CharSequence;)V
...
.method public greylist-max-o getCaptionWindowId()I
    ...
    iget p0, p0, Landroid/media/Cea708CCWidget$CCWindowLayout;->mCaptionWindowId:I
...
.method public greylist-max-o initWindow(Landroid/media/Cea708CCWidget$CCLayout;Landroid/media/Cea708CCParser$CaptionWindow;)V
    ...
    :cond_7
    iget v2, p2, Landroid/media/Cea708CCParser$CaptionWindow;->anchorId:I

    const/4 v3, 0x3

    rem-int/2addr v2, v3

    iget v5, p2, Landroid/media/Cea708CCParser$CaptionWindow;->anchorId:I
    ...
    iget v8, p2, Landroid/media/Cea708CCParser$CaptionWindow;->columnCount:I
    ...
    invoke-virtual {v2, v9}, Landroid/media/Cea708CCWidget$CCView;->setAlignment(Landroid/text/Layout$Alignment;)V
    ...
    invoke-virtual {v3, v8}, Landroid/media/Cea708CCWidget$CCView;->setAlignment(Landroid/text/Layout$Alignment;)V
    ...
    invoke-virtual {v2, v8}, Landroid/media/Cea708CCWidget$CCView;->setAlignment(Landroid/text/Layout$Alignment;)V
    ...
    invoke-direct {v5, v1, v4, v0, v2}, Landroid/media/Cea708CCWidget$ScaledLayout$ScaledLayoutParams;-><init>(FFFF)V

    invoke-virtual {p1, p0, v5}, Landroid/media/Cea708CCWidget$CCLayout;->addOrUpdateViewToSafeTitleArea(Landroid/media/Cea708CCWidget$CCWindowLayout;Landroid/media/Cea708CCWidget$ScaledLayout$ScaledLayoutParams;)V
    ...
    invoke-virtual {p0, v3}, Landroid/media/Cea708CCWidget$CCWindowLayout;->setGravity(I)V
...
.method public greylist-max-o setCaptionStyle(Landroid/view/accessibility/CaptioningManager$CaptionStyle;)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/Cea708CCWidget$CCView;->setCaptionStyle(Landroid/view/accessibility/CaptioningManager$CaptionStyle;)V
...
.method public greylist-max-o setPenAttr(Landroid/media/Cea708CCParser$CaptionPenAttr;)V
    ...
    :cond_4
    iget-object p0, p0, Landroid/media/Cea708CCWidget$CCWindowLayout;->mCharacterStyles:Ljava/util/List;
