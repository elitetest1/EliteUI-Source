...
.method private greylist-max-o clearWindows(I)V
    ...
    check-cast p1, Landroid/media/Cea708CCWidget$CCWindowLayout;

    invoke-virtual {p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->clear()V
...
.method private greylist-max-o delay(I)V
    ...
    iget-object p0, p0, Landroid/media/Cea708CCWidget$CCHandler;->mHandler:Landroid/os/Handler;
...
.method private greylist-max-o displayWindows(I)V
    ...
    invoke-virtual {p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->show()V
...
.method private greylist-max-o hideWindows(I)V
    ...
    invoke-virtual {p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->hide()V
...
.method private greylist-max-o processPendingBuffer()V
    ...
    :cond_0
    iget-object p0, p0, Landroid/media/Cea708CCWidget$CCHandler;->mPendingCaptionEvents:Ljava/util/ArrayList;
...
.method private greylist-max-o sendControlToCurrentWindow(C)V
    ...
    iget-object p0, p0, Landroid/media/Cea708CCWidget$CCHandler;->mCurrentWindowLayout:Landroid/media/Cea708CCWidget$CCWindowLayout;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->sendControl(C)V
...
.method private greylist-max-o setPenAttr(Landroid/media/Cea708CCParser$CaptionPenAttr;)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->setPenAttr(Landroid/media/Cea708CCParser$CaptionPenAttr;)V
...
.method private greylist-max-o setPenColor(Landroid/media/Cea708CCParser$CaptionPenColor;)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->setPenColor(Landroid/media/Cea708CCParser$CaptionPenColor;)V
...
.method private greylist-max-o setPenLocation(Landroid/media/Cea708CCParser$CaptionPenLocation;)V
    ...
    iget v0, p1, Landroid/media/Cea708CCParser$CaptionPenLocation;->row:I

    iget p1, p1, Landroid/media/Cea708CCParser$CaptionPenLocation;->column:I

    invoke-virtual {p0, v0, p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->setPenLocation(II)V
...
.method private greylist-max-o setWindowAttr(Landroid/media/Cea708CCParser$CaptionWindowAttr;)V
    ...
    invoke-virtual {p0, p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->setWindowAttr(Landroid/media/Cea708CCParser$CaptionWindowAttr;)V
...
.method private greylist-max-o toggleWindows(I)V
    ...
    invoke-virtual {p1}, Landroid/media/Cea708CCWidget$CCWindowLayout;->isShown()Z
