...
.method public whitelist describeContents()I
    ...
    iget-object v0, p0, Landroid/media/AudioIoDescriptor;->patch:Landroid/media/AudioPatchFw;
...
.method public final whitelist writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget p2, p0, Landroid/media/AudioIoDescriptor;->latency:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget p2, p0, Landroid/media/AudioIoDescriptor;->portId:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-boolean p2, p0, Landroid/media/AudioIoDescriptor;->mDsEnable:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeBoolean(Z)V

    iget p2, p0, Landroid/media/AudioIoDescriptor;->mDsProfile:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget p2, p0, Landroid/media/AudioIoDescriptor;->mDsDevice:I

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-boolean p0, p0, Landroid/media/AudioIoDescriptor;->mDsInfoChanged:Z
