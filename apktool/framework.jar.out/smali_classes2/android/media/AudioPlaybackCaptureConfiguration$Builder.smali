...
.method public whitelist addMatchingUid(I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;
    ...
    invoke-virtual {v0, v1, p1}, Landroid/media/audiopolicy/AudioMixingRule$Builder;->addMixRule(ILjava/lang/Object;)Landroid/media/audiopolicy/AudioMixingRule$Builder;
...
.method public whitelist addMatchingUsage(I)Landroid/media/AudioPlaybackCaptureConfiguration$Builder;
    ...
    invoke-virtual {v0, p1, v2}, Landroid/media/audiopolicy/AudioMixingRule$Builder;->addRule(Landroid/media/AudioAttributes;I)Landroid/media/audiopolicy/AudioMixingRule$Builder;
...
.method public whitelist build()Landroid/media/AudioPlaybackCaptureConfiguration;
    ...
    iget-object p0, p0, Landroid/media/AudioPlaybackCaptureConfiguration$Builder;->mProjection:Landroid/media/projection/MediaProjection;

    const/4 v2, 0x0

    invoke-direct {v0, v1, p0, v2}, Landroid/media/AudioPlaybackCaptureConfiguration;-><init>(Landroid/media/audiopolicy/AudioMixingRule;Landroid/media/projection/MediaProjection;Landroid/media/AudioPlaybackCaptureConfiguration-IA;)V
