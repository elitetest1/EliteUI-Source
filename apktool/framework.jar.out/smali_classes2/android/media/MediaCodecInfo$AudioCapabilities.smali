...
.method private greylist-max-o applyLevelLimits()V
    ...
    invoke-static {v9, v1}, Landroid/util/Range;->create(Ljava/lang/Comparable;Ljava/lang/Comparable;)Landroid/util/Range;
    ...
    invoke-static {v8, v1}, Landroid/util/Range;->create(Ljava/lang/Comparable;Ljava/lang/Comparable;)Landroid/util/Range;
    ...
    const-string v11, "AudioCapabilities"

    invoke-static {v11, v10}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v10, v0, Landroid/media/MediaCodecInfo$AudioCapabilities;->mParent:Landroid/media/MediaCodecInfo$CodecCapabilities;

    iget v11, v10, Landroid/media/MediaCodecInfo$CodecCapabilities;->mError:I

    or-int/2addr v11, v7

    iput v11, v10, Landroid/media/MediaCodecInfo$CodecCapabilities;->mError:I
    ...
    invoke-static {v11, v13}, Landroid/util/Range;->create(Ljava/lang/Comparable;Ljava/lang/Comparable;)Landroid/util/Range;
    ...
    invoke-static {v9, v11}, Landroid/util/Range;->create(Ljava/lang/Comparable;Ljava/lang/Comparable;)Landroid/util/Range;
    ...
    iget-object v4, v0, Landroid/media/MediaCodecInfo$AudioCapabilities;->mParent:Landroid/media/MediaCodecInfo$CodecCapabilities;

    iget v10, v4, Landroid/media/MediaCodecInfo$CodecCapabilities;->mError:I

    or-int/2addr v10, v7

    iput v10, v4, Landroid/media/MediaCodecInfo$CodecCapabilities;->mError:I
    ...
    invoke-direct {v0, v1}, Landroid/media/MediaCodecInfo$AudioCapabilities;->limitSampleRates([Landroid/util/Range;)V
    ...
    new-array v3, v7, [Landroid/util/Range;
...
.method private greylist-max-o supports(Ljava/lang/Integer;Ljava/lang/Integer;)Z
    ...
    iget-object p0, p0, Landroid/media/MediaCodecInfo$AudioCapabilities;->mSampleRateRanges:[Landroid/util/Range;

    invoke-static {p0, p1}, Landroid/media/Utils;->binarySearchDistinctRanges([Landroid/util/Range;Ljava/lang/Comparable;)I
...
.method public whitelist getBitrateRange()Landroid/util/Range;
    ...
    iget-object p0, p0, Landroid/media/MediaCodecInfo$AudioCapabilities;->mBitrateRange:Landroid/util/Range;
...
.method public greylist-max-o getDefaultFormat(Landroid/media/MediaFormat;)V
    ...
    :cond_1
    iget-object p0, p0, Landroid/media/MediaCodecInfo$AudioCapabilities;->mSampleRates:[I
...
.method public whitelist getInputChannelCountRanges()[Landroid/util/Range;
    ...
    iget-object p0, p0, Landroid/media/MediaCodecInfo$AudioCapabilities;->mInputChannelRanges:[Landroid/util/Range;
