...
.method public blacklist onCancel(Landroid/os/IBinder;)V
    ...
    :try_start_0
    iget-object p0, p0, Landroid/inputmethodservice/IRemoteInputConnectionInvoker$1;->this$0:Landroid/inputmethodservice/IRemoteInputConnectionInvoker;

    invoke-static {p0}, Landroid/inputmethodservice/IRemoteInputConnectionInvoker;->-$$Nest$fgetmConnection(Landroid/inputmethodservice/IRemoteInputConnectionInvoker;)Lcom/android/internal/inputmethod/IRemoteInputConnection;

    move-result-object p0

    invoke-interface {p0, p1}, Lcom/android/internal/inputmethod/IRemoteInputConnection;->cancelCancellationSignal(Landroid/os/IBinder;)V
    :try_end_0
...
.method public blacklist onForget(Landroid/os/IBinder;)V
    ...
    invoke-interface {p0, p1}, Lcom/android/internal/inputmethod/IRemoteInputConnection;->forgetCancellationSignal(Landroid/os/IBinder;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
