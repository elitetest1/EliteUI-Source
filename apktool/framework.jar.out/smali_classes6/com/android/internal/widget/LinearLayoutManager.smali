...
.method private blacklist computeScrollExtent(Lcom/android/internal/widget/RecyclerView$State;)I
    ...
    iget-boolean v3, p0, Lcom/android/internal/widget/LinearLayoutManager;->mSmoothScrollbarEnabled:Z

    xor-int/2addr v3, v2

    invoke-direct {p0, v3, v2}, Lcom/android/internal/widget/LinearLayoutManager;->findFirstVisibleChildClosestToEnd(ZZ)Landroid/view/View;
...
.method private blacklist fixLayoutEndGap(ILcom/android/internal/widget/RecyclerView$Recycler;Lcom/android/internal/widget/RecyclerView$State;Z)I
    ...
    iget-object p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mOrientationHelper:Lcom/android/internal/widget/OrientationHelper;

    invoke-virtual {p0, p3}, Lcom/android/internal/widget/OrientationHelper;->offsetChildren(I)V
...
.method private blacklist layoutForPredictiveAnimations(Lcom/android/internal/widget/RecyclerView$Recycler;Lcom/android/internal/widget/RecyclerView$State;II)V
    ...
    invoke-virtual {v7}, Lcom/android/internal/widget/RecyclerView$ViewHolder;->isRemoved()Z
    ...
    :cond_1
    invoke-virtual {v7}, Lcom/android/internal/widget/RecyclerView$ViewHolder;->getLayoutPosition()I
    ...
    invoke-virtual {v8, v7}, Lcom/android/internal/widget/OrientationHelper;->getDecoratedMeasurement(Landroid/view/View;)I
    ...
    iput-object v0, v1, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mScrapList:Ljava/util/List;
    ...
    invoke-direct {p0, v0, p3}, Lcom/android/internal/widget/LinearLayoutManager;->updateLayoutStateToFillStart(II)V

    iget-object p3, p0, Lcom/android/internal/widget/LinearLayoutManager;->mLayoutState:Lcom/android/internal/widget/LinearLayoutManager$LayoutState;

    iput v5, p3, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mExtra:I

    iget-object p3, p0, Lcom/android/internal/widget/LinearLayoutManager;->mLayoutState:Lcom/android/internal/widget/LinearLayoutManager$LayoutState;

    iput v2, p3, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mAvailable:I

    iget-object p3, p0, Lcom/android/internal/widget/LinearLayoutManager;->mLayoutState:Lcom/android/internal/widget/LinearLayoutManager$LayoutState;

    invoke-virtual {p3}, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->assignPositionFromScrapList()V

    iget-object p3, p0, Lcom/android/internal/widget/LinearLayoutManager;->mLayoutState:Lcom/android/internal/widget/LinearLayoutManager$LayoutState;

    invoke-virtual {p0, p1, p3, p2, v2}, Lcom/android/internal/widget/LinearLayoutManager;->fill(Lcom/android/internal/widget/RecyclerView$Recycler;Lcom/android/internal/widget/LinearLayoutManager$LayoutState;Lcom/android/internal/widget/RecyclerView$State;Z)I
    ...
    invoke-virtual {p0, p3}, Lcom/android/internal/widget/LinearLayoutManager;->getPosition(Landroid/view/View;)I

    move-result p3

    invoke-direct {p0, p3, p4}, Lcom/android/internal/widget/LinearLayoutManager;->updateLayoutStateToFillEnd(II)V

    iget-object p3, p0, Lcom/android/internal/widget/LinearLayoutManager;->mLayoutState:Lcom/android/internal/widget/LinearLayoutManager$LayoutState;

    iput v6, p3, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mExtra:I
    ...
    :cond_6
    iget-object p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mLayoutState:Lcom/android/internal/widget/LinearLayoutManager$LayoutState;

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mScrapList:Ljava/util/List;
...
.method private blacklist updateAnchorFromChildren(Lcom/android/internal/widget/RecyclerView$Recycler;Lcom/android/internal/widget/RecyclerView$State;Lcom/android/internal/widget/LinearLayoutManager$AnchorInfo;)Z
    ...
    invoke-virtual {p0}, Lcom/android/internal/widget/OrientationHelper;->getEndAfterPadding()I
    ...
    invoke-virtual {p0}, Lcom/android/internal/widget/OrientationHelper;->getStartAfterPadding()I

    move-result p0

    :goto_1
    iput p0, p3, Lcom/android/internal/widget/LinearLayoutManager$AnchorInfo;->mCoordinate:I
...
.method private blacklist updateAnchorFromPendingData(Lcom/android/internal/widget/RecyclerView$State;Lcom/android/internal/widget/LinearLayoutManager$AnchorInfo;)Z
    ...
    iget-object p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mPendingSavedState:Lcom/android/internal/widget/LinearLayoutManager$SavedState;

    iget p0, p0, Lcom/android/internal/widget/LinearLayoutManager$SavedState;->mAnchorOffset:I
    ...
    iput p0, p2, Lcom/android/internal/widget/LinearLayoutManager$AnchorInfo;->mCoordinate:I
    ...
    invoke-virtual {p0}, Lcom/android/internal/widget/OrientationHelper;->getTotalSpaceChange()I
    ...
    invoke-virtual {p0, p1}, Lcom/android/internal/widget/OrientationHelper;->getDecoratedStart(Landroid/view/View;)I
    ...
    :goto_2
    iget-boolean p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mShouldReverseLayout:Z
    ...
    iget p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mPendingScrollPositionOffset:I
...
.method private blacklist updateAnchorInfoForLayout(Lcom/android/internal/widget/RecyclerView$Recycler;Lcom/android/internal/widget/RecyclerView$State;Lcom/android/internal/widget/LinearLayoutManager$AnchorInfo;)V
    ...
    iget-boolean p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mStackFromEnd:Z
    ...
    :goto_1
    iput p0, p3, Lcom/android/internal/widget/LinearLayoutManager$AnchorInfo;->mPosition:I
...
.method private blacklist updateLayoutState(IIZLcom/android/internal/widget/RecyclerView$State;)V
    ...
    iput p1, p0, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mScrollingOffset:I
...
.method public blacklist canScrollHorizontally()Z
    ...
    iget p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mOrientation:I
...
.method blacklist collectPrefetchPositionsForLayoutState(Lcom/android/internal/widget/RecyclerView$State;Lcom/android/internal/widget/LinearLayoutManager$LayoutState;Lcom/android/internal/widget/RecyclerView$LayoutManager$LayoutPrefetchRegistry;)V
    ...
    iget p0, p2, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mCurrentPosition:I
    ...
    invoke-interface {p3, p0, p1}, Lcom/android/internal/widget/RecyclerView$LayoutManager$LayoutPrefetchRegistry;->addPosition(II)V
...
.method blacklist createLayoutState()Lcom/android/internal/widget/LinearLayoutManager$LayoutState;
    ...
    new-instance p0, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;

    invoke-direct {p0}, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;-><init>()V
...
.method blacklist fill(Lcom/android/internal/widget/RecyclerView$Recycler;Lcom/android/internal/widget/LinearLayoutManager$LayoutState;Lcom/android/internal/widget/RecyclerView$State;Z)I
    ...
    :cond_9
    :goto_0
    iget p0, p2, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mAvailable:I
...
.method public blacklist generateDefaultLayoutParams()Lcom/android/internal/widget/RecyclerView$LayoutParams;
    ...
    invoke-direct {p0, v0, v0}, Lcom/android/internal/widget/RecyclerView$LayoutParams;-><init>(II)V
...
.method public blacklist getInitialItemPrefetchCount()I
    ...
    iget p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mInitialItemPrefetchCount:I
...
.method public blacklist getRecycleChildrenOnDetach()Z
    ...
    iget-boolean p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mRecycleChildrenOnDetach:Z
...
.method public blacklist getReverseLayout()Z
    ...
    iget-boolean p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mReverseLayout:Z
...
.method public blacklist isSmoothScrollbarEnabled()Z
    ...
    iget-boolean p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mSmoothScrollbarEnabled:Z
...
.method blacklist layoutChunk(Lcom/android/internal/widget/RecyclerView$Recycler;Lcom/android/internal/widget/RecyclerView$State;Lcom/android/internal/widget/LinearLayoutManager$LayoutState;Lcom/android/internal/widget/LinearLayoutManager$LayoutChunkResult;)V
    ...
    iput-boolean p1, p4, Lcom/android/internal/widget/LinearLayoutManager$LayoutChunkResult;->mFinished:Z
    ...
    iget v4, p4, Lcom/android/internal/widget/LinearLayoutManager$LayoutChunkResult;->mConsumed:I
    ...
    invoke-virtual {p2}, Lcom/android/internal/widget/RecyclerView$LayoutParams;->isItemRemoved()Z

    move-result p0

    if-nez p0, :cond_a

    invoke-virtual {p2}, Lcom/android/internal/widget/RecyclerView$LayoutParams;->isItemChanged()Z
    ...
    :cond_a
    iput-boolean p1, p4, Lcom/android/internal/widget/LinearLayoutManager$LayoutChunkResult;->mIgnoreConsumed:Z
    ...
    iput-boolean p0, p4, Lcom/android/internal/widget/LinearLayoutManager$LayoutChunkResult;->mFocusable:Z
...
.method public blacklist onLayoutCompleted(Lcom/android/internal/widget/RecyclerView$State;)V
    ...
    iget-object p0, p0, Lcom/android/internal/widget/LinearLayoutManager;->mAnchorInfo:Lcom/android/internal/widget/LinearLayoutManager$AnchorInfo;
...
.method public blacklist onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, p0}, Lcom/android/internal/widget/LinearLayoutManager$SavedState;-><init>(Lcom/android/internal/widget/LinearLayoutManager$SavedState;)V
    ...
    iput p0, v0, Lcom/android/internal/widget/LinearLayoutManager$SavedState;->mAnchorPosition:I
...
.method blacklist resolveIsInfinite()Z
    ...
    invoke-virtual {p0}, Lcom/android/internal/widget/OrientationHelper;->getEnd()I
...
.method blacklist scrollBy(ILcom/android/internal/widget/RecyclerView$Recycler;Lcom/android/internal/widget/RecyclerView$State;)I
    ...
    iput p1, p0, Lcom/android/internal/widget/LinearLayoutManager$LayoutState;->mLastScrollDelta:I
