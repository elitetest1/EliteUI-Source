...
.field private static final blacklist TAG:Ljava/lang/String; = "CassATCmd"
...
.method public constructor blacklist <init>(Landroid/content/Context;)V
    ...
    const-string p1, "CASS"

    invoke-static {p1}, Lcom/samsung/android/service/vaultkeeper/VaultKeeperManager;->getInstance(Ljava/lang/String;)Lcom/samsung/android/service/vaultkeeper/VaultKeeperManager;

    move-result-object p1

    iput-object p1, p0, Lcom/android/server/CassATCmd;->mVkm:Lcom/samsung/android/service/vaultkeeper/VaultKeeperManager;
...
.method public blacklist processCmd(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string p0, "NG_FAILEDCONNECTION"
    ...
    iget-object p1, p0, Lcom/android/server/CassATCmd;->mVkm:Lcom/samsung/android/service/vaultkeeper/VaultKeeperManager;

    invoke-virtual {p1}, Lcom/samsung/android/service/vaultkeeper/VaultKeeperManager;->isInitialized()Z

    move-result p1

    if-eqz p1, :cond_3

    iget-object p0, p0, Lcom/android/server/CassATCmd;->mVkm:Lcom/samsung/android/service/vaultkeeper/VaultKeeperManager;

    invoke-virtual {p0}, Lcom/samsung/android/service/vaultkeeper/VaultKeeperManager;->migrationStorage()Z
