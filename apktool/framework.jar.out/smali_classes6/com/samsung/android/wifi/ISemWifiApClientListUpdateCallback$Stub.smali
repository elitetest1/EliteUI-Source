...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lcom/samsung/android/wifi/ISemWifiApClientListUpdateCallback;
    ...
    check-cast v0, Lcom/samsung/android/wifi/ISemWifiApClientListUpdateCallback;

    return-object v0

    :cond_1
    new-instance v0, Lcom/samsung/android/wifi/ISemWifiApClientListUpdateCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/samsung/android/wifi/ISemWifiApClientListUpdateCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo p0, "onOverallDataLimitChanged"

    return-object p0

    :cond_1
    const-string/jumbo p0, "onClientListUpdated"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p3, p4}, Lcom/samsung/android/wifi/ISemWifiApClientListUpdateCallback$Stub;->onOverallDataLimitChanged(J)V

    goto :goto_0

    :cond_3
    sget-object p1, Lcom/samsung/android/wifi/SemWifiApClientDetails;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {p0, p1, p3, p4}, Lcom/samsung/android/wifi/ISemWifiApClientListUpdateCallback$Stub;->onClientListUpdated(Ljava/util/List;J)V
