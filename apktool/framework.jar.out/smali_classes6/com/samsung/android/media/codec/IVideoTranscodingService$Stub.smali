...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lcom/samsung/android/media/codec/IVideoTranscodingService;
    ...
    check-cast v0, Lcom/samsung/android/media/codec/IVideoTranscodingService;

    return-object v0

    :cond_1
    new-instance v0, Lcom/samsung/android/media/codec/IVideoTranscodingService$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/samsung/android/media/codec/IVideoTranscodingService$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo p0, "stopTask"

    return-object p0

    :cond_1
    const-string/jumbo p0, "startTask"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/media/codec/IVideoTranscodingService$Stub;->stopTask(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/media/codec/IVideoTranscodingService$Stub;->startTask(Ljava/lang/String;)V
    ...
    invoke-static {p4}, Lcom/samsung/android/media/codec/IVideoTranscodingServiceCallback$Stub;->asInterface(Landroid/os/IBinder;)Lcom/samsung/android/media/codec/IVideoTranscodingServiceCallback;

    move-result-object p4

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1, p4}, Lcom/samsung/android/media/codec/IVideoTranscodingService$Stub;->register(ILcom/samsung/android/media/codec/IVideoTranscodingServiceCallback;)Ljava/lang/String;
