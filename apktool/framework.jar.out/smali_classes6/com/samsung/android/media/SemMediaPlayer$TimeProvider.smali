...
.method public constructor blacklist <init>(Lcom/samsung/android/media/SemMediaPlayer;)V
    ...
    const-string v2, "SemMediaPlayerMTPEventThread"

    const/4 v4, -0x2

    invoke-direct {p1, v2, v4}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;I)V

    iput-object p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mHandlerThread:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Landroid/os/HandlerThread;->start()V

    iget-object p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mHandlerThread:Landroid/os/HandlerThread;
    ...
    invoke-direct {v2, p0, p1}, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider$EventHandler;-><init>(Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;Landroid/os/Looper;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mListeners:[Landroid/media/MediaTimeProvider$OnMediaTimeListener;

    new-array p1, v3, [J

    iput-object p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mTimes:[J
...
.method private declared-synchronized blacklist notifySeek()V
    ...
    const-string/jumbo v0, "onSeekComplete at "
    ...
    :try_start_1
    invoke-virtual {p0, v2, v1}, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->getCurrentTimeUs(ZZ)J

    move-result-wide v3

    iget-boolean v5, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->DEBUG:Z
    ...
    :cond_2
    iput-boolean v2, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mPausing:Z

    invoke-direct {p0, v1}, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->notifyTimedEvent(Z)V
    :try_end_2
...
.method private declared-synchronized blacklist notifyTimedEvent(Z)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, v0}, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->getCurrentTimeUs(ZZ)J
    ...
    :catch_0
    :try_start_1
    iput-boolean v0, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mRefresh:Z
    ...
    :goto_0
    iget-boolean p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mSeeking:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_0
    :try_start_2
    iget-boolean p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->DEBUG:Z
    ...
    iget-wide v6, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mLastTimeUs:J
    ...
    iget-object v6, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mTimes:[J
    ...
    :goto_3
    iget-object v8, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mTimes:[J

    array-length v9, v8

    if-ge v5, v9, :cond_b

    iget-object v9, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mListeners:[Landroid/media/MediaTimeProvider$OnMediaTimeListener;
    ...
    iget-boolean v8, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->DEBUG:Z
    ...
    iget-boolean v3, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mPaused:Z
    ...
    :cond_c
    iget-object v0, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mPlayer:Lcom/samsung/android/media/SemMediaPlayer;

    invoke-virtual {v0, v6, v7}, Lcom/samsung/android/media/SemMediaPlayer;->notifyAt(J)V

    goto :goto_6

    :cond_d
    iget-object v3, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mEventHandler:Landroid/os/Handler;
...
.method private blacklist registerListener(Landroid/media/MediaTimeProvider$OnMediaTimeListener;)I
    ...
    iput-object v4, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mListeners:[Landroid/media/MediaTimeProvider$OnMediaTimeListener;
    ...
    iget-object p0, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mTimes:[J
...
.method public blacklist cancelNotifications(Landroid/media/MediaTimeProvider$OnMediaTimeListener;)V
    ...
    iget-object p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mListeners:[Landroid/media/MediaTimeProvider$OnMediaTimeListener;
    ...
    iget-object p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mTimes:[J
...
.method protected whitelist test-api finalize()V
    ...
    iget-object p0, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mHandlerThread:Landroid/os/HandlerThread;
...
.method public blacklist getCurrentTimeUs(ZZ)J
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mPaused:Z

    if-eqz v1, :cond_0

    if-nez p1, :cond_0

    iget-wide p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mLastReportedTime:J
    ...
    :try_start_2
    iget-wide p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mLastTimeUs:J
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->scheduleNotification(IJ)V
    ...
    iput-wide p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mLastReportedTime:J
...
.method public blacklist notifyAt(JLandroid/media/MediaTimeProvider$OnMediaTimeListener;)V
    ...
    const-string/jumbo v0, "notifyAt "

    monitor-enter p0

    :try_start_0
    iget-boolean v1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->DEBUG:Z
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->scheduleNotification(IJ)V
...
.method public blacklist onBuffering(Z)V
    ...
    const-string/jumbo v0, "onBuffering: "
...
.method public blacklist onPaused(Z)V
    ...
    iput-boolean p1, p0, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->mSeeking:Z
...
.method public blacklist scheduleUpdate(Landroid/media/MediaTimeProvider$OnMediaTimeListener;)V
    ...
    invoke-direct {p0, p1, v1, v2}, Lcom/samsung/android/media/SemMediaPlayer$TimeProvider;->scheduleNotification(IJ)V
