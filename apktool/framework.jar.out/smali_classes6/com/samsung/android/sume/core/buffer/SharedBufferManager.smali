...
.method public static blacklist copyFromBuffer(Lcom/samsung/android/sume/core/buffer/MediaBuffer;Landroid/hardware/HardwareBuffer;)V
    ...
    invoke-static {p0, p1, v0}, Lcom/samsung/android/sume/core/buffer/SharedBufferManager;->nativeByte2HwBuffer(Ljava/nio/Buffer;Landroid/hardware/HardwareBuffer;Ljava/lang/String;)I
    :try_end_0
...
.method public static blacklist copyFromByteBuffer(Lcom/samsung/android/sume/core/format/MediaFormat;Ljava/nio/ByteBuffer;Landroid/hardware/HardwareBuffer;)V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/sume/core/types/ColorFormat;->stringfy()Ljava/lang/String;
    ...
    invoke-static {p1, p2, p0}, Lcom/samsung/android/sume/core/buffer/SharedBufferManager;->nativeByte2HwBuffer(Ljava/nio/Buffer;Landroid/hardware/HardwareBuffer;Ljava/lang/String;)I
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static blacklist copyToByteBuffer(Lcom/samsung/android/sume/core/format/MediaFormat;Landroid/hardware/HardwareBuffer;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1, p2, p0}, Lcom/samsung/android/sume/core/buffer/SharedBufferManager;->nativeHw2ByteBuffer(Landroid/hardware/HardwareBuffer;Ljava/nio/Buffer;Ljava/lang/String;)I
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static blacklist create(Lcom/samsung/android/sume/core/format/MediaFormat;)Landroid/hardware/HardwareBuffer;
    ...
    invoke-direct {v0, p0}, Lcom/samsung/android/sume/core/buffer/SharedBufferManager;->createAsAudio(Lcom/samsung/android/sume/core/format/MutableMediaFormat;)Landroid/hardware/HardwareBuffer;
...
.method private blacklist createAsImage(Lcom/samsung/android/sume/core/format/MediaFormat;)Landroid/hardware/HardwareBuffer;
    ...
    sget-object p0, Lcom/samsung/android/sume/core/buffer/SharedBufferManager$1;->$SwitchMap$com$samsung$android$sume$core$types$ColorFormat:[I
    ...
    invoke-virtual {v0}, Lcom/samsung/android/sume/core/types/ColorFormat;->ordinal()I
