...
.method static constructor blacklist <clinit>()V
    ...
    const-string v5, "com.sec.android.allshare.event.EVENT_FILERECEIVER_DISCOVERY"
...
.method constructor blacklist <init>(Lcom/samsung/android/allshare/IAllShareConnector;)V
    ...
    const-string p0, "DeviceFinderImpl(v1)"
...
.method private blacklist getDeviceFromMap(Landroid/os/Bundle;Lcom/samsung/android/allshare/Device$DeviceType;)Lcom/samsung/android/allshare/Device;
    ...
    sget-object p1, Lcom/samsung/android/allshare/DeviceFinderImpl$2;->$SwitchMap$com$samsung$android$allshare$Device$DeviceType:[I
    ...
    :cond_2
    iget-object p1, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mUnknownDeviceMap:Ljava/util/HashMap;
    ...
    :cond_5
    :goto_1
    iget-object p0, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mUnknownDeviceMap:Ljava/util/HashMap;
    ...
    :cond_6
    iget-object p1, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mScreenSharingDeviceMap:Ljava/util/HashMap;
    ...
    iget-object p2, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mAllShareConnector:Lcom/samsung/android/allshare/IAllShareConnector;
    ...
    iget-object p2, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mScreenSharingDeviceMap:Ljava/util/HashMap;

    invoke-virtual {p2, v2, p1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_7
    iget-object p0, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mScreenSharingDeviceMap:Ljava/util/HashMap;
    ...
    :cond_8
    iget-object p1, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mImageViewerMap:Ljava/util/HashMap;
    ...
    iget-object p2, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mImageViewerMap:Ljava/util/HashMap;

    invoke-virtual {p2, v2, p1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_9
    iget-object p0, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mImageViewerMap:Ljava/util/HashMap;
    ...
    :cond_a
    iget-object p1, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mAVPlayerMap:Ljava/util/HashMap;
    ...
    iget-object p2, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mAVPlayerMap:Ljava/util/HashMap;

    invoke-virtual {p2, v2, p1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_b
    iget-object p0, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mAVPlayerMap:Ljava/util/HashMap;
...
.method private blacklist privateGetDevices(Ljava/lang/String;Lcom/samsung/android/allshare/Device$DeviceDomain;Lcom/samsung/android/allshare/Device$DeviceType;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :cond_0
    new-instance v1, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;

    const/4 v2, 0x0

    invoke-direct {v1, p0, p1, v2}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;-><init>(Lcom/samsung/android/allshare/DeviceFinderImpl;Ljava/lang/String;Lcom/samsung/android/allshare/DeviceFinderImpl-IA;)V
    ...
    invoke-virtual {v1, p1, p2}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->putString(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p3}, Lcom/samsung/android/allshare/Device$DeviceType;->enumToString()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v1, v3, p1}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1, p4}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p2, "DeviceFinderImpl(v1)"

    if-nez p1, :cond_3

    const-string/jumbo p0, "resBundle is null"
    ...
    :cond_3
    const-string p4, "BUNDLE_PARCELABLE_ARRAYLIST_DEVICE"

    invoke-virtual {p1, p4}, Landroid/os/Bundle;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {p0, p4, p3}, Lcom/samsung/android/allshare/DeviceFinderImpl;->getDeviceFromMap(Landroid/os/Bundle;Lcom/samsung/android/allshare/Device$DeviceType;)Lcom/samsung/android/allshare/Device;
    ...
    :cond_5
    const-string p4, "getDeviceFromMap is null"
    ...
    :cond_6
    :goto_2
    const-string p0, "devices.size is null or 0"
...
.method private blacklist removeDeviceFromMap(Landroid/os/Bundle;Lcom/samsung/android/allshare/Device$DeviceType;)V
    ...
    const-string v4, "DeviceFinderImpl(v1)"
    ...
    :cond_1
    :try_start_0
    sget-object v5, Lcom/samsung/android/allshare/DeviceFinderImpl$2;->$SwitchMap$com$samsung$android$allshare$Device$DeviceType:[I
    ...
    :cond_2
    iget-object p2, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mUnknownDeviceMap:Ljava/util/HashMap;
...
.method public final whitelist getDevice(Ljava/lang/String;Lcom/samsung/android/allshare/Device$DeviceType;)Lcom/samsung/android/allshare/Device;
    ...
    invoke-direct {v0, p0, v2, v1}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;-><init>(Lcom/samsung/android/allshare/DeviceFinderImpl;Ljava/lang/String;Lcom/samsung/android/allshare/DeviceFinderImpl-IA;)V
    ...
    invoke-virtual {v0, p1, v2}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->putString(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final whitelist refresh()V
    ...
    invoke-direct {v0, p0, v2, v3}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;-><init>(Lcom/samsung/android/allshare/DeviceFinderImpl;Ljava/lang/String;Lcom/samsung/android/allshare/DeviceFinderImpl-IA;)V

    const-string p0, "BUNDLE_STRING_ID"

    invoke-virtual {v0, p0, v1}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->putString(Ljava/lang/String;Ljava/lang/String;)V
...
.method public blacklist refresh(Lcom/samsung/android/allshare/Device$DeviceType;)V
    ...
    invoke-direct {v0, p0, v1, v2}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;-><init>(Lcom/samsung/android/allshare/DeviceFinderImpl;Ljava/lang/String;Lcom/samsung/android/allshare/DeviceFinderImpl-IA;)V
    ...
    invoke-virtual {v0, p0, p1}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->putString(Ljava/lang/String;Ljava/lang/String;)V
...
.method public blacklist registerSearchTarget(Ljava/util/ArrayList;)V
    ...
    :cond_4
    new-instance p1, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;

    const-string v2, "com.sec.android.allshare.action.ACTION_DEVICE_FINDER_REGISTER_SEARCH_TARGET_SYNC"

    const/4 v3, 0x0

    invoke-direct {p1, p0, v2, v3}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;-><init>(Lcom/samsung/android/allshare/DeviceFinderImpl;Ljava/lang/String;Lcom/samsung/android/allshare/DeviceFinderImpl-IA;)V

    const-string p0, "BUNDLE_STRING_ID"

    invoke-virtual {p1, p0, v1}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string p0, "BUNDLE_STRINGARRAYLIST_DEVICE_TYPE_LIST"

    invoke-virtual {p1, p0, v0}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->putStringArrayList(Ljava/lang/String;Ljava/util/ArrayList;)V

    invoke-virtual {p1}, Lcom/samsung/android/allshare/DeviceFinderImpl$SyncActionInvoker;->invoke()Landroid/os/Bundle;
...
.method public whitelist setDeviceFinderEventListener(Lcom/samsung/android/allshare/Device$DeviceType;Lcom/samsung/android/allshare/DeviceFinder$IDeviceFinderEventListener;)V
    ...
    :cond_2
    iget-object v0, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mDiscoveryListenerMap:Ljava/util/HashMap;
    ...
    iget-object p0, p0, Lcom/samsung/android/allshare/DeviceFinderImpl;->mEventHandler:Lcom/samsung/android/allshare/AllShareEventHandler;
