...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lcom/samsung/android/edge/IEdgeLightingCallback;
    ...
    :cond_1
    new-instance v0, Lcom/samsung/android/edge/IEdgeLightingCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/samsung/android/edge/IEdgeLightingCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo p0, "onEdgeLightingStopped"

    return-object p0

    :cond_1
    const-string/jumbo p0, "onEdgeLightingStarted"

    return-object p0

    :cond_2
    const-string/jumbo p0, "onScreenChanged"

    return-object p0

    :cond_3
    const-string/jumbo p0, "onStopEdgeLighting"

    return-object p0

    :cond_4
    const-string/jumbo p0, "onStartEdgeLighting"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/edge/IEdgeLightingCallback$Stub;->onScreenChanged(Z)V
    ...
    invoke-virtual {p0, p1, p3}, Lcom/samsung/android/edge/IEdgeLightingCallback$Stub;->onStopEdgeLighting(Ljava/lang/String;I)V
    ...
    sget-object p3, Lcom/samsung/android/edge/SemEdgeLightingInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p3}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Lcom/samsung/android/edge/SemEdgeLightingInfo;
    ...
    invoke-virtual {p0, p1, p3, p4}, Lcom/samsung/android/edge/IEdgeLightingCallback$Stub;->onStartEdgeLighting(Ljava/lang/String;Lcom/samsung/android/edge/SemEdgeLightingInfo;I)V
