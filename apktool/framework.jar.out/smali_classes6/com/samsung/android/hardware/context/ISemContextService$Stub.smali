...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lcom/samsung/android/hardware/context/ISemContextService;
    ...
    :cond_1
    new-instance v0, Lcom/samsung/android/hardware/context/ISemContextService$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/samsung/android/hardware/context/ISemContextService$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string p0, "getCurrentServiceList"

    return-object p0

    :pswitch_1
    const-string/jumbo p0, "requestHistoryData"

    return-object p0

    :pswitch_2
    const-string/jumbo p0, "requestToUpdate"

    return-object p0

    :pswitch_3
    const-string/jumbo p0, "setReferenceData"

    return-object p0

    :pswitch_4
    const-string p0, "getAvailableServiceMap"

    return-object p0

    :pswitch_5
    const-string p0, "changeParameters"

    return-object p0

    :pswitch_6
    const-string p0, "initializeService"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1, p4, v0}, Lcom/samsung/android/hardware/context/ISemContextService$Stub;->requestHistoryData(Landroid/os/IBinder;ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p4, v0}, Lcom/samsung/android/hardware/context/ISemContextService$Stub;->requestToUpdate(Landroid/os/IBinder;ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p4, v0}, Lcom/samsung/android/hardware/context/ISemContextService$Stub;->setReferenceData(II[B)Z
    ...
    sget-object v0, Lcom/samsung/android/hardware/context/SemContextAttribute;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v0}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/samsung/android/hardware/context/SemContextAttribute;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1, p4, v0}, Lcom/samsung/android/hardware/context/ISemContextService$Stub;->changeParameters(Landroid/os/IBinder;ILcom/samsung/android/hardware/context/SemContextAttribute;)Z
    ...
    invoke-virtual {p0, p1, p4}, Lcom/samsung/android/hardware/context/ISemContextService$Stub;->initializeService(Landroid/os/IBinder;I)V
    ...
    invoke-virtual {p0, p1, p4}, Lcom/samsung/android/hardware/context/ISemContextService$Stub;->unregisterCallback(Landroid/os/IBinder;I)Z
    ...
    invoke-virtual {p0, p1, p4, v0, v2}, Lcom/samsung/android/hardware/context/ISemContextService$Stub;->registerCallback(Landroid/os/IBinder;ILcom/samsung/android/hardware/context/SemContextAttribute;Ljava/lang/String;)V
