...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lcom/samsung/android/ims/ISemEpdgListener;
    ...
    check-cast v0, Lcom/samsung/android/ims/ISemEpdgListener;

    return-object v0

    :cond_1
    new-instance v0, Lcom/samsung/android/ims/ISemEpdgListener$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/samsung/android/ims/ISemEpdgListener$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo p0, "onEpdgShowPopup"

    return-object p0

    :cond_1
    const-string/jumbo p0, "onIpsecDisconnection"

    return-object p0

    :cond_2
    const-string/jumbo p0, "onIpsecConnection"

    return-object p0

    :cond_3
    const-string/jumbo p0, "onHandoverResult"

    return-object p0

    :cond_4
    const-string/jumbo p0, "onEpdgAvailable"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual {p0, p1, p3}, Lcom/samsung/android/ims/ISemEpdgListener$Stub;->onEpdgShowPopup(II)V
    ...
    invoke-virtual {p0, p1, p3}, Lcom/samsung/android/ims/ISemEpdgListener$Stub;->onIpsecDisconnection(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p3, p4, v0}, Lcom/samsung/android/ims/ISemEpdgListener$Stub;->onIpsecConnection(ILjava/lang/String;II)V
    ...
    invoke-virtual {p0, p1, p3, p4, v0}, Lcom/samsung/android/ims/ISemEpdgListener$Stub;->onHandoverResult(IIILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p3, p4}, Lcom/samsung/android/ims/ISemEpdgListener$Stub;->onEpdgAvailable(IZI)V
