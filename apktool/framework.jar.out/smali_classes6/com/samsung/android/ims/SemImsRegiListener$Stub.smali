...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lcom/samsung/android/ims/SemImsRegiListener;
    ...
    check-cast v0, Lcom/samsung/android/ims/SemImsRegiListener;

    return-object v0

    :cond_1
    new-instance v0, Lcom/samsung/android/ims/SemImsRegiListener$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/samsung/android/ims/SemImsRegiListener$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_2
    sget-object p1, Lcom/samsung/android/ims/SemImsRegistration;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/samsung/android/ims/SemImsRegistration;

    sget-object p3, Lcom/samsung/android/ims/SemImsRegistrationError;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p3}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p3

    check-cast p3, Lcom/samsung/android/ims/SemImsRegistrationError;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1, p3}, Lcom/samsung/android/ims/SemImsRegiListener$Stub;->onDeregistered(Lcom/samsung/android/ims/SemImsRegistration;Lcom/samsung/android/ims/SemImsRegistrationError;)V
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/ims/SemImsRegiListener$Stub;->onRegistered(Lcom/samsung/android/ims/SemImsRegistration;)V
