...
.method public whitelist onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string p0, " CREATE TABLE ClipboardImageTable (id INTEGER PRIMARY KEY AUTOINCREMENT,  _data TEXT NOT NULL);"
...
.method public whitelist onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    const-string p2, ". Old data will be destroyed"
    ...
    const-string p2, "DROP TABLE IF EXISTS ClipboardImageTable"
