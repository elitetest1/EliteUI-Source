...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lcom/samsung/android/gesture/IMotionRecognitionCallback;
    ...
    :cond_1
    new-instance v0, Lcom/samsung/android/gesture/IMotionRecognitionCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Lcom/samsung/android/gesture/IMotionRecognitionCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string p0, "getListenerPackageName"

    return-object p0

    :cond_1
    const-string p0, "getListenerInfo"

    return-object p0

    :cond_2
    const-string/jumbo p0, "motionCallback"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_4
    sget-object p1, Lcom/samsung/android/gesture/SemMotionRecognitionEvent;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/samsung/android/gesture/SemMotionRecognitionEvent;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Lcom/samsung/android/gesture/IMotionRecognitionCallback$Stub;->motionCallback(Lcom/samsung/android/gesture/SemMotionRecognitionEvent;)V
