...
.method public static final blacklist readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v3, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;

    invoke-direct {v3}, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;-><init>()V

    mul-int/lit8 v5, v1, 0x60

    int-to-long v5, v5

    invoke-virtual {v3, v4, p0, v5, v6}, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final blacklist writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    check-cast v3, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;

    mul-int/lit8 v5, v4, 0x60

    int-to-long v5, v5

    invoke-virtual {v3, v2, v5, v6}, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final whitelist test-api equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    check-cast p1, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;

    iget-object v2, p0, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;->base:Lvendor/samsung/hardware/radio/V2_0/SehCardStatus;

    iget-object v3, p1, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;->base:Lvendor/samsung/hardware/radio/V2_0/SehCardStatus;
    ...
    :cond_3
    iget-object p0, p0, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;->eid:Ljava/lang/String;

    iget-object p1, p1, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;->eid:Ljava/lang/String;
...
.method public final blacklist readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lvendor/samsung/hardware/radio/V2_0/SehCardStatus;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput-object p3, p0, Lvendor/samsung/hardware/radio/V2_1/SehCardStatus;->eid:Ljava/lang/String;
...
.method public final blacklist writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lvendor/samsung/hardware/radio/V2_0/SehCardStatus;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
