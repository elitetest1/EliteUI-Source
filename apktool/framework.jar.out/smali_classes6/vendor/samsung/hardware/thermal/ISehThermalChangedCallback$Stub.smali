...
.method public static blacklist asInterface(Landroid/os/IBinder;)Lvendor/samsung/hardware/thermal/ISehThermalChangedCallback;
    ...
    check-cast v0, Lvendor/samsung/hardware/thermal/ISehThermalChangedCallback;

    return-object v0

    :cond_1
    new-instance v0, Lvendor/samsung/hardware/thermal/ISehThermalChangedCallback$Stub$Proxy;

    invoke-direct {v0, p0}, Lvendor/samsung/hardware/thermal/ISehThermalChangedCallback$Stub$Proxy;-><init>(Landroid/os/IBinder;)V
...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo p0, "notifyTemperatures"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_4
    sget-object p1, Lvendor/samsung/hardware/thermal/SehTemperature;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, p1}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Lvendor/samsung/hardware/thermal/SehTemperature;

    invoke-virtual {p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {p0, p1}, Lvendor/samsung/hardware/thermal/ISehThermalChangedCallback$Stub;->notifyTemperatures([Lvendor/samsung/hardware/thermal/SehTemperature;)V
